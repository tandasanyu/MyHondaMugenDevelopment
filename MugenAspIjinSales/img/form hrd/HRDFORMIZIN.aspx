                ...
                <table class="table table-borderless" align="left">
					...
					<tr> 
						...
						<td class="col-md-4">
							...
							<div id="UploadFile" runat="server"><asp:FileUpload ID="FileUpload1" runat="server" />
...
<%--                            <asp:DropDownList ID="DropDownList1" runat="server"  class="form-control required" >
					...
					<tr> 
						...
						<td class="col-md-4">
							...
							<div id="DivTerlambat" runat="server"><asp:FileUpload ID="FileUploadTerlambat" runat="server" />
