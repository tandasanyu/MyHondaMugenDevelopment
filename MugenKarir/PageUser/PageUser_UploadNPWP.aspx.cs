...
public partial class PageUser_PageUser_UploadNPWP : System.Web.UI.Page
{
    ...
    protected void BtnSubmitNPWP_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            //imgPath
            string imgPath = "~/UploadFile/NPWP/" + nama + extension;
            //Upload File 
            ...
            if (FileUpload1.PostedFile != null && FileUpload1.PostedFile.FileName != "")
            {
                ...
                Hasil = cn.KelasKoneksi_Insert("Insert into Data_UploadNPWP values (" + Convert.ToInt32(IdLamar) + ",'" + nama + extension + "' )");
                if (Hasil == "1")
                {
