<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageUser_UploadKK.aspx.cs" Inherits="PageUser_PageUser_UploadKK" %>
    ...
    <form id="form1" runat="server">
        <div style="margin-bottom:100px">
                <div style="margin-left:1%">
                    <h2 class="FormUploadFoto">Form Upload Foto Kartu Keluarga Anda</h2>
                    <br />
                    <br />
                </div>              
