...
public partial class PageUser_PageUser_UploadSurat : System.Web.UI.Page
{
    ...
    protected void BtnSubmitSurat_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            //imgPath
            string imgPath = "~/UploadFile/Surat/" + nama + extension;
            //Upload File 
            ...
            if (FileUpload1.PostedFile != null && FileUpload1.PostedFile.FileName != "")
            {
                ...
                Hasil = cn.KelasKoneksi_Insert("Insert into Data_UploadSurat (Id_lamaran, Path_Foto) values (" + Convert.ToInt32(IdLamar) + ",'" + nama + extension + "' )");
                if (Hasil == "1")
                {
