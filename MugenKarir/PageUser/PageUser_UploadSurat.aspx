<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageUser_UploadSurat.aspx.cs" Inherits="PageUser_PageUser_UploadSurat" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload Surat Referensi Kerja</title>
    <!-- DATEPICKER RANGE -->
    ...
    <form id="form1" runat="server">
        <div style="margin-bottom:100px">
                <div style="margin-left:1%">
                    <h2 class="FormUploadFoto">Form Upload Surat Referensi Anda</h2>
                    <br />
                    <br />
                </div> 
                <div class="blue-square-container">
                  <div class="blue-square">
                            <div class="form-group" id="Foto Pribadi">
                                 <div style="margin-left:1%" >
                                      <asp:Label ID="Label1" runat="server" Text="Upload File Surat Referensi Anda" Font-Bold="true"></asp:Label>
                                     ...
                                     </div><asp:Button ID="BtnSubmitSurat" OnClientClick ="return OnUpload();" runat="server" Text="Upload File" class="btn btn-secondary" OnClick="BtnSubmitSurat_Click" />   
                                 </div>
                            </div>
                  </div>
                </div>     
