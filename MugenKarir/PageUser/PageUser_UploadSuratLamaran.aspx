<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageUser_UploadSuratLamaran.aspx.cs" Inherits="PageUser_PageUser_UploadSuratLamaran" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload Surat Lamaran</title>
    <!-- DATEPICKER RANGE -->
    ...
    <form id="form1" runat="server">
        <div style="margin-bottom:100px">
                <div style="margin-left:1%">
                    <h2 class="FormUploadFoto">Form Upload File Surat Lamaran Anda</h2>
                    <br />
                    <br />
                </div>              
