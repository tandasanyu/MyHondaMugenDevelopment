<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageUser_UploadNPWP.aspx.cs" Inherits="PageUser_PageUser_UploadNPWP" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload NPWP</title>
    <!-- DATEPICKER RANGE -->
    ...
    <form id="form1" runat="server">
        <div style="margin-bottom:100px">
                <div style="margin-left:1%">
                    <h2 class="FormUploadFoto">Form Upload Foto NPWP Anda</h2>
                    <br />
                    <br />
                </div>              
