...
public partial class PageUser_PageUser_UploadIjazah : System.Web.UI.Page
{
    ...
    protected void BtnSubmitIjazah_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            //imgPath
            string imgPath = "~/UploadFile/Ijazah/" + nama + extension;
            //Upload File 
            ...
            if (FileUpload1.PostedFile != null && FileUpload1.PostedFile.FileName != "")
            {
                ...
                Hasil = cn.KelasKoneksi_Insert("Insert into Data_UploadIjazah values (" + Convert.ToInt32(IdLamar) + ",'" + nama + extension + "' )");
                if (Hasil == "1")
                {
