...
public partial class PageUser_PageUser_UploadKTP : System.Web.UI.Page
{
    ...
    protected void BtnSubmitKTP_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            //imgPath
            string imgPath = "~/UploadFile/KTP/" + nama + extension;
            //Upload File 
            ...
            if (FileUpload1.PostedFile != null && FileUpload1.PostedFile.FileName != "")
            {
                ...
                Hasil = cn.KelasKoneksi_Insert("Insert into Data_UploadKTP values (" + Convert.ToInt32(IdLamar) + ",'" + nama + extension + "' )");
                if (Hasil == "1")
                {
