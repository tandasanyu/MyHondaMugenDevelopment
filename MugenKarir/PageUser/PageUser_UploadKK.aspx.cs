...
public partial class PageUser_PageUser_UploadKK : System.Web.UI.Page
{
    ...
    protected void BtnSubmitKK_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            //imgPath
            string imgPath = "~/UploadFile/KK/" + nama + extension;
            //Upload File 
            ...
            if (FileUpload1.PostedFile != null && FileUpload1.PostedFile.FileName != "")
            {
                ...
                Hasil = cn.KelasKoneksi_Insert("Insert into Data_UploadKK values (" + Convert.ToInt32(IdLamar) + ",'" + nama + extension + "' )");
                if (Hasil == "1")
                {
