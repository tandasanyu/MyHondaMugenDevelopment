<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Undang_Psikotest.aspx.cs" Inherits="PagesHRD_Undang_Psikotest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
      $( function() {
        ...
        <div class="row">
            <div class="col">
                <asp:MultiView ID="MultiViewUndangPsikotest" runat="server">
                    <asp:View ID="View1" runat="server">
                       <br />     
                        <h3 class="text-center">Template Undangan Psikotest Pelamar Baru</h3><br />
                        ...
                        <p>Kami telah mereview CV singkat anda dan ingin mengundang Anda untuk bisa menghadiri Psikotest posisi <asp:Label ID="LblPosisi" runat="server" Text="Label"></asp:Label> yang akan diselenggarakan pada :</p>
                        <br />    
                        <div class="row">
                        ...
                        <div class="row">   
                            ...
                            <div class="col-sm-1">CV Lengkap, Alat Tulis (Penghapus, Pensil HB, Pulpen)</div>
                        </div>
                        <div class="row">
