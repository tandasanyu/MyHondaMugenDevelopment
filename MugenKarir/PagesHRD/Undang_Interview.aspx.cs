...
public partial class PagesHRD_Undang_Interview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MultiViewUndangInterview.ActiveViewIndex = 0;
    }
    ...
    protected void BtnPreview_Click(object sender, EventArgs e)
    {
        ...
        {
            MultiViewUndangInterview.ActiveViewIndex = 1;
            ...
            isiemail = "<br /><br /><p>Selamat Siang Bapak/Ibu,</p><p>Kami telah mereview CV singkat anda dan ingin mengundang Anda untuk bisa menghadiri Interview posisi <b>" + LblPosisi.Text + "</b> yang akan diselenggarakan pada :</p><br /><div><div><p><b>Hari / Tanggal </b>: " + trueday + "-" + TxtHariTgl.Text + "</p></div></div><div ><div ><p><b>Waktu</b> : " + TxtPukul.Text + "</p></div></div><div ><div ><p><b>Alamat</b> : " + DDAlamat.SelectedValue + "</p></div></div><div ><div ><p><b>Membawa</b> : CV Lengkap</p></div></div><div ><div ><p><b>Bertemu</b> : " + TxtBertemu.Text + "</p></div></div><br /><p>Harap untuk membalas email ini untuk konfirmasi kehadiran anda, atau bisa menghubungi nomor What’s App berikut 089649750950</p><p>Terima Kasih</p><br /><br /><br /><p>Regards, </p><b><p>Retno Syifa Fauziah</p></b><p>Staff Recruitment HONDA MUGEN</p><p>PT. Mitrausaha Gentaniaga</p><p>Jl. Raya Pasar Minggu No. 10 Jakarta Selatan 12740</p><p>Tlp. (021) 797 2000 (Bengkel), (021) 797 3000 (Showroom)</p><p>Ext. 167</p><p>Email : recruitment@hondamugen.co.id</p>";
    ...
    protected void BtnKirim_Click(object sender, EventArgs e)
    {
        ...
        if (status == "OK")
        {
            ...
            Response.Write("<script>alert('Berhasil Kirim Email Undangan Interview Pelamar Baru')</script>");
        }
        else
        {
