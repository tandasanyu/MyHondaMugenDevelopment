...
Partial Class formChecklist2
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load

        Dim noRangka1 As String = Request.QueryString("noRangka1")
        If noRangka1 = "null" Then
            Response.Redirect("default.aspx")
        Else
            tglMasuk.Text = Format(Now, "yyyy-MM-dd HH:mm:ss")
            Dim username1 As String = Request.QueryString("username1")
            petugas.text = username1
            Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
            Dim cnn As OleDbConnection
            Dim cmd As OleDbCommand
            Dim GetData_Checklist As Integer
            noRangka.Text = noRangka1
            Dim mSqlCommadstring As String = "select * FROM DATA_CUSTOMER LEFT JOIN DATA_WARNING ON DATA_CUSTOMER.CUST_NORANGKA = DATA_WARNING.WARN_NORANGKA LEFT JOIN DATA_TYPE ON DATA_CUSTOMER.CUST_TYPE = DATA_TYPE.TYPE_KODE WHERE CUST_NORANGKA ='" + noRangka1 + "' AND CUST_NORANGKA<>''"
            ...
            Try
                ...
                If MyRecReadA.HasRows = True Then
                    While MyRecReadA.Read()
                        nopol.Text = MyRecReadA("cust_nopol")
    ...
    Protected Sub simpan_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            Dim petugas1 As String = petugas.text
            nopol1 = nopol.Text
            nopol1 = nopol1.ToUpper()
            tglMasuk1 = tglMasuk.Text
            catatan1 = catatan.Text
            Call insertChecklist_Tabel("INSERT INTO TEMP_CHECKLISTH(nopol, tglMasuk, petugasAwal, kategori, catatan) VALUES('" + nopol1 + "','" + tglMasuk1 + "','" + petugas1 + "','2','" + catatan1 + "')")
