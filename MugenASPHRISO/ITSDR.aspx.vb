...
Partial Class ITSDR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LblUserName.Text = "" Then
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility, tb_user WHERE tb_userutility.username collate SQL_Latin1_General_CP1_CI_AS = tb_user.username collate SQL_Latin1_General_CP1_CI_AS and tb_userutility.username = '" & LblUserName.Text & "' And tb_userutility.hakakses = 'FORM SDR -- VIEW SEMUA DATA'") = 1 Then
                MultiViewAkses.ActiveViewIndex = 0
                MultiViewJudul.ActiveViewIndex = 0
                MultiViewAkses2.ActiveViewIndex = -1
            ElseIf GetData_UserSecurity("SELECT * FROM tb_userutility,tb_user WHERE tb_userutility.username collate SQL_Latin1_General_CP1_CI_AS  = tb_user.username collate SQL_Latin1_General_CP1_CI_AS and tb_userutility.username = '" & LblUserName.Text & "' And tb_userutility.hakakses = 'FORM SDR -- VIEW DATA'") = 1 Then
        ...
        Else
            ...
            If DropDownList2.Text = "Permanen" Then
                ...
                If (FileUpload1.HasFile) Then
                    ...
                    Dim fileuploadpath As String = "C:\inetpub\wwwroot\MugenASPHRISO\WEBDOWNLOAD\DOKUMENSDR\"
                    FileUpload1.PostedFile.SaveAs(Path.Combine(fileuploadpath, filename))
                    Call UpdateData_Server("UPDATE TRXN_SDR SET SDRLOG_LAMPIRAN = '" & filename & "' WHERE  SDRLOG_NO='" & lblSDRId.Text & "'")
                End If
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    GetData_SearchNomor = "SDR" & mTahun & mBulan & GetData_SearchNomor
                End If
            End If
            MyRecReadA.Close()
            cmd.Dispose()
    ...
    Function GetData_Head() As String
        ...
        'mSqlCommadstring = "SELECT NOMOR FROM TRXN_SPKAH WHERE CABANG='" & lblDealer.Text & "' AND NOT(NOMOR IS NULL OR NOMOR='') AND MONTH(TANGGAL_ENTRY)=MONTH(GETDATE()) AND YEAR(TANGGAL_ENTRY)=YEAR(GETDATE()) ORDER BY NOMOR DESC"
        mSqlCommadstring = "select headdivisi from divisi,tb_user where divisi.kddivisi = tb_user.kddivisi and username ='" & LblUserName.Text & "'"
        cnn = New OleDbConnection(strconn)
        Try
            cnn.Open()
            cmd = New OleDbCommand(mSqlCommadstring, cnn)
