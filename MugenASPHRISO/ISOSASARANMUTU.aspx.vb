...
Partial Class ISOSASARANMUTU
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LblUserName.Text = "" Then
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility, tb_user WHERE tb_userutility.username collate SQL_Latin1_General_CP1_CI_AS = tb_user.username collate SQL_Latin1_General_CP1_CI_AS and tb_userutility.username = '" & LblUserName.Text & "' And tb_userutility.hakakses = 'FORM ISO -- VIEW SEMUA DATA'") = 1 Then
                MultiViewAkses.ActiveViewIndex = 0
            ElseIf GetData_UserSecurity("SELECT * FROM tb_userutility, tb_user WHERE tb_userutility.username collate SQL_Latin1_General_CP1_CI_AS = tb_user.username collate SQL_Latin1_General_CP1_CI_AS and tb_userutility.username = '" & LblUserName.Text & "' And tb_userutility.hakakses = 'FORM ISO -- VIEW DATA'") = 1 Then
    ...
    Protected Sub LvDetailMaster2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvDetailMaster2.SelectedIndexChanged
        TxtID.Text = (LvDetailMaster2.DataKeys(LvDetailMaster2.SelectedIndex).Value.ToString)
        Call GetData_MasterSM("SELECT * FROM TRXN_ISOASM WHERE MUTU_ID='" & TxtID.Text & "'")
        MultiViewActionPlane2.ActiveViewIndex = 0
        MultiViewAkses2.ActiveViewIndex = -1
        Call DetailMasterOn2()
    End Sub
    ...
    Protected Sub LVActionPlane_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVActionPlane.SelectedIndexChanged
        ...
        MultiViewActionPlaneENtry.ActiveViewIndex = 0
    End Sub
    Protected Sub LVActionPlane2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVActionPlane2.SelectedIndexChanged
        MultiViewActionPlaneENtry.ActiveViewIndex = 0
    End Sub
    ...
    Protected Sub BtnNilai_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnNilaiSM.Click
        ...
        ' If GetData_UserSecurity("SELECT * FROM tb_user WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- DISETUJUI HEAD'") = 1 And GetData_MasterNilai("SELECT * FROM TRXN_ISOENILAI WHERE MUTUN_CREATEUSER IS NULL AND MUTUN_CREATEUSERTGL IS NULL") Then
        'BtnNilaiSMSave0.Visible = True
        ' Else
        ' BtnNilaiSMSave0.Visible = False
        '  End If

        If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- DISETUJUI WAKIL MANAJEMEN'") = 1 And GetFindRecord_Tabel("SELECT * FROM TRXN_ISOENILAI WHERE MUTUN_CREATEMGM IS NULL AND MUTUN_CREATEMGMTGL IS NULL") = 1 Then
            BtnNilaiSMSave1.Visible = True
            BtnNilaiSMSave.Visible = False
            BtnNilaiSMDel.Visible = False
        ElseIf GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- DISETUJUI WAKIL MANAJEMEN'") = 1 And GetFindRecord_Tabel("SELECT * FROM TRXN_ISOENILAI WHERE MUTUN_CREATEMGM IS NOT NULL AND MUTUN_CREATEMGMTGL IS NOT NULL") = 1 Then
            BtnNilaiSMSave1.Visible = False
            BtnNilaiSMSave.Visible = False
            BtnNilaiSMDel.Visible = False
        Else
            BtnNilaiSMSave.Visible = True
            BtnNilaiSMDel.Visible = True
        End If
    ...
    Protected Sub LVNilaiSasaranMutu_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVNilaiSasaranMutu.SelectedIndexChanged
        ...
        MultiViewNilaiProgressEntry.ActiveViewIndex = 0
        'If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- DISETUJUI HEAD'") = 1 And GetData_MasterNilai("SELECT * FROM TRXN_ISOENILAI WHERE MUTUN_CREATEUSER IS NULL AND MUTUN_CREATEUSERTGL IS NULL") Then
        'BtnNilaiSMSave0.Visible = True
        'Else
        'BtnNilaiSMSave0.Visible = False
        'End If
    ...
    Function EditDataNilai() As String
        ...
        EditDataNilai = "UPDATE TRXN_ISOENILAI SET " & _
                             ...
                             "MUTUN_CREATEMGM=NULL," & _
                             "MUTUN_CREATEMGMTGL=NULL," & _
    ...
    Protected Sub LvPerbaikan_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvPerbaikan.SelectedIndexChanged
        ...
        Dim mSqlCommand As String = "DELETE FROM TRXN_ISODTINDAKAN WHERE MUTUT_TIPE='B' AND MUTUT_ID='" & TxtID.Text & "' AND YEAR(MUTUT_PROGRESS)=" & Year(lblSasaranMutuProgress.Text) & " AND MONTH(MUTUT_PROGRESS)=" & Month(lblSasaranMutuProgress.Text) & " AND MUTUT_TINDAKAN='" & TxtPerbaikanTindakan.Text & "'"
        Call UpdateData_Tabel(mSqlCommand, "D")
    ...
    Function GetFindRecord_Tabel2(ByVal mSqlCommadstring As String) As Integer
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
        GetFindRecord_Tabel2 = 0
        cnn = New OleDbConnection(strconn)
        Try
            cnn.Open()
            cmd = New OleDbCommand(mSqlCommadstring, cnn)
