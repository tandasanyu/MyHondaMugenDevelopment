    ...
    Function GetData_SDR(ByVal mSqlCommadstring As String) As Double
        ...
        Try
            ...
            If MyRecReadA.HasRows = True Then
                ...
                If (MyRecReadA("SDRLOG_LAMPIRAN") IsNot DBNull.Value) Then
                    lampiran.Text = "Klik <a href = 'webdownload/dokumensdr/" + nSr(MyRecReadA("SDRLOG_LAMPIRAN")) + "' target=_blank> disini </a> untuk melihat lampiran"
                End If
