...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="TxtNotif" style="display:none;" runat="server"></asp:Label>
    ...
    <asp:Label ID="TXTUsername" style="display:none;" runat="server"></asp:Label>
    ...
    <div class="container">
        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
			<asp:View ID="View0102Karyawan" runat="server">
				    ...
				    <tr>
                     ...
                     <tr>
				        ...
				        <td class="col-md-4"><asp:Label ID="subJabatan" runat="server" MaxLength="30" Text ="" class="form-control required"></asp:Label><br />
                             <p class="small">[0] Operator &nbsp [1] Staff &nbsp [2] Leader &nbsp [3] SPV &nbsp [4] Ast.Manager <br /> [5] Manager </p>
				        </td>
                ...
                Deadline Pengisian PK :<font color="red"><b> <asp:Label ID="lblDeadlinePK" runat="server" Text=""></asp:Label> </b></font> <br />
                Deadline Verifikasi Atasan Langsung :<font color="red"><b> <asp:Label ID="lblDeadlineAtasan" runat="server" Text=""></asp:Label> </b></font><br />
                Deadline Verifikasi Atasan Dari Atasan Langsung :<font color="red"><b> <asp:Label ID="lblDeadlineAtasan2" runat="server" Text=""></asp:Label> </b></font><br />
                Format Pembacaan Tanggal : mm/dd/yyyy <br /><br />
            </asp:View>
        </asp:MultiView>

        <asp:MultiView ID="MultiViewKpiMaster" runat="server" Visible="TRUE">
            <asp:View ID="ViewTampilKpiMasterSumary" runat="server">  
                <asp:Button ID="BtnKpi40Master" visible="true" runat="server" Text="Tambah Data KPI" class="button button4"/>
                <asp:Button runat="server" id="test" Text="Kirim PK ke Email" class="button button2"></asp:Button>
				<br /><br />
                ...
                <asp:View ID="View3" runat="server">  
                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr id="pengisian" runat="server" visible="false">
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label2" runat="server" Text="Deadline Pengisian PK"></asp:Label></td>
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlinePK" runat="server" Text="06/17/2018" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
                                            <asp:Button ID="Button100"  Text="..."  runat="server" CausesValidation="False" class="btn btn-default" />
                    
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender3" runat="server"
                                            TargetControlID="TxtDeadlinePK" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                                            ...
                                            ControlExtender="MaskedEditExtender3" ControlToValidate="TxtDeadlinePK" EmptyValueMessage="Date is required"
                                            ...
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TxtDeadlinePK" PopupButtonID="Button100" />
                                    </td>
                                    <td class="col-md-2"></td>
                                </tr>
                                 <tr id="atasanlangsung" runat="server" visible="false">
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label3" runat="server" Text="Deadline Verifikasi Atasan Langsung"></asp:Label></td>
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlineAtasan" runat="server" Text="06/24/2018" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
                                            <asp:Button ID="Button101"  Text="..."  runat="server" CausesValidation="False" class="btn btn-default" />
                    
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" runat="server"
                                            TargetControlID="TxtDeadlineAtasan" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                                            OnInvalidCssClass="MaskedEditError" MaskType="Date" DisplayMoney="Left" AcceptNegative="Left" ErrorTooltipEnabled="True" />

                                            <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator2" runat="server"
                                            ControlExtender="MaskedEditExtender3" ControlToValidate="TxtDeadlineAtasan" EmptyValueMessage="Date is required"
                                            InvalidValueMessage="Date is invalid" Display="Dynamic" IsValidEmpty="false" TooltipMessage="Input a date"
                                            EmptyValueBlurredText="*" InvalidValueBlurredMessage="Format MM/DD/YYYY Bulan Tanggal Tahun" ValidationGroup="MKE" />

                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TxtDeadlineAtasan" PopupButtonID="Button101" />
                                    </td>
                                    <td class="col-md-2"></td>
                                </tr>
                                 <tr id="atasanlangsung2" runat="server" visible="false">
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label4" runat="server" Text="Deadline Verifikasi Atasan Dari Atasan Langsung"></asp:Label></td>
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlineAtasan2" runat="server" Text="06/30/2018" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
                                            <asp:Button ID="Button102"  Text="..."  runat="server" CausesValidation="False" class="btn btn-default" />
                    
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender2" runat="server"
                                            TargetControlID="TxtDeadlineAtasan2" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                                            OnInvalidCssClass="MaskedEditError" MaskType="Date" DisplayMoney="Left" AcceptNegative="Left" ErrorTooltipEnabled="True" />

                                            <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator3" runat="server"
                                            ControlExtender="MaskedEditExtender3" ControlToValidate="TxtDeadlineAtasan2" EmptyValueMessage="Date is required"
                                            InvalidValueMessage="Date is invalid" Display="Dynamic" IsValidEmpty="false" TooltipMessage="Input a date"
                                            EmptyValueBlurredText="*" InvalidValueBlurredMessage="Format MM/DD/YYYY Bulan Tanggal Tahun" ValidationGroup="MKE" />

                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TxtDeadlineAtasan2" PopupButtonID="Button102" />
                                    </td>
                                    <td class="col-md-2"></td>
                                </tr>
                            ...
                            <center>
                                ...
                                <table align="center" id="buttonMaster" runat="server" width="600px" visible="false">
                                    <tr>
                                        <td><asp:Button ID="BtnKpi40MasterReset" runat="server" Text="Reset Verifikasi User" class="btn btn-warning" OnClientClick="return confirm('Apakah anda yakin akan mereset verifikasi PK untuk karyawan ini?');"/></td>
                                        <td><asp:Button ID="BtnResetVerifikasiHead" runat="server" Text="Reset Verifikasi Atasan Langsung" class="btn btn-info" OnClientClick="return confirm('Apakah anda yakin akan mereset verifikasi Atasan Langsung untuk karyawan ini?');"/></td>
                                        <td><asp:Button ID="BtnKpi40MasterCopy" runat="server" Text="Copy" class="btn btn-default" /></td>
                                        <td><asp:Button ID="BtnKpi40MasterNew" runat="server"  Text="Buat Baru" class="btn btn-success" /></td>
                                        <td><asp:Button ID="BtnResetDeadline" runat="server"  Text="Ubah Deadline" class="btn btn-primary" /></td>
                                        <td><asp:Button ID="BtnKpi40MasterDel" runat="server" OnClientClick="return confirm('Apakah anda yakin akan menghapus data PK untuk karyawan ini?');" Text="Hapus" class="btn btn-danger" /></td>
                                    </tr>
                                </table>
                            </center>     
                            <br /><br />
            ...
            <asp:MultiView ID="MultiViewKPIMasterDetail" runat="server" Visible="TRUE">
                <asp:View ID="ViewTampilKpiMasterDetail" runat="server">  
                    ...
                    <asp:Button ID="BtnKpi40" visible="true" runat="server" Text="Tambah Data" class="button button4"/>
                    <br /><br />
            ...
            <asp:View ID="ViewKPIMasterENtry" runat="server">  
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <center><asp:Button ID="BtnKpi40ASave" Visible="true" runat="server" Text="Simpan" class="btn btn-success" /></center>
                        </div>
                        ...
                        <center>
                            ...
                            <asp:Button ID="BtnKpi40Del" OnClientClick="return confirm('Apakah anda yakin akan menghapus Item PK untuk karyawan ini?');" Visible="false" runat="server" Text="Hapus" class="btn btn-danger" />
                        </center><br /><br /> 
                        </div>
                    </div>
                </div> 
        ...
        <asp:MultiView ID="MultiViewProsesTabel" runat="server" Visible="TRUE">
            <asp:View ID="View2" runat="server">  
                ...
                <asp:SqlDataSource ID="SqlDataProses" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT DATA_KPIN.KPIN_JUDUL, TRXN_KPIDD.KPI_NIK, TRXN_KPIDD.KPI_KOMENTAR2, TRXN_KPIDD.KPI_TARGET, round(TRXN_KPIDD.KPI_STAFF,2) as KPI_STAFF,  round(TRXN_KPIDD.KPI_ATASAN,2) as KPI_ATASAN, TRXN_KPIDD.KPI_TIPEA, TRXN_KPIDD.KPI_KOMENTAR, TRXN_KPIDD.KPI_TAHUN, TRXN_KPIDD.KPI_KODEITEM FROM TRXN_KPIDD LEFT OUTER JOIN DATA_KPIN ON TRXN_KPIDD.KPI_KODEITEM = DATA_KPIN.KPIN_TIPE WHERE (TRXN_KPIDD.KPI_TIPEA = 'A') AND (TRXN_KPIDD.KPI_NIK = ?) AND (TRXN_KPIDD.KPI_TAHUN = ?) ORDER BY [KPI_KODEITEM]"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <SelectParameters>
        ...
        <asp:MultiView ID="MultiViewProsesEntry" runat="server" Visible="TRUE">
            <asp:View ID="ViewKerjaAEntry" runat="server">
                ...
                <asp:Button ID="btnShow54" Visible="false" runat="server" Text="Komentar Bawahan" class="button button1" /><br />
        ...
        <asp:MultiView ID="MultiViewPeopleTabel" runat="server" Visible="TRUE">
            <asp:View ID="ViewKerjaBT" runat="server">  
                ...
                <asp:Button ID="btnShow55" Visible="false" runat="server" Text="Komentar Bawahan" class="button button1" /><br />
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr runat="server" id="nilaiBawahan"> 
                                <td class="col-md-2"></td>
                                <td class="col-md-2"><asp:Label ID="Label1" runat="server" Text="Nilai dari Bawahan"></asp:Label></td>
                                <td class="col-md-4"><asp:TextBox ID="TxtPeopleBawahan" ReadOnly="true" runat="server" MaxLength="5" Text ="" class="form-control required"></asp:TextBox></td>
                                <td class="col-md-2"></td>
                            </tr>
                            <tr> 
                                <td class="col-md-2"></td>
                ...
                <div class="well">  	
	                <div class="container">
                        ...
                        <center>
                            ...
                            <asp:Button ID="ButtonRefresh"   runat="server" Text="Refresh" class="btn btn-primary" />
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender55" runat="server" PopupControlID="Panel55" TargetControlID="btnShow55"
            CancelControlID="btnClose55" BackgroundCssClass="ModalPopupBG">
        </ajaxToolkit:ModalPopupExtender>
        <asp:Panel ID="Panel55" runat="server" CssClass="modal-dialog" align="center" style = "display:none">
        <!-- Modal content-->
            <div class="modal-content" style="max-height: 500px; margin-left:-200px; margin-top:-55px; min-width:1000px;overflow: auto;">
                <div class="modal-header">
                    <h4 class="modal-title">Komentar Bawahan ke Atasan</h4>
                </div>
                <div class="modal-body">
                     <asp:SqlDataSource ID="SqlDataSource55" runat="server"
                            ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                            SelectCommand="SELECT [KPIN_NOTE] FROM [TRXN_KPIN] WHERE ([KPIN_ATASAN] =  ? Or [KPIN_ATASAN] = ?) AND ([KPIN_NOTE] <> NULL Or [KPIN_NOTE] <> '') order by [KPIN_USER] asc"
                            ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="TxtStaffNama" Name="kpin_atasan" PropertyName="Text" Type="String" />
                                <asp:ControlParameter ControlID="TxtUsername" Name="kpin_atasan" PropertyName="Text" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>                                     
                        <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource55" DataKeyNames ="KPIN_NOTE">
                            <LayoutTemplate>
                                <table id="table-a" class="table table-bordered table-striped">
                                    <tr style="background-color:#4877CF">
                                        <td style="text-align:center; color:white">No.</td>
                                        <td style="text-align:center; color:white" class="col-md-11">Komentar</td>
                                    </tr>
                                    <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                                </table>
                            </LayoutTemplate>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td align="center"><%#Container.DataItemIndex + 1 %></td>
                                    <td><%#Eval("KPIN_NOTE")%></td>
                                </tr>
                            </ItemTemplate>
                            <EmptyDataTemplate>Data Komentar Tidak diketemukan</EmptyDataTemplate> 
                            <EmptyItemTemplate>Data Komentar Standard Tidak diketemukan</EmptyItemTemplate>              
                        </asp:ListView>
                    <br />
                        <button type="button" class="btn btn-danger" id="btnClose55" data-dismiss="modal">Tutup</button>
                    </div>
                </div>
        </asp:Panel>

        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender54" runat="server" PopupControlID="Panel54" TargetControlID="btnShow54"
            CancelControlID="btnClose54" BackgroundCssClass="ModalPopupBG">
        </ajaxToolkit:ModalPopupExtender>
        <asp:Panel ID="Panel54" runat="server" CssClass="modal-dialog" align="center" style = "display:none">
        <!-- Modal content-->
            <div class="modal-content" style="max-height: 500px; margin-left:-200px; margin-top:-55px; min-width:1000px;overflow: auto;">
                <div class="modal-header">
                    <h4 class="modal-title">Komentar Bawahan ke Atasan</h4>
                ...
                <div class="modal-body">
                     <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                        ...
                        <asp:ListView ID="ListView4" runat="server" DataSourceID="SqlDataSource55" DataKeyNames ="KPIN_NOTE">
                            <LayoutTemplate>
                                <table id="table-a" class="table table-bordered table-striped">
                                    <tr style="background-color:#4877CF">
                                        <td style="text-align:center; color:white">No.</td>
                    ...
                    <br />
                        <button type="button" class="btn btn-danger" id="btnClose54" data-dismiss="modal">Tutup</button>
                    </div>
                </div>
        </asp:Panel>
