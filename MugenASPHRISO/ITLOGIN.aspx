<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" Debug="true" CodeFile="ITLOGIN.aspx.vb" Inherits="ITLOGIN" title="DATA USER LOGIN SISTEM/EMAIL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><span class="glyphicon glyphicon-log-in"></span> &nbsp Form Login</li>
        </ul>
        ...
        <asp:MultiView ID="MultiViewJudul" runat="server" Visible="TRUE">
            <asp:View ID="View3" runat="server">
                <div class="container">
                    <center>
                        <h2 style="font-family:Cooper Black;">DATA USER LOGIN SISTEM/EMAIL<br />
        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
            <asp:View ID="View1Akses" runat="server">
                <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
                    ...
                    SelectCommand="SELECT [SDRLOG_NO], [SDRLOG_TIPE], [SDRLOG_JENIS], [SDRLOG_NMUSER], [SDRLOG_TGLCLOSE], [SDRLOG_TESTSTATUS], [SDRLOG_TESTTGL], [SDRLOG_DETAIL], [SDRLOG_TUJUAN], [SDRLOG_WAKTUSELESAI], [SDRLOG_PEMOHONNAMA], [SDRLOG_PEMOHONTGL], [SDRLOG_KETAHUINAMA], [SDRLOG_KETAHUITGL], [SDRLOG_SETUJUNAMA], [SDRLOG_SETUJUTGL], [SDRLOG_UJITGL], [SDRLOG_UJINAMA], [SDRLOG_TARGETR1] FROM [TRXN_SDR] WHERE [SDRLOG_JENIS] in ('Login Email','Login Sistem')"
                ...
                <asp:ListView ID="LvDetailMaster" runat="server" DataSourceID="SqlDataMutuMaster" DataKeyNames ="SDRLOG_NO">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><p class="small"><%#Eval("SDRLOG_JENIS")%><br />
                               (<%#Eval("SDRLOG_TIPE")%>)</p></td>
                            <td><p class="small"><%#Eval("SDRLOG_NMUSER")%></p></td>
                            <td><p class="small"><%#Eval("SDRLOG_PEMOHONNAMA")%><br />
                                <%#Eval("SDRLOG_PEMOHONTGL")%></p>
                            </td>
                            <td><p class="small"><%#Eval("SDRLOG_KETAHUINAMA")%><br />
                                <%#Eval("SDRLOG_KETAHUITGL")%>
                            </td>
                            <td><p class="small"><%#Eval("SDRLOG_SETUJUNAMA")%><br />
                                <%#Eval("SDRLOG_SETUJUTGL")%></p>
                            </td>
                            <td><p class="small"><%#Eval("SDRLOG_UJINAMA")%><br />
                                <%#Eval("SDRLOG_UJITGL")%></p>
                            </td>
                            <td><p class="small"><%#Eval("SDRLOG_TARGETR1")%></p></td>
                            <td><p class="small"><%#Eval("SDRLOG_TGLCLOSE")%></p></td>
                             <td align="center"><a href="<%#"ITLOGINOUTPUT.aspx?no=" + Eval("SDRLOG_NO")%>"><img src="img/dokumen1.png" width="35px" height="40px" /></a></td>
                    ...
                    <EmptyDataTemplate>Data Pengajuan Login Tidak diketemukan</EmptyDataTemplate> 
                    <EmptyItemTemplate>Data Pengajuan Login Tidak diketemukan</EmptyItemTemplate>              
                </asp:ListView>
                <br />
            </asp:View> 
        </asp:MultiView> 
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-duplicate"></span> &nbsp <font style="color:#ffffff">Form User Login Sistem/Email</font></div>
                        <div class="panel-body">
                            <center>
                                <h3 style="font-family:Blunter;">FORM USER LOGIN SISTEM/EMAIL<br />
                                    SYSTEM INFORMASI SHOWROOM & SERVICE
                                </h3>
                                <h5>004-FRM-IT.R1</h5>
                            </center>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label1" runat="server" Text="Jenis Permintaan"></asp:Label></td>
                                    <td class="col-md-4">
                                        <asp:DropDownList ID="DropDownList1" runat="server" class="form-control">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Tambah</asp:ListItem>
                                            <asp:ListItem>Rubah</asp:ListItem>
                                            <asp:ListItem>Hapus</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label15" runat="server" Text="Nama User"></asp:Label></td>
                                    <td class="col-md-4"><asp:TextBox ID="nmUser" runat="server" MaxLength="200" class="form-control"></asp:TextBox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-borderless" style="margin-top:-15px">
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label17" runat="server" Text="Tipe"></asp:Label></td>
                                    <td class="col-md-4">
                                        <asp:DropDownList ID="DropDownList3" runat="server" class="form-control">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Login Sistem</asp:ListItem>
                                            <asp:ListItem>Login Email</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label3" runat="server" Text="Keterangan"></asp:Label></td>
                                    <td class="col-md-4"><asp:TextBox ID="TxtKeterangan" TextMode = "MultiLine" runat="server" class="form-control"></asp:TextBox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                            ...
                            <center>
                                <asp:Label ID="LblErrorSaveC" runat="server" Text="" ForeColor="Red"></asp:Label><br />
        ...
        <asp:MultiView ID="MultiViewAkses2" runat="server" Visible="TRUE">
            <asp:View ID="View1" runat="server">
                <asp:SqlDataSource ID="SqlDataLogin2" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [SDRLOG_NO], [SDRLOG_TIPE], [SDRLOG_JENIS], [SDRLOG_NMUSER], [SDRLOG_TGLCLOSE], [SDRLOG_TESTSTATUS], [SDRLOG_TESTTGL], [SDRLOG_DETAIL], [SDRLOG_TUJUAN], [SDRLOG_WAKTUSELESAI], [SDRLOG_PEMOHONNAMA], [SDRLOG_PEMOHONTGL], [SDRLOG_KETAHUINAMA], [SDRLOG_KETAHUITGL], [SDRLOG_SETUJUNAMA], [SDRLOG_SETUJUTGL], [SDRLOG_UJITGL], [SDRLOG_UJINAMA], [SDRLOG_TARGETR1] FROM [TRXN_SDR] WHERE ([SDRLOG_PEMOHONNAMA] = ? OR [SDRLOG_KETAHUINAMA] = ?) AND [SDRLOG_JENIS] in ('Login Email','Login Sistem')"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
                ...
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataLogin2" DataKeyNames ="SDRLOG_NO">
                    <LayoutTemplate>
                        <table id="table-a" class="table table-bordered table-striped data2">
                            <thead style="background-color:#4877CF">
                                <th style="text-align:center; color:white">No.</th>
                                <th style="text-align:center; color:white">ID</th>
                                <th style="text-align:center; color:white">Tipe</th>
