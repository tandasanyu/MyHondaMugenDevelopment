...
Partial Class HRDPENILAIANKARYAWANB
    ...
    Function EditDataNilaiKPI(ByVal mStatus As String, ByVal mItem As String, ByVal mTarget As String, ByVal mNilaiStaff As String, ByVal mNilaiHead As String, ByVal mNilaiAkhir As String, ByVal mNilaiAkhir2 As String) As String
