            ...
            <asp:View ID="View4" runat="server">    
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <b><asp:Label ID="Label20" runat="server" Text="008 Mengambil alih pekerjaan tambahan di tengah2 proses karena anggota tim dirasa lamban atau tidak benar melaksanakannya."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label22" runat="server" Text="009 Mampu menunjukkan rasa empati terhadap permasalahan yang dihadapi oleh anggota tim kerja & bersedia membantu memberikan alternatif solusi jika dibutuhkan."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label24" runat="server" Text="010 Meluangkan waktu / kesempatan kepada anggota tim kerja untuk mengungkapkan opini, ide2 / usulan, terhadap suatu hal."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label26" runat="server" Text="011 Mampu mendorong rasa percaya diri anggota tim kerja terhadap kemampuannya serta memotivasi untuk melakukan pekerjaan yang terbaik"></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label28" runat="server" Text="012 Meluangkan waktu untuk menggali potensi serta mengajari keterampilan2 & ilmu2 baru kepada anggota tim kerja"></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label31" runat="server" Text="013 Melakukan briefing harian / mingguan untuk mengkomunikasikan pembagian & pengaturan kerja anggotanya."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label35" runat="server" Text="014 Memberi arahan terhadap hambatan teknis pekerjaan anggota tim kerja."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label33" runat="server" Text="015 Turut serta menyelesaikan hambatan teknis pekerjaan anggota tim kerja."></asp:Label></b>
                        ...
                        <b><asp:Label ID="Label37" runat="server" Text="016 Sangat memahami prosedur & teknis pekerjaannya dan tim kerjanya"></asp:Label></b>
                        <asp:RadioButtonList ID="RadioButton16" style="margin-left:30px" runat="server" CssClass="radio" RepeatLayout="Flow" RepeatDirection="Horizontal">
                         ...
                         <b><asp:Label ID="Label39" runat="server" Text="017 Komentar"></asp:Label></b><br />
