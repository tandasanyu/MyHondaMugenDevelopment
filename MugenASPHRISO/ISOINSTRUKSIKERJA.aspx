<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ISOINSTRUKSIKERJA.aspx.vb" Inherits="ISOINSTRUKSIKERJA" title="Dokumen Instruksi Kerja" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container">
        <ul class="breadcrumb">
          ...
          <li class="active"><span class="glyphicon glyphicon-briefcase"></span> &nbsp Instruksi Kerja</li>
        </ul>
        <asp:Button ID="BtnMasterInstruksi" runat="server" Text="Dokumen Instruksi Kerja" class="button button1" />
        ...
        <asp:MultiView ID="MultiViewError" runat="server" Visible="TRUE">
            <asp:View ID="Viewerr00" runat="server">
                <asp:Label ID="lblMsgBox" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="Red">Judul Permohonan</asp:Label>
            </asp:View> 
        </asp:MultiView>

        <asp:MultiView ID="MultiViewDept" runat="server" Visible="TRUE">
            <asp:View ID="View7" runat="server">
                  <div class="container">
                    <br />
                    <center>
                        <h2 style="font-family:Cooper Black;">DOKUMEN INSTRUKSI KERJA</h2>
                    </center>
	            </div>  <br /><br />

                <asp:SqlDataSource ID="SqlDataDept" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT * FROM [DATA_DEPARTMENT] order by dept_nama asc"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                </asp:SqlDataSource>                                             
                <asp:ListView ID="LvDetailDept" runat="server" DataSourceID="SqlDataDept" DataKeyNames ="DEPT_NAMA">
                    <LayoutTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("DEPT_NAMA")%></td>
                            <td align="center"><asp:LinkButton ID="lnkSelect" Text='Detail' CommandName="Select" runat="server" ><img src="img/details.png" width="60px" height="50px" /></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                    <EmptyDataTemplate>Data Department Tidak diketemukan</EmptyDataTemplate> 
                    <EmptyItemTemplate>Data Department Tidak diketemukan</EmptyItemTemplate>              
                </asp:ListView>
            </asp:View> 
        </asp:MultiView>
        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
            <asp:View ID="View1Akses" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIBUAT2], [DOKUMEN_TGLDIBUAT2], [DOKUMEN_KETERANGAN], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE ([DOKUMEN_DEPARTMENT] = ? AND [DOKUMEN_JENIS]='C') ORDER BY DOKUMEN_NO ASC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                     <selectparameters>
                ...
                <asp:ListView ID="LvDetailMaster" runat="server" DataSourceID="SqlDataMutuMaster" DataKeyNames ="DOKUMEN_NO">
                    <LayoutTemplate>
                        <table id="table-a"  class="table table-bordered table-striped">
                            <thead style="background-color:#4877CF">
                                ...
                                <th style="text-align:center; color:white" class="col-md-3">Dokumen</th>
							    <th style="text-align:center; color:white" class="col-md-3">Keterangan</th>
                    ...
                    <EmptyDataTemplate>Data Instruksi Kerja Tidak diketemukan</EmptyDataTemplate> 
                    <EmptyItemTemplate>Data Instruksi Kerja Tidak diketemukan</EmptyItemTemplate>              
                </asp:ListView>
                <br />
            </asp:View> 
        </asp:MultiView> 
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div class="container">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-briefcase"></span> &nbsp <font style="color:#ffffff">Form Instruksi Kerja</font></div>
                            <div class="panel-body">
                            <center>
                                <h2 style="font-family:Cooper Black;">FORM INSTRUKSI KERJA</h2>
                            </center>
	                        <br /><br />
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-4"><asp:TextBox ID="TxtNamaDokumen" runat="server" class="form-control" Text =""></asp:TextBox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label14" runat="server" Text="Keterangan Dokumen"></asp:Label></td>
                                    <td class="col-md-4"><asp:Textbox ID="txtKeterangan" runat="server" Text ="" CssClass="form-control"></asp:Textbox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label15" runat="server" Text="Dibuat Oleh"></asp:Label></td>
                                    <td class="col-md-4">
                                        <asp:DropDownList ID="dibuat" runat="server" class="form-control required">
                                            ...
                                            <asp:ListItem>Marketing & Delivery Director</asp:ListItem>
					                    </asp:DropDownList>
                                    </td>
                                </tr>
								<tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label123" runat="server" Text="Dibuat Oleh 2"></asp:Label></td>
                                    <td class="col-md-4">
                                        <asp:DropDownList ID="dibuat2" runat="server" class="form-control required">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>CC SPV</asp:ListItem>
                                            <asp:ListItem>Direksi</asp:ListItem>
                                            <asp:ListItem>HRD & GA Head</asp:ListItem>
                                            <asp:ListItem>IT Head</asp:ListItem>
					                        <asp:ListItem>Operation Support Manager</asp:ListItem>
											<asp:ListItem>QMR</asp:ListItem>
                                            <asp:ListItem>Service Manager Ps. Minggu</asp:ListItem>
						                    <asp:ListItem>Service Manager Puri</asp:ListItem>
						                    <asp:ListItem>SM Ps. Minggu</asp:ListItem>
                                ...
                                <tr> 
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label67" runat="server" Text="Department"></asp:Label></td>
                                    <td class="col-md-4"><asp:DropDownList ID="department" runat="server" class="form-control" DataValueField="dept_nama"  DataValueText="dept_nama"  DataSourceID="SqlDataSource1"></asp:DropDownList> 
        ...
        <asp:MultiView ID="MultiViewDistribusiDokumen" runat="server" Visible="TRUE">
            <asp:View ID="View4" runat="server">
                <br /><br /><br />
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-briefcase"></span> &nbsp <font style="color:#ffffff">Form Distribusi Instruksi Kerja</font></div>
                    <div class="panel-body">
                        <center><h2 style="font-family:Cooper Black;">FORM DISTRIBUSI INSTRUKSI KERJA</h2></center>
                        <br /><br />
                        <table class="table table-borderless">
                            <tr>
                                <td class="col-md-2"></td>
                            ...
                            <tr>
                                ...
                                <td class="col-md-2"></td>
                                <td class="col-md-2"><asp:Label ID="Label12" runat="server" Text="Distribusi"></asp:Label></td>
                                <td class="col-md-2">
        ...
        <asp:MultiView ID="MultiViewEditInstruksiKerja" runat="server" Visible="TRUE">
            <asp:View ID="View1" runat="server">
                <div class="container">
                    <br />
                    <center>
                        <h2 style="font-family:Cooper Black;">HISTORY DOKUMEN INSTUKSI KERJA</h2>
                    </center>
	            </div><br /><br />
       
                <asp:SqlDataSource ID="SqlDataEditPanduan" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_LINK], [DOKUMEN_LINKOBSOLETE], [DOKUMEN_TGLDIBUAT], [DOKUMEN_TGLDIBUATPERTAMA] FROM [TRXN_DOKUMEN] WHERE [DOKUMEN_JENIS]='C' AND [DOKUMEN_DIBUAT] = ? ORDER BY [DOKUMEN_TGLDIBUAT] DESC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
         ...
         <asp:MultiView ID="MultiViewFormEditDokumen" runat="server" Visible="TRUE">
            <asp:View ID="View3" runat="server">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <center><h2 style="font-family:Cooper Black;">FORM UPDATE DOKUMEN INSTRUKSI KERJA</h2></center>
	                    <br /><br />
                        <table class="table table-borderless">
                            <tr>
                                <td class="col-md-2"></td>
                            ...
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-2"><asp:Label ID="Label13" runat="server" Text="Keterangan Dokumen"></asp:Label></td>
        ...
        <asp:MultiView ID="MultiViewObsolete" runat="server" Visible="TRUE">
            <asp:View ID="View5" runat="server">
                <div class="container">
                    <br />
                    <center>
                        <h2 style="font-family:Cooper Black;">DOKUMEN OBSOLETE INSTRUKSI KERJA</h2>
                    </center>
	            </div><br /><br />
       
                <asp:SqlDataSource ID="SqlDataObsolete" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMENO_NAMA], [DOKUMENO_TGLTIDAKBERLAKU], [DOKUMENO_LINK], [DOKUMENO_JENIS] FROM [TRXN_DOKUMENO] WHERE [DOKUMENO_JENIS]='C'  ORDER BY [DOKUMENO_TGLTIDAKBERLAKU] DESC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                </asp:SqlDataSource>                                             
                <asp:ListView ID="ListObsolete" runat="server" DataSourceID="SqlDataObsolete" DataKeyNames ="DOKUMENO_NAMA">
                    ...
                    <EmptyDataTemplate>Dokumen Obsolete Instruksi Kerja Tidak diketemukan</EmptyDataTemplate> 
                    <EmptyItemTemplate>Dokumen Obsolete Instruksi Kerja Tidak diketemukan</EmptyItemTemplate>              
                </asp:ListView>
            </asp:View>
        </asp:MultiView>

        <asp:MultiView ID="MultiViewInstruksiKerja" runat="server" Visible="TRUE">
            <asp:View ID="View6" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataView" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIBUAT2], [DOKUMEN_TGLDIBUAT2], [DOKUMEN_KETERANGAN], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK], [DOKUMEND_DISTRIBUSI] FROM [TRXN_DOKUMEN] INNER JOIN [TRXN_DOKUMEND] ON [DOKUMEND_NO] = [DOKUMEN_NO] WHERE ([DOKUMEND_DISTRIBUSI] = ? AND [DOKUMEN_JENIS]='C') ORDER BY DOKUMEN_NO ASC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
			        <selectparameters>
                ...
                <asp:ListView ID="LvDetailView" runat="server" DataSourceID="SqlDataView" DataKeyNames ="DOKUMEN_NO">
                    ...
                    <EmptyDataTemplate>Dokumen Instruksi Kerja Tidak diketemukan</EmptyDataTemplate> 
                    <EmptyItemTemplate>Dokumen Instruksi Kerja Tidak diketemukan</EmptyItemTemplate>              
                </asp:ListView>
            </asp:View>
        </asp:MultiView>
    </div>
