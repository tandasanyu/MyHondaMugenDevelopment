<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="HRDPENILAIANATASANLEADER.aspx.vb" Inherits="HRDPENILAIANATASANLEADER" title="Penilaian Atasan Leader" %>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label21" runat="server" Text="Mengambil alih pekerjaan tambahan di tengah2 proses karena anggota tim dirasa lamban atau tidak benar melaksanakannya."></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label23" runat="server" Text="Mampu menunjukkan rasa empati terhadap permasalahan yang dihadapi oleh anggota tim kerja & bersedia membantu memberikan alternatif solusi jika dibutuhkan."></asp:Label></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label25" runat="server" Text="Meluangkan waktu / kesempatan kepada anggota tim kerja untuk mengungkapkan opini, ide2 / usulan, terhadap suatu hal."></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label27" runat="server" Text="Mampu mendorong rasa percaya diri anggota tim kerja terhadap kemampuannya serta memotivasi untuk melakukan pekerjaan yang terbaik"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label30" runat="server" Text="Meluangkan waktu untuk menggali potensi serta mengajari keterampilan2 & ilmu2 baru kepada anggota tim kerja"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label32" runat="server" Text="Melakukan briefing harian / mingguan untuk mengkomunikasikan pembagian & pengaturan kerja anggotanya."></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label36" runat="server" Text="Memberi arahan terhadap hambatan teknis pekerjaan anggota tim kerja."></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label34" runat="server" Text="Turut serta menyelesaikan hambatan teknis pekerjaan anggota tim kerja."></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="col-md-4"><asp:Label ID="Label38" runat="server" Text="Sangat memahami prosedur & teknis pekerjaannya dan tim kerjanya"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="col-md-2"></td>
                                <td class="col-md-4">
                            ...
                            <tr>
                                <td class="col-md-2"><asp:Label ID="Label39" runat="server" Text="017"></asp:Label></td>
