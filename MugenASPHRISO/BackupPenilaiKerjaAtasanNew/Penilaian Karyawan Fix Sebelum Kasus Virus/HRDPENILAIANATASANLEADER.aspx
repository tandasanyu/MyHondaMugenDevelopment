<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="HRDPENILAIANATASANSALES" title="Penilaian Atasan Sales" %>
			...
			<asp:View ID="View0102Karyawan" runat="server">
			    ...
			    <table class="table table-borderless" align="left">
				    <tr>
			            ...
			            <td class="col-md-4"><asp:Textbox ID="TxtStaffNIK" runat="server" Text="" class="form-control required"></asp:Textbox></td>
                        <td class="col-md-2"><asp:Label ID="Label9" runat="server" Text="Tahun Penilaian"></asp:Label></td>
				        <td class="col-md-4"><asp:Label ID="TahunPenilaian" runat="server" MaxLength="15" Text ="" class="form-control required"></asp:Label></td>
				    </tr>
				    <tr>
                        <td class="col-md-2"><asp:Label ID="Label8" runat="server" Text="Atasan"></asp:Label></td>
				        <td class="col-md-4"><asp:DropDownList ID="lblAtasan" runat="server" class="form-control" > 
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem>BAYU KURNIAWAN</asp:ListItem>
                                <asp:ListItem>DAVID HUTABARAT</asp:ListItem>
                                <asp:ListItem>FENDY WIJAYA WONG</asp:ListItem>
