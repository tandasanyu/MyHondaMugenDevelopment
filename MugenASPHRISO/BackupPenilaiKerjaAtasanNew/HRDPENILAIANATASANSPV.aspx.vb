...
Partial Class HRDPENILAIANATASANSPV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LblUserName.Text = "" Then
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' And hakakses = 'FORM HRD -- PENILAIAN SPV'") = 1 Then
...
ErrHand:
    ...
    Sub SaveTombol()
        ...
        mNilai = "0"
        If RadioButton171.Checked = True Then
            mNilai = 1
        ElseIf RadioButton172.Checked = True Then
            mNilai = 2
        ElseIf RadioButton173.Checked = True Then
            mNilai = 3
        ElseIf RadioButton174.Checked = True Then
            mNilai = 4
        ElseIf RadioButton175.Checked = True Then
            mNilai = 5
        ElseIf RadioButton176.Checked = True Then
            mNilai = 6
        End If
        Call insertabel("017", TxtStaffNama.Text, lblAtasan.Text, mNilai, "", "")
        mNilai = "0"
        If RadioButton181.Checked = True Then
            mNilai = 1
        ElseIf RadioButton182.Checked = True Then
            mNilai = 2
        ElseIf RadioButton183.Checked = True Then
            mNilai = 3
        ElseIf RadioButton184.Checked = True Then
            mNilai = 4
        ElseIf RadioButton185.Checked = True Then
            mNilai = 5
        ElseIf RadioButton186.Checked = True Then
            mNilai = 6
        End If
        Call insertabel("018", TxtStaffNama.Text, lblAtasan.Text, mNilai, "", "")
        mNilai = "0"
        If RadioButton191.Checked = True Then
            mNilai = 1
        ElseIf RadioButton192.Checked = True Then
            mNilai = 2
        ElseIf RadioButton193.Checked = True Then
            mNilai = 3
        ElseIf RadioButton194.Checked = True Then
            mNilai = 4
        ElseIf RadioButton195.Checked = True Then
            mNilai = 5
        ElseIf RadioButton196.Checked = True Then
            mNilai = 6
        End If
        Call insertabel("019", TxtStaffNama.Text, lblAtasan.Text, mNilai, "", "")
        mNilai = "0"
        If RadioButton201.Checked = True Then
            mNilai = 1
        ElseIf RadioButton202.Checked = True Then
            mNilai = 2
        ElseIf RadioButton203.Checked = True Then
            mNilai = 3
        ElseIf RadioButton204.Checked = True Then
            mNilai = 4
        ElseIf RadioButton205.Checked = True Then
            mNilai = 5
        ElseIf RadioButton206.Checked = True Then
            mNilai = 6
        End If
        Call insertabel("020", TxtStaffNama.Text, lblAtasan.Text, mNilai, "", "")
        mNilai = "0"
