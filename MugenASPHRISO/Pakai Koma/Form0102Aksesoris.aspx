...
<br />
    ...
    <asp:MultiView ID="MultiView1a" runat="server" Visible="TRUE">
        ...
        <asp:View ID="V3SPK" runat="server">
            ...
            <tr> 
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF; font-weight: bold;">
                   <asp:Label ID="Label6" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
                <td style="width: 80%;  ">
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF; font-weight: bold;">
                    <asp:Label ID="Label7" runat="server" height= "21px" Text="Tipe permohonan"></asp:Label>
                </td>
                <td style="width: 80%;  ">
             ...
             <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF; font-weight: bold;">
                    <asp:Label ID="Label36" runat="server" height= "21px" Text="Alasan"></asp:Label>
                </td>
                <td style="width: 80%;  ">
            ...
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size:medium ;">
            <tr> 
                <td style="width: 20%; background-color:#CCCCFF ; font-weight: bold;" >
                   <asp:Label ID="Label11" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF ;">
                   <asp:Label ID="lblMohonDetailSPK" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            </table>             
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size: medium">
            <tr> 
                <td style="width: 20%; font-weight: bold;">
                   <asp:Label ID="Label23" runat="server" height= "21px" Text="Nama SPK" ForeColor="Black"></asp:Label>
                </td>
                <td style="width: 80%;">
                    <asp:Label ID="LblNama" runat="server" height= "21px" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold; ">
                    <asp:Label ID="Label24" runat="server" height= "21px" Text="Nama Sales" ForeColor="Black"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF ;">
                    <asp:Label ID="LblSales" runat="server" height= "21px" ></asp:Label>
                    <asp:Label ID="LblSalesSPV" runat="server" height="21px"></asp:Label>
                    <asp:Label ID="LblSalesSPV0" runat="server" height="21px"></asp:Label>
                </td>
            </tr>
            </table>
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size: medium">
            <tr>
                <td style="width: 20%; font-weight: bold;">
                    <asp:Label ID="Label25" runat="server" height= "21px" Text="Tipe"></asp:Label>
                </td>
                <td style="width: 30%; ">
                    <asp:Label ID="LblCdType" runat="server" Text=""></asp:Label>
                    <asp:Label ID="LblCdTypeNamaDetail" runat="server" Text=""></asp:Label>
                    <asp:Label ID="lblGroupTipeNamaDetail" runat="server" Text=""></asp:Label>
                </td>
                <td style="width: 20%; font-weight: bold; ">
                   <asp:Label ID="Label28" runat="server" height= "21px" Text="Warna"></asp:Label>
                </td>
                <td style="width: 30%; ">
            ...
            <tr>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label30" runat="server" height= "21px" Text="Nomor Rangka"></asp:Label>
                </td>
                <td style="width: 30%; background-color:#CCCCFF ;">
                    <asp:Label ID="lblNorangka" runat="server" Text=""></asp:Label>
                </td>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label31" runat="server" height= "21px" Text="Tahun/Road[N] Offroad[F]"></asp:Label>
                </td>
                <td style="width: 30%; background-color:#CCCCFF ;">
            ...
            <tr>
                <td style="width: 20%;font-weight: bold; ">
                    <asp:Label ID="Label32" runat="server" height= "21px" Text="Harga"></asp:Label></td>
                <td style="width: 30%; ">
            ...
            <tr>
            <td style="width: 20%; background-color:#CCCCFF ; font-weight: bold;">
            <asp:Label ID="Label33" runat="server" height= "21px" Text="Potongan"></asp:Label>
            </td>
            <td style="width: 30%; background-color:#CCCCFF ;">
            ...
            <td style="width: 30%; background-color:#CCCCFF ;"></td>
            </tr>
            
            <tr>
                <td style="width: 20%;font-weight: bold; ">
                    <asp:Label ID="Label71" runat="server" height= "21px" Text="Subsidi"></asp:Label>
                </td>
                <td style="width: 30%; ">
                    <asp:Label ID="LblSubsidi" runat="server" Text=""></asp:Label>
                </td>
                <td style="width: 20%;font-weight: bold; ">
                </td>
                <td style="width: 30%; ">
            ...
            <tr>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label76" runat="server" height= "21px" Text="Komisi"></asp:Label>
                </td>
                <td style="width: 30%; background-color:#CCCCFF ;">
                    <asp:Label ID="LblKomisi" runat="server" Text=""></asp:Label>
                </td>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;"></td>
                <td style="width: 30%; background-color:#CCCCFF ;"></td>
            </tr>
            <tr>
                <td style="width: 20%; font-weight: bold;">
                <asp:Label ID="Label39" runat="server" height= "21px" Text="Total"></asp:Label>     
                </td>
                <td style="width: 30%; ">
            ...
            <tr>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label40" runat="server" height= "21px" Text="Jenis Pembayaran"></asp:Label>
                </td>
                <td style="width: 30%; background-color:#CCCCFF ;">
                ...
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label41" runat="server" height= "21px" Text="Tenor"></asp:Label>
                </td>
                <td style="width: 30%; background-color:#CCCCFF ;">
            ...
            <tr>
            <td style="width: 20%; font-weight: bold;">
               <asp:Label ID="Label43" runat="server" height= "21px" Text="Total Bayar"></asp:Label>
            </td>
            <td style="width: 30%; ">
                <asp:Label ID="LblBayar" runat="server" Text=""></asp:Label>
            </td>
            <td style="width: 20%; font-weight: bold;">
               <asp:Label ID="Label50" runat="server" height= "21px" Text="Keharusan Uang Muka (Berdasarkan PO leasing)"></asp:Label>
            </td>
            <td style="width: 30%; ">
            ...
            <tr> 
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                   <asp:Label ID="Label16" runat="server" height= "21px" Text="Tanggal Mohon"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF ;">
                   <asp:Label ID="lblMohonDetailTgl" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
             <tr>
                <td style="width: 20%;font-weight: bold; ">
                    <asp:Label ID="Label13" runat="server" height= "21px" Text="Tipe permohonan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="lblMohonDetailTipe" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            
            <tr>
                <td style="width: 20%; background-color:#CCCCFF ;font-weight: bold;">
                    <asp:Label ID="Label14" runat="server" height= "21px" Text="Alasan"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF ;">
                   <asp:Label ID="lblMohonDetailAlasan" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%;font-weight: bold;">
                    <asp:Label ID="lblMohonDetailJudul" runat="server" height= "21px" Text="Proses Persetujuan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="lblMohonDetailProsesPersetujuan" runat="server" height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color:#CCCCFF;font-weight: bold;">
                    <asp:Label ID="Label15" runat="server" height= "21px" Text="Posisi Persetujuan Terakhir"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF;">
                   <asp:Label ID="lblMohonDetailProsesPersetujuanAkhir" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%;font-weight: bold;">
                    <asp:Label ID="lblMohonDetailJudul1" runat="server" height= "21px" Text="Nilai perubahan"></asp:Label>
                </td>
                <td style="width: 80%;">
                   <asp:Label ID="lblMohonDetailNilai1" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%;font-weight: bold;">
                    <asp:Label ID="lblMohonDetailJudul2" runat="server" height= "21px" Text="Nilai perubahan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="lblMohonDetailNilai2" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%;font-weight: bold;">
                    <asp:Label ID="lblMohonDetailJudul3" runat="server" height= "21px" Text="Nilai perubahan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="lblMohonDetailNilai3" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; font-weight: bold;">
                    <asp:Label ID="lblMohonDetailJudul4" runat="server" height= "21px" Text="Nilai perubahan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="lblMohonDetailNilai4" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color:#CCCCFF;font-weight: bold;"> 
                <asp:Label ID="Label18" runat="server" height= "21px" Text="Nomor Mohon"></asp:Label>
                </td>
                <td style="width: 80%;background-color:#CCCCFF;">
                   <asp:Label ID="LblNomormohon" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; font-weight: bold;">
                    <asp:Label ID="Label20" runat="server" height= "21px" Text="Tanggal Update Data SPK"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="LblUpdateDataSPK" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%; background-color:#CCCCFF;font-weight: bold;">
                    <asp:Label ID="Label46" runat="server" height= "21px" Text="Nomor Mohon"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF;">
                   <asp:Label ID="LblNomor" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%;font-weight: bold; ">
                    <asp:Label ID="Label45" runat="server" height= "21px" Text="Proses SPV"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="LblAskSPV" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%; background-color:#CCCCFF;font-weight: bold;">
                    <asp:Label ID="Label47" runat="server"  height= "21px" Text="Proses Sales Manager"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF;">
                   <asp:Label ID="LblAskSM" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%; font-weight: bold;">
                    <asp:Label ID="Label49" runat="server"  height= "21px" Text="Proses Operasional Sales Manager"></asp:Label>
                </td>
                <td style="width: 80%; ">
                   <asp:Label ID="LblAskOSM" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>

            <tr>
                <td style="width: 20%; background-color:#CCCCFF;font-weight: bold;">
                    <asp:Label ID="Label51" runat="server"  height= "21px" Text="Proses Direktur"></asp:Label>
                </td>
                <td style="width: 80%; background-color:#CCCCFF;">
                   <asp:Label ID="LblAskDIR" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
        </table>
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size: medium">
            ...
            <tr>
                <td style="width: 100%; ">
                <asp:Label ID="LblStatusUpdateSPK" runat="server" height="21px" Text="Status Update SPK" Font-Bold="True" 
            ...
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size: medium;">
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label88" runat="server" height= "21px" Text="Nomor Rangka"></asp:Label>
                </td>
                <td style="width: 50%; ">
                    <asp:TextBox ID="TxtChangeNorangka" runat="server" text="" Width="235px"  CssClass="uppercase"></asp:TextBox>
                    <asp:Label ID="Label90" runat="server" height="21px" Text=" " ForeColor="Red"></asp:Label>
                    <asp:Button ID="ButtonSimpan1" runat="server" BackColor="#003399" Font-Overline="False" Height="20px" 
                        Text="Cari Rangka (Isi % Semua tampil)" Width="225px" />
                </td>
                <td style="width: 30%; color: #FF0000;" > &lt;---Isi Nomor Rangka yang ada pada stok</td>
            </tr>
            </table> 
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label92" runat="server" height= "21px" Text="Faktur > Nama"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturNama" runat="server" text="" Width="100%" MaxLength="30" CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label102" runat="server" height= "21px" Text="Faktur > No KTP"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturNoKTP" runat="server" text="" Width="100%" MaxLength="20"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label93" runat="server"  height= "21px" Text="Faktur > Alamat"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturAlamat" runat="server" text="" Width="100%" Height="73px" MaxLength="80"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label94" runat="server"  height= "21px" Text="Faktur > Kota"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturKota" runat="server" text="" Width="100%" MaxLength="20"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label96" runat="server"  height= "21px" Text="Faktur > Kode Pos"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturPos" runat="server" text="" Width="100%" MaxLength="5"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label98" runat="server"  height= "21px" Text="Faktur > No Handphone"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturNoHP" runat="server" text="" Width="100%" MaxLength="20"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                ...
                <asp:TextBox ID="TxtTglLahir" runat="server" Width="130px" MaxLength="1" style="text-align:justify" ValidationGroup="MKE" />
                <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="False" 
                        BorderColor="Yellow" Height="20px" ImageUrl="~/calendar.png" />
  
                <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender15" runat="server"
                 TargetControlID="TxtTglLahir" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                 OnInvalidCssClass="MaskedEditError" MaskType="Date" DisplayMoney="None" AcceptNegative="Left" ErrorTooltipEnabled="True" />               
                
                <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator15" runat="server"
                ControlExtender="MaskedEditExtender15" ControlToValidate="TxtTglLahir" EmptyValueMessage="Date is required"
                ...
                <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TxtTglLahir" PopupButtonID="ImageButton1" />

                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label100" runat="server" height= "21px" Text="Faktur > Agama"></asp:Label></td>
                <td style="width: 80%; ">
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label103" runat="server" height= "21px" Text="Faktur > Pilih Nomor Polisi"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtFakturNoPolisi" runat="server" text="" Width="100%" MaxLength="10"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label107" runat="server"  height= "21px" Text="Faktur > Catatan"></asp:Label></td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtNOTE" runat="server" text="" Width="100%" MaxLength="50"  CssClass="uppercase"></asp:TextBox></td>
            </tr>
            </table> 
            </asp:View> 
            </asp:MultiView>
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtChangeHargaUnit" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender10" runat="server"
                    TargetControlID="TxtChangeHargaUnit" Mask="99,999,999,999" MessageValidatorTip="true"
                    ...
                    ControlExtender="MaskedEditExtender10" ControlToValidate="TxtChangeHargaUnit" IsValidEmpty="false"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtChangeHargaDisc" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender11" runat="server"
                    TargetControlID="TxtChangeHargaDisc" Mask="99,999,999,999" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator11" runat="server"
                    ControlExtender="MaskedEditExtender11" ControlToValidate="TxtChangeHargaDisc" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*" InvalidValueBlurredMessage="*" MaximumValueBlurredMessage="*"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtChangeHargaSubs" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender12" runat="server"
                    TargetControlID="TxtChangeHargaSubs" Mask="99,999,999,999" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator12" runat="server"
                    ControlExtender="MaskedEditExtender12" ControlToValidate="TxtChangeHargaSubs" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*" InvalidValueBlurredMessage="*" MaximumValueBlurredMessage="*"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtChangeHargaKoms" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender13" runat="server"
                    TargetControlID="TxtChangeHargaKoms" Mask="99,999,999,999" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator13" runat="server"
                    ControlExtender="MaskedEditExtender13" ControlToValidate="TxtChangeHargaKoms" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*" InvalidValueBlurredMessage="*" MaximumValueBlurredMessage="*"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtChangeTahun" runat="server" Width="130px" Height="16px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender14" runat="server"
                    TargetControlID="TxtChangeTahun" Mask="99" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator14" runat="server"
                    ControlExtender="MaskedEditExtender14" ControlToValidate="TxtChangeTahun" IsValidEmpty="false"
                    MaximumValue="99" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99"
                    EmptyValueBlurredText="*" InvalidValueBlurredMessage="*" MaximumValueBlurredMessage="*"
                    MinimumValueBlurredText="*" ValidationGroup="MKE" />
            ...
            <table style="width: 100%; height:inherit; font-family: Calibri; font-size: medium;">
             <tr>
                ...
                <td style="width: 80%; background-color:#CCCCFF ;">
                    <asp:Label ID="lblPemohon" runat="server"  
                    height= "21px" Text="Pemohon"></asp:Label>
                </td>
            </tr>
             <tr>
            ...
            <tr> 
                <td style="width: 20%; background-color :#008000 ;  color: #FFFFFF;">
                   <asp:Label ID="Label42" runat="server"  height= "21px" Text="Nomor SPK"></asp:Label>
                </td>
                <td style="width: 80%;">
                    ...
                    <asp:Label ID="LblNoMohon" runat="server" height="21px" Text="No Mohon" Width="118px"></asp:Label>
                </td>
            </tr>
             <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label34" runat="server" height= "21px" Text="Tipe Kendaraan"></asp:Label>
                </td>
                <td style="width: 80%;">
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="lblJudul" runat="server" height= "21px" Text="Kode Aksesoris"></asp:Label>
                </td>
                <td style="width: 80%;">
                    <asp:Label ID="LblAksesorisKode" runat="server" height="21px" Text="Kode Aksesoris"></asp:Label>
                    <asp:Label ID="LblApproved" runat="server" height="21px" Text="Tipe Kendaraan" Visible="False"></asp:Label>
                </td>
            </tr>
             <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="LblJudulAksesorisNama" runat="server" height= "21px" Text="Nama Aksesoris"></asp:Label>
                </td>
                <td style="width: 80%;"> 
                    <asp:Label ID="LblAksesorisNama" runat="server" height="21px" Text="Tipe Kendaraan"></asp:Label>
                </td>
            </tr>
             <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label27" runat="server" height= "21px" Text="Catatan"></asp:Label>
                </td>
                <td style="width: 80%; ">
                    <asp:Label ID="LblAksesorisDesc" runat="server" height="21px" Text="Catatan"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label2" runat="server" height= "21px" Text="Status"></asp:Label>
                </td>
                <td style="width: 80%; ">
                    <asp:DropDownList ID="DropDownList2" runat="server" Width="148px" AutoPostBack="true"  >
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtAksesorisQty" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender18" runat="server"
                    TargetControlID="TxtAksesorisQty" Mask="99" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" 
                    ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator18" runat="server"
                    ControlExtender="MaskedEditExtender18" ControlToValidate="TxtAksesorisQty" IsValidEmpty="false"
                    MaximumValue="20" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 20" MinimumValueMessage="Number &lt; 1"
                    MinimumValue="1" Display="Dynamic" TooltipMessage="Input a number from 1 to 20"
                    EmptyValueBlurredText="*"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label21" runat="server" height= "21px" Text="Harga Jual Mugen"></asp:Label>
                </td>
                <td style="width: 80%; ">
                    <asp:Label ID="LblalertChangeHargaUnit" runat="server" height="21px" Text="" ForeColor="Red"></asp:Label>
                    <asp:Label ID="LblAksesorisModal" runat="server" height="21px" Text="Tipe Kendaraan"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label26" runat="server" height= "21px" Text="Harga Jual "></asp:Label>
                </td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtHargaAss" runat="server" Width="130px" ValidationGroup = "MKE" />
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender16" runat="server"
                    TargetControlID="TxtHargaAss" Mask="99,999,999,999" MessageValidatorTip="true"
                    OnFocusCssClass="MaskedEditFocus"  OnInvalidCssClass="MaskedEditError" MaskType="Number"
                    InputDirection="RightToLeft" AcceptNegative="Left" DisplayMoney="None" 
                    ErrorTooltipEnabled="True" />
                    
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator16" runat="server"
                    ControlExtender="MaskedEditExtender16" ControlToValidate="TxtHargaAss" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    <asp:Label ID="Label3" runat="server" height= "21px" Text="Keterangan"></asp:Label>
                    </td>
                <td style="width: 80%; ">
                    <asp:TextBox ID="TxtCatatan" runat="server" text="" Width="727px" MaxLength="45"  CssClass="uppercase"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 20%; background-color: #008000;  color: #FFFFFF;">
                    &nbsp;</td>
                <td style="width: 80%; ">
                    <asp:Label ID="LblWarna" runat="server" height="21px" Text="WARNA HARUS DISISI" ForeColor="Red" Font-Bold="True"></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 80%; ">
                <asp:Label ID="LblNomorMohonOPT" runat="server" Font-Bold="True" Font-Strikeout="False" ></asp:Label>
                <asp:Label ID="LblStatusUpdateOPT" runat="server" height="21px" Text="Status Update SPK" Font-Bold="True" 
           ...
           <tr> 
            ...
            BackColor="Yellow" Height="20px" ImageUrl="~/calendar.png" />
            ...
            <tr> 
                ...
                <td style="width: 35%; background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasHrgJual" runat="server" Width="130px" ValidationGroup = "MKE" />
                ...
                <td style="width: 35%; background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasHrgAks" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender1" ControlToValidate="TxtMobkasHrgAks" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr> 
                ...
                <td style="width: 35%;  background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasHrgPot" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender3" ControlToValidate="TxtMobkasHrgPot" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr> 
                ...
                <td style="width: 35%; background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasHrgKomisi" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender4" ControlToValidate="TxtMobkasHrgKomisi" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr> 
                ...
                <td style="width: 35%;  background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasHrgSubsidi" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender6" ControlToValidate="TxtMobkasHrgSubsidi" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr> 
                ...
                ControlExtender="MaskedEditExtender9" ControlToValidate="TxtMobkasFTglLahir" EmptyValueMessage="Date is required"
                InvalidValueMessage="Date is invalid" Display="Dynamic" IsValidEmpty="false" TooltipMessage="Input a date"
                EmptyValueBlurredText="*" 
                        InvalidValueBlurredMessage="Format MM/DD/YYYY Bulan Tanggal Tahun" 
                        ValidationGroup="MKE" >
                ...
                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TxtMobkasFTglLahir" PopupButtonID="ImageButton1" />
            ...
            <tr> 
                ...
                <td style="width: 85%; ">
                    <asp:TextBox ID="TxtMobkasModal" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender7" ControlToValidate="TxtMobkasModal" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
            ...
            <tr> 
                ...
                <td style="width: 85%; background-color:#CCCCFF ;">
                    <asp:TextBox ID="TxtMobkasModalPPN" runat="server" Width="130px" ValidationGroup="MKE" />
                    ...
                    ControlExtender="MaskedEditExtender8" ControlToValidate="TxtMobkasModalPPN" IsValidEmpty="false"
                    MaximumValue="99000000000" EmptyValueMessage="Number is required" InvalidValueMessage="Number is invalid"
                    MaximumValueMessage="Number &gt; 99000000000" MinimumValueMessage="Number &lt; 0"
                    MinimumValue="0" Display="Dynamic" TooltipMessage="Input a number from 0 to 99000000000"
                    EmptyValueBlurredText="*"
        ...
        <asp:View ID="V4Jadwal" runat="server">
            ...
            BackColor="Yellow" Height="20px" ImageUrl="~/calendar.png" />
                <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender17" runat="server"
                 TargetControlID="txtDate" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                 OnInvalidCssClass="MaskedEditError" MaskType="Date" DisplayMoney="None" AcceptNegative="Left" ErrorTooltipEnabled="True" />               
                <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator17" runat="server"
                ControlExtender="MaskedEditExtender17" ControlToValidate="txtDate" EmptyValueMessage="Date is required"
                InvalidValueMessage="Date is invalid" Display="Dynamic" IsValidEmpty="false" TooltipMessage="Input a date"
                EmptyValueBlurredText="*" 
                        InvalidValueBlurredMessage="Format MM/DD/YYYY Bulan Tanggal Tahun" 
                        ValidationGroup="MKE" >
                ...
                <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtDate" PopupButtonID="ImgBntCalc" />
