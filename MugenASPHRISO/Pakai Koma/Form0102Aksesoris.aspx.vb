...
Partial Class Form02Aksesoris
    ...
    Protected Sub ButtonSimpan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSimpan.Click
        ...
        If DropDownList2.Text = "BAYAR" And _
           (nLg(TxtAksesorisQty.Text) * nLg(TxtHargaAss.Text)) < (nLg(TxtAksesorisQty.Text) * nLg(LblAksesorisModal.Text)) Then
            LblErrorSave.Text = LblErrorSave.Text & ",Harga Jual kurang dari harga jual mugen "
        End If
    ...
    Sub DropDownList3_DO()
        ...
        If DropDownList3.Text = "ENTRY ALASAN MELEBIHI MAKSIMAL DISKON" Then
            'MultiViewMhnInpTahun.ActiveViewIndex = 0
        End If
    ...
    Sub ClearInputDataSPKMobilSecond()
        ...
        TxtMobkasTglLahir.Text = Now() : DropDownListAgama.SelectedIndex = -1
        ...
        TxtMobkasHrgJual.Text = "10000" : TxtMobkasHrgKomisi.Text = "0" : TxtMobkasHrgPot.Text = "0" : TxtMobkasHrgSubsidi.Text = "0"
...
ErrHand:
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Dim mNilaiTxtChangeHargaDisc As String = nLg(TxtChangeHargaDisc.Text)
        Dim mNilaiTxtChangeHargaUnit As String = nLg(TxtChangeHargaUnit.Text)
        Dim mNilaiTxtChangeHargaSubs As String = nLg(TxtChangeHargaSubs.Text)
        Dim mNilaiTxtChangeHargaKoms As String = nLg(TxtChangeHargaKoms.Text)
        Call Msg_err("")
        ...
        ElseIf DropDownList3.Text = "ENTRY TOTAL UBAH HARGA UNIT MENJADI" And _
           (Not IsNumeric(mNilaiTxtChangeHargaUnit) Or Val(mNilaiTxtChangeHargaUnit) <= 0) Then
        ...
        ElseIf DropDownList3.Text = "ENTRY TOTAL UBAH HARGA DISKON MENJADI" And _
               (Not IsNumeric(mNilaiTxtChangeHargaDisc) Or Val(mNilaiTxtChangeHargaDisc) <= 0) Then
        ...
        ElseIf DropDownList3.Text = "ENTRY ALASAN SUBSIDI" And _
               (Not IsNumeric(mNilaiTxtChangeHargaSubs) Or Val(mNilaiTxtChangeHargaSubs) <= 0) Then
            Call Msg_err("ISIAN HARGA PERUBAHAN SUBSIDI BELUM DIISI") : Exit Sub
        ElseIf DropDownList3.Text = "ENTRY ALASAN KOMISI" And _
               (Not IsNumeric(mNilaiTxtChangeHargaKoms) Or Val(mNilaiTxtChangeHargaKoms) <= 0) Then
        ...
        If mAroval <> "" And mNomorMohon <> "" Then
            ...
            If DropDownList3.Text = "ENTRY TOTAL UBAH HARGA UNIT MENJADI" Then
                mTxtInsert = "'" & mNilaiTxtChangeHargaUnit & "','','','',''"
            ElseIf DropDownList3.Text = "ENTRY TOTAL UBAH HARGA DISKON MENJADI" Then
                mTxtInsert = "'','" & mNilaiTxtChangeHargaDisc & "','','',''"
            ElseIf DropDownList3.Text = "ENTRY ALASAN SUBSIDI" Then
                mTxtInsert = "'','','" & mNilaiTxtChangeHargaSubs & "','',''"
            ElseIf DropDownList3.Text = "ENTRY ALASAN KOMISI" Then
                mTxtInsert = "'','','','" & mNilaiTxtChangeHargaKoms & "',''"
            ElseIf DropDownList3.Text = "ENTRY ALASAN MELEBIHI MAKSIMAL DISKON" Then
                mTxtInsert = "'" & mNilaiTxtChangeHargaUnit & "','" & mNilaiTxtChangeHargaDisc & "','" & _
                             mNilaiTxtChangeHargaSubs & "','" & mNilaiTxtChangeHargaKoms & "','" & TxtChangeTahun.Text & "'"
            ElseIf DropDownList3.Text = "ENTRY ALASAN DO/ISI NOMOR RANGKA" Then
                mTxtInsert = "'" & TxtPetik(Left(Trim(TxtChangeNorangka.Text), 20)) & "','','','',''"
            End If
    ...
    Protected Sub ButtonSimpan1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSimpan1.Click
        If TxtCariNamaAssesoris.Text = "" Then
            TxtCariNamaAssesoris.Text = "%"
        End If
    ...
    Protected Sub LvPermohonan_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvPermohonan.SelectedIndexChanged
        ...
        If LblNomormohon.Text <> "" Then
            LblNomor.Text = "" : LblAskSPV.Text = "" : LblAskSM.Text = "" : LblAskOSM.Text = "" : LblAskDIR.Text = ""

            Call GetDataMasterDetail("SELECT * FROM TRXN_SPKAH WHERE NOMOR_SPK='" & Txt_NoSPKMohon.Text & "' AND TANGGAL_ENTRY='" & mKode & "'")
    ...
    Protected Sub Button6_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button6.Click
        If InStr(lblMohonDetailTipe.Text, "ENTRY") <> 0 And LblNomormohon.Text <> "" Then
    ...
    Protected Sub Button10_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button10.Click
        If LblMobkasNoSPK.Text = "" Then
            MsgBox(GetNumerikTxt(TxtMobkasHrgJual.Text) & "  " & TxtMobkasTglLahir.Text)
            Dim Mytxtsql As String
            Mytxtsql = "INSERT INTO TRXN_SPK(SPK_No,SPK_Tanggal,SPK_CdCustomer,SPK_Nama1,SPK_Nama2,SPK_FHP2,SPK_Alamat,SPK_Kota,SPK_Kodepos,SPK_Phone,SPK_Agama,SPK_TglLahir,SPK_NPWP,SPK_PKP,SPK_FHP,SPK_FEmail,SPK_PINBB," & "SPK_NoRangka,SPK_CdType,SPK_CdWarna,SPK_Tahun,SPK_Road," & _
                       "SPK_STSPPN,SPK_STSFPAJAK,SPK_NOFPAJAK,SPK_TGLFPAJAK,SPK_Keterangan," & _
                       "SPK_Piutang,SPK_CdLease,SPK_NOVCRDISC,SPK_Potongan,SPK_HrgJadi,SPK_HrgDP," & _
                       "SPK_HrgADM,SPK_HrgAngsur,SPK_HrgASR,SPK_Hari," & _
                       "SPK_CdSales,SPK_CdSSales,SPK_Direct,SPK_TGLSPK,SPK_TGLURT,SPK_MVoucher,SPK_KdRef) VALUES ('" & _
                       txtnospk.Text & "',GETDATE(),'NEW','" & TxtPetik(TxtMobkasNama.Text) & "','" & TxtPetik(TxtMobkasFNama.Text) & "','" & TxtMobkasFHp.Text & "','" & TxtPetik(TxtMobkasAlamat.Text) & "','" & TxtPetik(TxtMobkasKota.Text) & "','" & TxtPetik(TxtMobkasPos.Text) & "','" & TxtPetik(TxtMobkasPhone.Text) & "','" & Val(CStr(DropDownListAgama.SelectedIndex)) + 1 & "','" & DtFrSQL(TxtMobkasTglLahir.Text) & "','','','" & TxtMobkasHp.Text & "','" & TxtMobkasEmail.Text & "','','" & TxtMobkasRangka.Text & "','" & TxtMobkasTipe.Text & "','" & TxtMobkasWarna.Text & "','" & TxtPetik(TxtMobkasTahun.Text) & "','" & IIf(DropDownRoad.SelectedIndex = 0, "N", "F") & "','','','',NULL,'" & TxtPetik(TxtMobkasKeterangan.Text) & "'," & ndb(TxtMobkasHrgJual.Text) & ",'" & TxtMobkasLease.Text & "',''," & ndb(TxtMobkasHrgPot.Text) & ",0,," & nLg(TxtMobkasHrgSubsidi.Text) & ",0," & nLg(TxtMobkasHrgKomisi.Text) & "," & ndb(TxtMobkasJTP.Text) & ",'" & TxtMobkasSales.Text & "','" & TxtMobkasSPV.Text & "','" & DropDownListStatus.SelectedIndex & "',GETDATE(),GETDATE(),0,'')"
