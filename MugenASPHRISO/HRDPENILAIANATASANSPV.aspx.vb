...
ErrHand:
    ...
    Sub SaveTombol()
        Call UpdateData_Server("DELETE FROM TRXN_KPIN WHERE KPIN_USER='" & TxtStaffNama.Text & "' AND KPIN_TGL like '%" & TahunPenilaian.Text & "%' AND KPIN_GROUP = '2'")
        ...
        Else
            ...
            Call insertabel("017", TxtStaffNama.Text, lblAtasan.Text, RadioButton17.Text, "", "")
            Call insertabel("018", TxtStaffNama.Text, lblAtasan.Text, RadioButton18.Text, "", "")
            Call insertabel("019", TxtStaffNama.Text, lblAtasan.Text, RadioButton19.Text, "", "")
            Call insertabel("020", TxtStaffNama.Text, lblAtasan.Text, RadioButton20.Text, "", "")
            Call insertabel("021", TxtStaffNama.Text, lblAtasan.Text, "", "", TxtKomentar.Text)
            Response.Write("<script>alert('Anda telah sukses melakukan penilaian Atasan!')</script>")
            Response.Write("<script>window.location.href='HRDPENILAIANATASANSPV.aspx';</script>")
        End If
    End Sub
