...
<%@ Page Language="VB" MasterPageFile ="~/MasterPage.master"  AutoEventWireup="false" CodeFile="HRDFORMKARYAWAN2.aspx.vb" Inherits="HRDFORMKARYAWAN2" title="Form Karyawan" %>
    ...
    <div class="container">
		...
		<asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
			<asp:View ID="View0102Karyawan" runat="server">
                ...
                <div id="data_akun" runat="server" visible="false">
                    <br />
			        <hr />
			        <h3 style="font-family:Blunter;"><span class="glyphicon glyphicon-briefcase"></span> Data Akun</h3>
			        <br />
			        <table class="table table-borderless" align="left">
			            <tr> 
                            <td class="col-md-2"><asp:Label ID="Label54" runat="server" Text="Username"></asp:Label></td>
			                <td class="col-md-4"><asp:TextBox ID="txtUsername" runat="server" MaxLength="25" Text ="" class="form-control required"></asp:TextBox></td>
                            <td class="col-md-2"><asp:Label ID="Label55" runat="server" Text="Password"></asp:Label></td>
		                    <td class="col-md-4"><asp:TextBox ID="txtPassword"  runat="server" MaxLength="20" Text ="" class="form-control required"></asp:TextBox></td>  
                        </tr>
                    </table>
                </div>
		        <div id="data_kerja" runat="server" visible="false">
                <br />
			    <hr />
			    ...
			    <table class="table table-borderless" align="left">
		            ...
		            <tr>
				        ...
				        <td class="col-md-4"><asp:DropDownList ID="TxtStatusKerjaJabatan" runat="server" class="form-control" DataValueField="jabatan_nama"  DataValueText="jabatan_nama"  DataSourceID="SqlDataSource1"></asp:DropDownList>
                    ...
                    <tr>
					    <td class="col-md-2"><asp:Label ID="Label44" runat="server"  Text="Sub Jabatan"></asp:Label></td>
					    <td class="col-md-4">
					        <asp:DropDownList ID="subJabatan" runat="server" class="form-control required">
                                <asp:ListItem></asp:ListItem>
							    <asp:ListItem>0 Operator</asp:ListItem>
                                <asp:ListItem>1 Staff</asp:ListItem>
							    <asp:ListItem>2 Leader</asp:ListItem>
							    <asp:ListItem>3 SPV</asp:ListItem>
                                <asp:ListItem>4 Ast. Manager</asp:ListItem>
                                <asp:ListItem>5 Manager</asp:ListItem>
						    </asp:DropDownList>
				        </td>
                    </tr>
			    </table> 
				...
				<center><asp:Label ID="LblErrorSaveA1" runat="server" Text="" style="color:red"></asp:Label>
					...
					<asp:Button ID="ButtonA1Save" runat="server" Text="Simpan Data" class="btn btn-success" />
