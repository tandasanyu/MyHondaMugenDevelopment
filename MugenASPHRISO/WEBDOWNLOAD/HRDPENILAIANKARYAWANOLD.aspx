                ...
                <asp:ListView ID="LVProses" runat="server" DataSourceID="SqlDataProses" DataKeyNames ="KPI_KODEITEM">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align:center"><%#Eval("KPI_KOMENTAR2")%></td>
                            <td style="text-align:center"><asp:LinkButton ID="lnkSelect" Text='DETAIL' CommandName="Select" runat="server" ><img src="img/details.png" width="50px" height="40px" /></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                 ...
                 <p style="text-align:right">Rata-Rata Nilai Proses: <b><font size="5"><asp:Label ID="nilaiProses" runat="server" Text=""></asp:Label></b></font>   
            </asp:View> 
        </asp:MultiView>             
                 ...
                 <div class="well">  	
	                <div class="container">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr> 
                                ...
                                <td class="col-md-4"><p style="padding-left : 170px">
                                    <asp:DropDownList ID="TxtNilaiSP" OnTextChanged="nilaiSangsi" AutoPostBack="true" Enabled="False"  runat="server" MaxLength="200" style="width: 70px; height: 40px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;">
                        ...
                        <center>
                            ...
                            <asp:Button ID="BtnKpi44Setuju3" runat="server" OnClientClick="return confirm('Apakah anda yakin akan melakukan persetujuan PK?');" Text="Verifikasi Atasan" class="btn btn-success" />
