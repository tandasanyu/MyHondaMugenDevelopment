...
Partial Class HRDPENILAIANKARYAWAN
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If LblUserName.Text = "" Then
            ...
            If no <> "" Then
                ...
                Call GetData_UserHead("Select kpih_appvhead from trxn_kpih WHERE KPIH_NIK='" & TxtStaffNIK.Text & "'")
                Call GetData_UserHead2("Select kpih_appvhead2 from trxn_kpih WHERE KPIH_NIK='" & TxtStaffNIK.Text & "'")
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM HRD -- ADD PK'") = 1 Then
                copytahun.Visible = True
                BtnKpi40.Visible = True
                BtnKpi40Del.Visible = True
                BtnKpi40MasterReset.Visible = True
                BtnResetVerifikasiHead.Visible = True
            ...
            ElseIf GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'PENILAIAN KARYAWAN -- PENILAIAN ATASAN KE BAWAHAN'") = 1 Then
                ...
                'Button Raport Key Performance Indicator
    ...
    Sub lockkaryawan()
        ...
        If GetFindRecord_Server("SELECT * FROM TRXN_KPIH WHERE KPIH_APPVUSERTGL IS NULL AND  KPIH_NIK='" & TxtStaffNIK.Text & "' AND KPIH_TAHUN='" & TxtKpiSummaryTahun.Text & "'") = 1 And TxtHead.Text <> LblUserName.Text Then
            'Halaman Form Raport Performance Indicator
            BtnKpi40Save.Visible = False
            'Halaman Proses 
    ...
    Sub lockatasan()
        ...
        If GetFindRecord_Server("SELECT * FROM TRXN_KPIH WHERE KPIH_APPVUSER IS NOT NULL AND KPIH_APPVUSERTGL IS NOT NULL AND KPIH_APPVHEADTGL IS NULL AND KPIH_NIK='" & TxtStaffNIK.Text & "' AND KPIH_TAHUN='" & TxtKpiSummaryTahun.Text & "'") = 1 And TxtHead.Text = LblUserName.Text Then
            'Halaman Form Raport Performance Indicator
            'BtnKpi40Save.Visible = False
            'Halaman Proses
            BtnKpi42ASave.Visible = False
    ...
    Sub lockatasan2()
        'Jika staff sudah verifikasi
        If GetFindRecord_Server("SELECT * FROM TRXN_KPIH WHERE KPIH_APPVUSER IS NOT NULL AND KPIH_APPVUSERTGL IS NOT NULL AND KPIH_APPVHEADTGL IS NOT NULL AND KPIH_APPVHEADTGL2 IS NULL AND  KPIH_NIK='" & TxtStaffNIK.Text & "' AND KPIH_TAHUN='" & TxtKpiSummaryTahun.Text & "'") = 1 And TxtHead2.Text = LblUserName.Text Then
            BtnKpi40Save.Visible = False
            'Halaman Proses
            BtnKpi42ASave.Visible = False
            BtnProsesAtasan1.Visible = False
    ...
    Sub hitunghasil()
        ...
        If TxtKpiSummaryPosA.Text = "A" Or TxtKpiSummaryPosA.Text = "B" Or TxtKpiSummaryPosA.Text = "C" Then
            ...
            Call GetData_NILAIB("select round(avg(KPI_STAFF),2) AS TOTAL_NILAI2 from TRXN_KPIDD where KPI_TAHUN='" & TxtKpiSummaryTahun.Text & "' and KPI_TIPEA='A' AND KPI_NIK='" & TxtStaffNIK.Text & "' ")
        ...
        If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'PENILAIAN KARYAWAN -- PENILAIAN ATASAN KE BAWAHAN'") = 1 Then
            ...
            If LblUserName.Text = TxtHead.Text Then
                If tipeProses.Text = "Kepemimpinan" Then
                    ...
                    Call UpdateData_Server3("UPDATE TRXN_KPIDD SET KPI_STAFF='" & TxtTotal.Text & "' where  KPI_NIK='" & TxtStaffNIK.Text & "' AND KPI_TAHUN='" & TxtKpiSummaryTahun.Text & "' AND  KPI_KODEITEM ='" & LblProsesKodeItem.Text & "'")
                Else
            ...
            End If
        Else
            Call GetDataProses("select KPI_KODEITEMM, sum(ISNULL(KPI_STAFF,0)) / count(KPI_KODEITEMM) as NIlaiTotal from TRXN_KPIDD where  KPI_tipeA='Z' and KPI_NIK='" & TxtStaffNIK.Text & "' AND KPI_TAHUN='" & TxtKpiSummaryTahun.Text & "' AND KPI_KODEITEMM ='" & LblProsesKodeItem.Text & "' group by KPI_KODEITEMM")
            Call UpdateData_Server3("UPDATE TRXN_KPIDD SET KPI_STAFF='" & TxtTotal.Text & "' where  KPI_NIK='" & TxtStaffNIK.Text & "' AND KPI_TAHUN='" & TxtKpiSummaryTahun.Text & "' AND  KPI_KODEITEM ='" & LblProsesKodeItem.Text & "'")
        End If
    End Sub
    ...
    Protected Sub LvProses2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvProses2.SelectedIndexChanged
        ...
        If LblProsesKodeItem.Text = "PRC" Then
            If LblUserName.Text = TxtHead.Text Then
                ...
                Call GetData_NilaiBawahan("select avg(cast(kpin_nilai as int)*10) as nilai_bawahan from trxn_kpin where (KPIN_ATASAN = '" & TXTUsername.Text & "' Or KPIN_ATASAN = '" & TxtStaffNama.Text & "') and kpin_kode <> '017'")
    ...
    Protected Sub BtnProsesAtasan2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnProsesAtasan2.Click
        If LblProsesHead.Text <> TxtProsesHead.Text And TxtProsesKomentar2.Text = "" Then
    ...
    Protected Sub LBKerjaB_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVPeople.SelectedIndexChanged
        ...
        Call GetData_Bawahan("select avg(cast(kpin_nilai as int)*10) as nilai_bawahan from trxn_kpin, data_natasan where kpin_kode = natasan_kode and (KPIN_ATASAN = '" & TXTUsername.Text & "' Or KPIN_ATASAN = '" & TxtStaffNama.Text & "') and kpin_group=natasan_group and  natasan_subgroup = '" & TxtPetik(LblPeopleKode.Text) & "'")
    ...
    Protected Sub BtnKpi44Save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnKpi44Setuju1.Click
        If GetFindRecord_Server("select kpi_atasan from trxn_kpidd where (kpi_staff is null or kpi_staff = 0) and kpi_kodeitem like 'B%' and kpi_nik='" & TxtStaffNIK.Text & "' and kpi_tahun='" & TxtKpiSummaryTahun.Text & "'") = 1 Then
            Response.Write("<script>alert('Anda Penilaian Item Proses Yang Belum Anda Isi, Silahkan di cek kembali!')</script>")
        ElseIf GetFindRecord_Server("select kpi_atasan from trxn_kpidd where (kpi_staff = 0 or kpi_staff is null)  and kpi_kodeitem like 'M%' and kpi_nik='" & TxtStaffNIK.Text & "' and kpi_tahun='" & TxtKpiSummaryTahun.Text & "'") = 1 Then
            Response.Write("<script>alert('Anda Penilaian Item People Management Yang Belum Anda Isi, Silahkan di cek kembali!')</script>")
        Else
            If TxtKpiSummaryPosA.Text = "D" Then

                Dim mSqlCommand As String = "UPDATE TRXN_KPIH SET " & _
                                    "KPIH_NILAI = " & nDb(hasilakhir.Text) & "," & _
                                    "KPIH_NILAI1 = " & nDb(LblNiaiAkhir1.Text) & "," & _
                                    "KPIH_NILAI2 = " & nDb(LblNiaiAkhir2.Text) & "," & _
            ...
            ElseIf TxtKpiSummaryPosA.Text = "A" Or TxtKpiSummaryPosA.Text = "B" Or TxtKpiSummaryPosA.Text = "C" Or TxtKpiSummaryPosA.Text = "E" Then
                ...
                Dim mSqlCommand As String = "UPDATE TRXN_KPIH SET " & _
                                    ...
                                    "KPIH_NILAI1 = " & nDb(LblNiaiAkhir1.Text) & "," & _
                                    "KPIH_NILAI2 = " & nDb(LblNiaiAkhir2.Text) & "," & _
                                    "KPIH_NILAI3 = " & nDb(LblNiaiAkhir3.Text) & "," & _
                                    "KPIH_KETERANGAN = '" & txtKategori.Text & "'," & _
                                    "KPIH_APPVUSER = '" & TxtStaffNama.Text & "'," & _
                                    "KPIH_APPVUSERTGL = '" & Now() & "' " & _
                                    "WHERE KPIH_NIK='" & TxtStaffNIK.Text & "' AND KPIH_TAHUN='" & TxtKpiSummaryTahun.Text & "'"
    ...
    Protected Sub BtnKpi44Setuju2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnKpi44Setuju2.Click
        If GetFindRecord_Server("select kpi_atasan from trxn_kpidd where (kpi_atasan is null or kpi_atasan = 0) and kpi_kodeitem like 'B%' and kpi_nik='" & TxtStaffNIK.Text & "' and kpi_tahun='" & TxtKpiSummaryTahun.Text & "'") = 1 Then
            Response.Write("<script>alert('Anda Penilaian Item Proses Yang Belum Anda Isi, Silahkan di cek kembali!')</script>")
            Response.Write("<script>window.location.href='HRDPENILAIANKARYAWAN.aspx?no=" + TxtStaffNIK.Text + "';</script>")
        ElseIf GetFindRecord_Server("select kpi_atasan from trxn_kpidd where (kpi_atasan = 0 or kpi_atasan is null)  and kpi_kodeitem like 'M%' and kpi_nik='" & TxtStaffNIK.Text & "' and kpi_tahun='" & TxtKpiSummaryTahun.Text & "'") = 1 Then
            Response.Write("<script>alert('Anda Penilaian Item People Management Yang Belum Anda Isi, Silahkan di cek kembali!')</script>")
            Response.Write("<script>window.location.href='HRDPENILAIANKARYAWAN.aspx?no=" + TxtStaffNIK.Text + "';</script>")
        Else
            If TxtKpiSummaryPosA.Text = "D" Then
            ...
            If TxtHead2.Text <> "" Then
                Call emailatasanlangsung("select emaildivisi from  divisi where headdivisi = '" & TxtHead2.Text & "'")
            End If
