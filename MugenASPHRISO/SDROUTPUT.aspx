<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" Debug="true" CodeFile="SDROUTPUT.aspx.vb" Inherits="SDROUTPUT" title="Dokumen System Development/Fault Request" %>
                 ...
                 <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        ...
                        <div class="panel-body">
                            <center>
                                <h3 style="font-family:Georgia;">HEAD IT APPROVAL SDR</h3>
                            </center>
	                        <br />
                ...
                <br /><br />
                 <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        ...
                        <div class="panel-body">
                            <center>
                                <h3 style="font-family:Georgia;">TEST APPROVAL SDR</h3>
                            </center>
	                        <br /><br />
                            <table class="table table-borderless">
                                <tr>
