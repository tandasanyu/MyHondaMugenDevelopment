        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
            <asp:View ID="View1Akses" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT],  [DOKUMEN_KETERANGAN], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIBUAT2], [DOKUMEN_TGLDIBUAT2], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE ([DOKUMEN_DEPARTMENT] = ? AND [DOKUMEN_JENIS]='B')"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-4"><asp:TextBox ID="TxtNamaDokumen" runat="server" MaxLength="100" class="form-control" Text =""></asp:TextBox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label14" runat="server" Text="Keterangan Dokumen"></asp:Label></td>
                                    <td class="col-md-4"><asp:Textbox ID="txtKeterangan" runat="server" MaxLength="200" Text ="" CssClass="form-control"></asp:Textbox></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
