<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ISOSOP.aspx.vb" Inherits="ISOSOP" title="Dokumen Standard Operasional Prosedur" %>
        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
            <asp:View ID="View1Akses" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT],  [DOKUMEN_KETERANGAN], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIBUAT2], [DOKUMEN_TGLDIBUAT2], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE ([DOKUMEN_DEPARTMENT] = ? AND [DOKUMEN_JENIS]='B') ORDER BY DOKUMEN_NO ASC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td class="col-md-4">SOP<asp:Label ID="lblBackupId" runat="server" Text="ID"></asp:Label></td>
                                    <td class="col-md-2"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2"></td>
                                ...
                                <tr>
                                    <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label12" runat="server" Text="Dibuat Oleh"></asp:Label></td>
                                    <td class="col-md-4">
        ...
        <asp:MultiView ID="MultiViewSOP" runat="server" Visible="TRUE">
            <asp:View ID="View6" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataView" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_TGLDIBUAT], [DOKUMEN_KETERANGAN], [DOKUMEN_DIBUAT2], [DOKUMEN_TGLDIBUAT2], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK], [DOKUMEND_DISTRIBUSI] FROM [TRXN_DOKUMEN] INNER JOIN [TRXN_DOKUMEND] ON [DOKUMEND_NO] = [DOKUMEN_NO] WHERE ([DOKUMEND_DISTRIBUSI] = ? AND [DOKUMEN_JENIS]='B') ORDER BY DOKUMEN_NO ASC"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
			        <selectparameters>
                        <asp:ControlParameter ControlID="lblArea1" Name="lblArea1" PropertyName= "Text" Type="String" />            
			        </selectparameters>
