<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Form0103FORM.aspx.vb" Inherits="SALES_Form0104FORM" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:View ID="View1Akses" runat="server">
        <div class="container">
            <center>
                <h2 style="font-family:Cooper Black;">DATA FORM</h2>
            </center>
	    </div>  <br /><br />
        ...
        <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
            ...
            SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE [DOKUMEN_JENIS]='D'"
