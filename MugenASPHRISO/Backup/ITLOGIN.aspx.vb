...
Partial Class ITLOGIN
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LblUserName.Text = "" Then
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM LOGIN -- VIEW SEMUA DATA'") = 1 Then
                MultiViewAkses.ActiveViewIndex = 0
                MultiViewJudul.ActiveViewIndex = 0
                MultiViewAkses2.ActiveViewIndex = -1
            ElseIf GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' And hakakses = 'FORM LOGIN -- VIEW DATA'") = 1 Then
