...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><span class="glyphicon glyphicon-share"></span> &nbsp Sasaran Mutu</li>
        </ul>
    ...
    <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
        <asp:View ID="View1Akses" runat="server">
            ...
            <asp:MultiView ID="MultiViewMasterIsi" runat="server" Visible="TRUE">
                <asp:View ID="View3" runat="server">
                     <div class="container">
                        <center>
                            <h3 style="font-family:Blunter;">DATA SASARAN MUTU</h3>
                        </center>
	                </div><br /><br />
                    ...
                    <table class="table table-borderless" align="left">
                        ...
                        <tr> 
                            ...
                            <td class="col-md-4"><asp:TextBox ID="TxtSMDep" runat="server" class="form-control required"></asp:TextBox></td>
                            <td class="col-md-2"></td>
                        </tr>
                        <tr>
                            <td class="col-md-2"></td>
                            <td class="col-md-2"><asp:Label ID="Label39" runat="server" Text="Sasaran Mutu"></asp:Label></td>
                            <td class="col-md-2"><asp:TextBox ID="TxtSMDesc" runat="server" class="form-control required"></asp:TextBox></td>
                            <td class="col-md-2"></td>
                        </tr>
                        <tr>
                            <td class="col-md-2"></td> 
                        ...
                        <tr>
                            ...
                            <td class="col-md-4"><asp:TextBox ID="TxtSMUser" runat="server" class="form-control required"></asp:TextBox></td>
                            <td class="col-md-2"></td> 
                        </tr>
                        <tr> 
                            <td class="col-md-2"></td> 
                    ...
                    <center>
                        <asp:Button ID="ButtonABack" runat="server"  CssClass="btn btn-warning" Text="Kembali Ke Menu Awal" />
        ...
        <asp:MultiView ID="MultiViewActionPlane" runat="server" Visible="TRUE">
            <asp:View ID="View4" runat="server">
                <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DATA ACTION PLAN</h3>
                    </center>
	            </div><br />
                <asp:Button ID="BtnB" runat="server" Text="(+) Tambah Action Plan" class="btn btn-primary" />
                <br /><br />
                ...
                <asp:ListView ID="LVActionPlane" runat="server" DataSourceID="SqlDataPLAN" DataKeyNames ="MUTUP_URUTAN">
                    <LayoutTemplate>
                        <table id="table-a"  class="table table-bordered table-striped" align="left">
                            <thead style="background-color:#E8E8E8">
                                ...
                                <th style="text-align:center">ID Departemen</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="col-md-2" style="text-align:center"><asp:LinkButton ID="lnkSelect" Text='Detail' CommandName="Select" runat="server" ><img src="img/details.png" width="50px" height="40px" /></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
        ...
        <asp:MultiView ID="MultiViewActionPlaneENtry" runat="server" Visible="TRUE">
            <asp:View ID="View5" runat="server">
                <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DETAIL ACTION PLAN</h3>
                    </center>
	            </div><br /><br />
                <table class="table table-borderless" align="left">
                     <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-md-4"><asp:TextBox ID="TxtActionPlan" class="form-control required" runat="server"></asp:TextBox>
                ...
                <center>
                    <asp:Button ID="BtnBBack" runat="server" Text="Kembali Ke Menu Awal" cssClass="btn btn-warning" />
        ...
        <asp:MultiView ID="MultiViewNilaiProgress" runat="server" Visible="TRUE">
            <asp:View ID="View1" runat="server">
                <br />
                 <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DATA PROGRESS</h3>
                    </center>
	            </div><br />
                <asp:Button ID="BtnNilaiSM" runat="server" Text="(+) Tambah Progress" CssClass="btn btn-primary" />
                <br /><br />
                ...
                <asp:ListView ID="LVNilaiSasaranMutu" runat="server" DataSourceID="SqlDataSMutu" DataKeyNames ="MUTUN_PROGRESS">
                    <LayoutTemplate>
                        <table id="table-a" class="table table-bordered table-striped" align="left">
                            <thead style="background-color:#E8E8E8">
                                <th style="text-align:center" class="col-md-1">No.</th>
                                <th style="text-align:center" class="col-md-2">Progress</th>
                                <th style="text-align:center" class="col-md-1">Target</th>
                                <th style="text-align:center" class="col-md-1">Actual</th>
                                <th style="text-align:center" class="col-md-3">Cara Hitung</th>
                                <th style="text-align:center" class="col-md-2">Head</th>
                                <th style="text-align:center" class="col-md-2">Wakil Manajemen</th>
                                <th style="text-align:center" class="col-md-1">Lihat Detail</th>
                            </thead>
                            <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                        </table>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:LinkButton ID="lnkSelect" Text='Detail' CommandName="Select" runat="server" ><img src="img/details.png" width="50px" height="40px" /></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
        ...
        <asp:MultiView ID="MultiViewNilaiProgressEntry" runat="server" Visible="TRUE">
            <asp:View ID="View2" runat="server">
                <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DETAIL PROGRESS</h3>
                    </center>
	            </div><br /><br />
                <table class="table table-borderless" align="left">
                    <tr>
                    ...
                    <tr>
                        <td class="col-md-2"></td>
                        <td class="col-md-2"><asp:Label ID="Label11" runat="server" Text="Persetujuan Wakil Manajemen"></asp:Label></td>
                        <td class="col-md-4"><asp:Button ID="BtnNilaiSMSave1" runat="server" Text="Disetujui Wakil Manajemen" CssClass="btn btn-info"/></td>
                        <td class="col-md-2"></td>
                    </tr>
                </table>
                
                <center><asp:Label ID="LblErrorSaveC" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="" style="color: red;"></asp:Label></center>
                
                <center>
                    <asp:Button ID="BtnNilaiSMBack" runat="server" Text="Kembali Ke Menu Awal" CssClass="btn btn-warning" />
        ...
        <asp:MultiView ID="MultiViewMasalah" runat="server" Visible="TRUE">
            <asp:View ID="View6" runat="server">
                <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DATA MASALAH</h3>
                    </center>
	            </div><br />
                <asp:Button ID="BtnD" runat="server" class="btn btn-primary" Text="(+) Tambah Data Masalah" />
                <br /><br />
                ...
                <asp:ListView ID="LvMasalah" runat="server" DataSourceID="SqlDataMasalah" DataKeyNames ="MUTUM_MASALAH">
                    <LayoutTemplate>
                        <table id="table-a" class="table table-bordered table-striped" align="left" >
                            <thead style="background-color:#E8E8E8">
                                <th style="text-align:center" class="col-md-1">No.</th>
                                <th style="text-align:center" class="col-md-10">Masalah</th>
                                <th style="text-align:center" class="col-md-1">Lihat Detail</th>
                            </thead>
                            <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                        </table>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align:center"><asp:LinkButton ID="lnkSelect" Text='HAPUS' CommandName="Select" runat="server" ><img src="img/delete.png" width="50px" height="40px" /></asp:LinkButton></td>
                    </tr>
                </ItemTemplate>
    ...
    <asp:MultiView ID="MultiViewMasalahENtry" runat="server" Visible="TRUE">
        <asp:View ID="View7" runat="server"><br />
            <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DETAIL MASALAH</h3>
                    </center>
	            </div><br /><br />
            <table class="table table-borderless" align="left">
                <tr> 
           ...
           <center><asp:Label ID="LblErrorSaveD" runat="server" Text="" style="color: red;"></asp:Label></center>
            ...
            <center>
                <asp:Button ID="BtnDBack" runat="server" Text="Kembali Ke Menu Awal" cssClass="btn btn-warning" />
    ...
    <asp:MultiView ID="MultiViewKoreksi" runat="server" Visible="TRUE">
        <asp:View ID="View8" runat="server">
            <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DATA KOREKSI</h3>
                    </center>
	            </div><br />
            <asp:Button ID="BtnE" runat="server" class="btn btn-primary" Text="(+) Tambah Data Koreksi"  />
            <br /><br />
            ...
            <asp:ListView ID="LVKoreksi" runat="server" DataSourceID="SqlDataKoreksi" DataKeyNames ="MUTUT_TINDAKAN">
                <LayoutTemplate>
                    <table id="table-a"  class="table table-bordered table-striped" align="left">
                        <thead style="background-color:#E8E8E8">    
                            <th style="text-align:center" class="col-md-1">No.</th>
                            <th style="text-align:center" class="col-md-6">Koreksi</th>
                            <th style="text-align:center" class="col-md-2">PIC</th>
                            <th style="text-align:center" class="col-md-2">Due Date</th>
                            <th style="text-align:center" class="col-md-1">Lihat Detail</th>
                        </thead>
                        <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                    </table>
    ...
    <asp:MultiView ID="MultiViewKoreksiEntry" runat="server" Visible="TRUE">
        <asp:View ID="View9" runat="server">
            <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DETAIL KOREKSI</h3>
                    </center>
	            </div><br /><br />
           <table class="table table-borderless" align="left">
                <tr>
            ...
            <center>
                    <asp:Button ID="BtnEBack" runat="server" Text="Kembali Ke Menu Awal" cssClass="btn btn-warning" />
    ...
    <asp:MultiView ID="MultiViewPerbaikan" runat="server" Visible="TRUE">
        <asp:View ID="View10" runat="server"><br />
            <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DATA PERBAIKAN</h3>
                    </center>
	            </div><br />
            <asp:Button ID="BtnF" runat="server" Text="(+) Tambah Data Perbaikan" class="btn btn-primary" />
            <br /><br />
            ...
            <asp:ListView ID="LvPerbaikan" runat="server" DataSourceID="SqlDataPerbaik" DataKeyNames ="MUTUT_TINDAKAN">
                <LayoutTemplate>
                    <table class="table table-bordered table-striped" align="left">
                        <thead style="background-color:#E8E8E8">  
                            <th style="text-align:center" class="col-md-1">No.</th>  
                            <th style="text-align:center" class="col-md-6">Perbaikan</th>
                            <th style="text-align:center" class="col-md-2">PIC</th>
                            <th style="text-align:center" class="col-md-2">Due Date</th>
                            <th style="text-align:center" class="col-md-1">Lihat Detail</th>
                        </thead>
    ...
    <asp:MultiView ID="MultiViewPerbaikanEntry" runat="server" Visible="TRUE">
        <asp:View ID="View11" runat="server">
             <div class="container">
                    <center>
                        <h3 style="font-family:Blunter;">DETAIL PERBAIKAN</h3>
                    </center>
	            </div><br /><br />
            <table class="table table-borderless" align="left">
                <tr>
               ...
               <center> <asp:Label ID="LblErrorSaveF" runat="server" Text="" style="color: red;"></asp:Label></center>
                
                <center>                    
                    <asp:Button ID="BtnFBack" runat="server" Text="Kembali Ke Menu Awal" cssClass="btn btn-warning" />
