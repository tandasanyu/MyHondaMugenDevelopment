...
Partial Class ISOSASARANMUTU
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If LblUserName.Text = "" Then
            ...
            If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- VIEW SEMUA DATA'") = 1 Then
    ...
    Protected Sub LVNilaiSasaranMutu_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVNilaiSasaranMutu.SelectedIndexChanged
        ...
        If GetData_UserSecurity("SELECT * FROM tb_userutility WHERE username = '" & LblUserName.Text & "' and hakakses = 'FORM ISO -- DISETUJUI WAKIL MANAJEMEN'") = 1 And GetData_MasterNilai("SELECT * FROM TRXN_ISOENILAI WHERE MUTUN_CREATEMGM IS NULL AND MUTUN_CREATEMGMTGL IS NULL") Then
