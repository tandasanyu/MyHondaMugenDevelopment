<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Form0103BERITAACARA.aspx.vb" Inherits="SALES_Form0104BERITAACARA" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container">
        ...
        <asp:Button ID="BtnMasterTabel" runat="server" Text="Tambah Berita Acara" class="button button4" />
        ...
        <asp:MultiView ID="MultiViewAkses" runat="server" Visible="TRUE">
            <asp:View ID="View1Akses" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataMutuMaster" runat="server"
                    ...
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_CABANG], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DIKETAHUI2], [DOKUMEN_TGLDIKETAHUI2], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE  [DOKUMEN_JENIS]='D'"
                ...
                <asp:ListView ID="LvDetailMaster" runat="server" DataSourceID="SqlDataMutuMaster" DataKeyNames ="DOKUMEN_NO">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center"><a target="_blank" href="webdownload/dokumeniso/<%#Eval("DOKUMEN_LINK")%>"><img src="img/dokumen1.png" width="35px" height="40px" /></asp:LinkButton></td>
                ...
                <div class="container">
                    ...
                    <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-paperclip"></span> &nbsp <font style="color:#ffffff">FORM LAPORAN DAN BERITA ACARA AUDIT/STOCKOPNAME</font></div>
                        <div class="panel-body">
                            <center>
                                <h2 style="font-family:Cooper Black;">FORM LAPORAN DAN BERITA ACARA AUDIT/STOCKOPNAME</h2>
                            </center>
	                    </div><br />
        ...
        <asp:MultiView ID="MultiViewData" runat="server" Visible="TRUE">
            <asp:View ID="View1" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataView" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_CABANG], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DIKETAHUI2], [DOKUMEN_TGLDIKETAHUI2], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE  ([DOKUMEN_DIKETAHUI] = ? OR [DOKUMEN_DIKETAHUI2] = ?  AND [DOKUMEN_JENIS]='D')"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
        ...
        <asp:MultiView ID="MultiViewData2" runat="server" Visible="TRUE">
            <asp:View ID="View3" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataView2" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MyConnCloudDnet2 %>"
                    SelectCommand="SELECT [DOKUMEN_NO], [DOKUMEN_NAMA], [DOKUMEN_DIBUAT], [DOKUMEN_CABANG], [DOKUMEN_TGLDIBUAT], [DOKUMEN_DIKETAHUI], [DOKUMEN_TGLDIKETAHUI], [DOKUMEN_DIKETAHUI2], [DOKUMEN_TGLDIKETAHUI2], [DOKUMEN_DISETUJUI], [DOKUMEN_TGLDISETUJUI], [DOKUMEN_LINK] FROM [TRXN_DOKUMEN] WHERE  [DOKUMEN_TGLDIKETAHUI] IS NOT NULL AND [DOKUMEN_TGLDIKETAHUI2] IS NOT NULL AND [DOKUMEN_DISETUJUI] IS NOT NULL  AND [DOKUMEN_JENIS]='D'"
                    ProviderName="<%$ ConnectionStrings:MyConnCloudDnet2.ProviderName %>">
                    <selectparameters>
                        <asp:ControlParameter ControlID="lblArea1" Name="lblArea1" PropertyName= "Text" Type="String" />      
                        <asp:ControlParameter ControlID="lblArea2" Name="lblArea2" PropertyName= "Text" Type="String" />      
