<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" Debug="true" CodeFile="ITSDROUTPUT.aspx.vb" Inherits="ITSDROUTPUT" title="Dokumen System Development/Fault Request" %>
                ...
                <br />
                 <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-duplicate"></span> &nbsp <font style="color:#ffffff">Head IT Approval SDR</font></div>
                        <div class="panel-body">
                            <center>
                                <h3 style="font-family:Georgia;">HEAD IT APPROVAL SDR/SFR</h3>
                            </center>
	                        <br />
         ...
         <asp:MultiView ID="MultiViewDiujiSDR" runat="server" Visible="TRUE">
            <asp:View ID="View8" runat="server">
                <br /><br />
                 <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        <div class="panel-heading" style="background-color:#2277B5"><span style="color:#ffffff" class="glyphicon glyphicon-duplicate"></span> &nbsp <font style="color:#ffffff">Test Approval SDR</font></div>
                        <div class="panel-body">
                            <center>
                                <h3 style="font-family:Georgia;">TEST APPROVAL SDR/SFR</h3>
                            </center>
	                        <br /><br />
                            <table class="table table-borderless">
                                <tr>
