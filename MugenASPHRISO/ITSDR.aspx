                 ...
                 <div class="container">
                    <div class="panel panel-default" style="margin-left:-25px">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-borderless" runat="server">
                             <tr> 
						            <td class="col-md-2"></td>
                                    <td class="col-md-2"><asp:Label ID="Label5" runat="server" Text="Upload Detail Program (Optional)"></asp:Label></td>
						            <td class="col-md-4">
                                        <asp:FileUpload ID="FileUpload1" runat="server"/>
							            <asp:RegularExpressionValidator ID="FileTypeValidator" runat="server" ErrorMessage="File type not allowed: Accept PDF, DOC, DOCX,XLS file type only" ValidationExpression="(.*pdf$)|(.*doc$)|(.*docx$) |(.*xls$)" ControlToValidate="FileUpload1"></asp:RegularExpressionValidator><br />
						            </td>
                                    <td class="col-md-2"></td>
					            </tr>
                                </table>
