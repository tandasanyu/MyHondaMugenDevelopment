<%@ Page Language="VB" MasterPageFile ="~/MasterPage.master"  AutoEventWireup="false" CodeFile="HRDPENILAIANKARYAWANB.aspx.vb" Inherits="HRDPENILAIANKARYAWANB" title="Penilaian Karyawan" %>
    ...
    <div class="container">
        ...
        <asp:MultiView ID="MultiViewKpiMaster" runat="server" Visible="TRUE">
            <asp:View ID="ViewTampilKpiMasterSumary" runat="server">  
                <asp:Button ID="BtnKpi40Master" visible="false" runat="server" Text="Tambah Data KPI" class="button button4"/>
                <br /><br />
                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr id="pengisian" runat="server" visible="false">
                                    ...
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlinePK" runat="server" Text="" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
                                 ...
                                 <tr id="atasanlangsung" runat="server" visible="false">
                                    ...
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlineAtasan" runat="server" Text="" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
                                 ...
                                 <tr id="atasanlangsung2" runat="server" visible="false">
                                    ...
                                    <td class="col-md-4"><asp:Textbox ID="TxtDeadlineAtasan2" runat="server" Text="" style="width: 130px; height: 35px; padding: 12px 10px; box-sizing: border-box; border: 1px solid Silver; border-radius: 4px;" ValidationGroup="MKE"></asp:Textbox>
            ...
            <asp:View ID="ViewKPIMasterENtry" runat="server">  
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <center><asp:Button ID="BtnKpi40ASave" Visible="false" runat="server" Text="Simpan" class="btn btn-success" /></center>
                        </div>
                ...
                <div class="well">  	
	                <div class="container">
                        ...
                        <center>
                            ...
                            <asp:Button ID="ButtonRefresh"  runat="server" Text="Refresh" class="btn btn-success" />
                        </center>
                    </div>
                </div>
            </asp:View> 
