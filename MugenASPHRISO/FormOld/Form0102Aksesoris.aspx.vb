...
Partial Class Form02Aksesoris
    ...
    Sub PermohonanFormNonAktif()
        ...
        MultiAdminAsesoirs.ActiveViewIndex = -1
    ...
    Protected Sub ButtonSimpan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSimpan.Click
        ...
        If (nLg(TxtAksesorisQty.Text) * nLg(TxtHargaAss.Text)) < (nLg(TxtAksesorisQty.Text) * nLg(LblAksesorisModal.Text)) And DropDownList2.Text = "BAYAR" And nLg(TxtAksesorisQty.Text) <= 0 And nLg(TxtAksesorisQty.Text) = 1 Then
    ...
    Protected Sub LvPO_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvPO.SelectedIndexChanged
        ...
        If UCase(LblUserName.Text) = "ITPSMOK" Or UCase(LblUserName.Text) = "ITPURIOK" Then
            LblQueryAsesoris.Text = "UPDATE TRXN_OPTPO SET OPT_STATUSPROSES='SETUJU-A' WHERE OPT_STATUSPROSES like 'SETUJU%' AND  OPT_NOMORMOHON='" & LblNomorMohonOPT.Text & "'"
            LblQueryAsesoris1.Text = "UPDATE TRXN_OPTPO SET OPT_NOSPK='-" & Right(txtnospk.Text, 5) & "' WHERE OPT_NOSPK='" & txtnospk.Text & "' AND OPT_NODEALER='" & lblArea1.Text & "'"
            MultiAdminAsesoirs.ActiveViewIndex = 0
...
ErrHand:
    ...
    Protected Sub LvPermohonan_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvPermohonan.SelectedIndexChanged
        ...
        If LblNomormohon.Text <> "" Then
            ...
            End If
            LblQueyUpdate.Text = "UPDATE TRXN_SPKAH SET STATUS=NULL WHERE NOMOR_MOHON ='" & LblNomormohon.Text & "' AND NOMOR='" & LblNomor.Text & "' AND JUDUL LIKE '%" & lblMohonDetailTipe.Text & "%'"
            If InStr(LblQueyUpdate.Text, "STJ-DIGANTI") <> 0 Then
                LblQueyUpdate.Text = "UPDATE TRXN_SPKAH SET STATUS=NULL,JUDUL=REPLACE(JUDUL,'STJ-DIGANTI','SETUJU') WHERE NOMOR_MOHON ='" & LblNomormohon.Text & "' AND NOMOR='" & LblNomor.Text & "' AND JUDUL LIKE '%" & lblMohonDetailTipe.Text & "%'"
            End If
        End If
        ...
        Try
            ...
            If MyRecReadA.HasRows = True Then
                While MyRecReadA.Read()
                    ...
                    LblStatusAkhir.Text = nSr(MyRecReadA("STATUS"))
