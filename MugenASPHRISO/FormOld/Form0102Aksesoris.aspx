        ...
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small">
            ...
            <tr>
                <td style="width: 100%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="LblQueyUpdate" runat="server" font-Names="Arial" 
                        Font-Size="Small" Font-Bold="True"                          
                        Text="" 
                        ForeColor="Yellow" BorderStyle="Dotted"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 100%; background-color: #000000;  color: #FFFFFF;">
            ...
            <asp:MultiView ID="MultiAdminAsesoirs" runat="server" Visible="TRUE">
            <asp:View ID ="View13" runat ="server">

            <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;"> 
            <tr>
                <td style="width: 100%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="LblQueryAsesoris" runat="server" font-Names="Arial" 
                        Font-Size="Small" Font-Bold="True"                          
                        Text="" 
                        ForeColor="Yellow" BorderStyle="Dotted"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <asp:Button ID="Button12" runat="server" BackColor="White" BorderStyle="None" 
                    Font-Bold="True" Font-Italic="True" Font-Overline="False" Font-Size="Medium" 
                    Font-Underline="True" ForeColor="blue" 
                    Text="Admin Akan membuka Status open untuk proses Akseoris yang sudah disetujui" 
                    Width="100%" />
                </td>
            </tr> 
            <tr>
                <td style="width: 100%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="LblQueryAsesoris1" runat="server" font-Names="Arial" 
                        Font-Size="Small" Font-Bold="True"                          
                        Text="" 
                        ForeColor="Yellow" BorderStyle="Dotted"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <asp:Button ID="Button13" runat="server" BackColor="White" BorderStyle="None" 
                    Font-Bold="True" Font-Italic="True" Font-Overline="False" Font-Size="Medium" 
                    Font-Underline="True" ForeColor="blue" 
                    Text="Admin Akan membuka mengahpus Akseoris yang sudah disetujui" 
                    Width="100%" />
                </td>
            </tr> 
            </table>
