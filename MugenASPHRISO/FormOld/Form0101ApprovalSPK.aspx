        ...
        <asp:View ID="View6" runat="server">
           ...
           <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 35%; ">
                    <asp:TextBox ID="TxtDisetujuiHrgDisc" runat="server" text="" Width="205px"></asp:TextBox>
                    <asp:CompareValidator ID="ChkTxtDisetujuiHrgDisc" runat ="server"  
                      ErrorMessage ="Tipe data harus numerik tanpa koma atau titik" ControlToValidate="TxtDisetujuiHrgDisc" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 40%; ">
           ...
           <tr>
                ...
                <td style="width: 35%; ">
                    <asp:TextBox ID="TxtDisetujuiHrgSubs" runat="server" text="" Width="204px"></asp:TextBox>
                    <asp:CompareValidator ID="ChkTxtDisetujuiHrgSubs" runat ="server"  
                      ErrorMessage ="Tipe data harus numerik tanpa koma atau titik" ControlToValidate="TxtDisetujuiHrgSubs" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 40%; ">
           ...
           <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 35%; ">
                    <asp:TextBox ID="TxtDisetujuiHrgKoms" runat="server" text="" Width="203px"></asp:TextBox>
                    <asp:CompareValidator ID="ChkTxtDisetujuiHrgKoms" runat ="server"  
                      ErrorMessage ="Tipe data harus numerik tanpa koma atau titik" ControlToValidate="TxtDisetujuiHrgKoms" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 40%; ">
