<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tes.aspx.cs" Inherits="tes" Title="Untitled Page" %>
...
<asp:Content ID="headBeranda" ContentPlaceHolderID="head" Runat="Server">
    ...
    <title>Honda Mugen :: Laporan</title>
 ...
 <asp:Content ID="bodySesuaiHalaman" ContentPlaceHolderID="body" Runat="Server"> 
  ...
  <div class="panel-heading" style="text-align:left;"><span class="glyphicon glyphicon-list"></span> Laporan Perbaikan</div>
...
<td>:</td>
<td>
    <asp:DropDownList ID="txtDivisi" runat="server" class="form-control" style="margin:5px;">
        <asp:ListItem>
        </asp:ListItem>
        <asp:ListItem>IT</asp:ListItem>
        <asp:ListItem>GA</asp:ListItem>
        <asp:ListItem>IT &amp; GA</asp:ListItem>
    </asp:DropDownList>
</td>
</tr>
<tr>
