...
public partial class tes : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (txtDivisi.Text == "")
        {
            lblError.Text = "Anda belum memilih unit kerja yang dituju";
        }
        else if (txtAwal.Text == "")
        {
        ...
        else if (txtCabang.Text == "")
        {
            ...
            Response.Redirect("reportkeluhan.aspx?dep=" + txtDivisi.Text + "&&tawl=" + txtAwal.Text + "&&takr=" + txtAkhir.Text + "&&cab=" + txtCabang.Text);
        }
