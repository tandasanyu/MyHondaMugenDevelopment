...
public partial class jobcontrolformanpuri : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("jobcontrolformanpuri.aspx?q=" + hasil);
    }
    protected void BtnLihatReport_Click(object sender, EventArgs e)
    {
        ...
        if (Status_ == "16")
        {
            Response.Redirect("Report_BP.aspx?qnowo=" + TxtCariReport.Text + "&&cabang=128");
        }
        else
        {
