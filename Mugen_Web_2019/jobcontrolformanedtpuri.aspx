    ...
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col" style="overflow-y:auto;overflow-x:auto;height:50%;width:70%">
...
<div id="show" style="border: 1px solid white; display: none; margin: 5px; padding: 2px; width: 98%;">
	...
	case [KERJABODY_LOKASI] 
		...
		when 9 then 'lt. 9' 
        when 10 then 'N / A'
		else '' END AS lokasimobil,[IDkrj_body], [KERJABODY_CATATAN], [KERJABODY_DETAILCATATAN] FROM [TEMP_KERJABODY] WHERE ([KERJABODY_NOWO] = @KERJABODY_NOWO and KERJABODY_STATUS <17) 
        ...
        <div class="row">
            <div class="col">
                <div  ><!-- class="d-flex justify-content-center align-items-center" -->
                    <table  align="center">
                        <tr>
                            <td style="padding:10px"><div id="Div1" class="rcorners1" style="background-color:greenyellow" runat="server"><h2 style="align-self:center">1. DISERAHKAN SA KE VENDOR</h2></div></td>
             ...
             <asp:ListView ID="ListViewHistoryPengerjaan" DataKeyNames ="IDkrj_body" DataSourceID="SqlDataSource4" runat="server" OnSelectedIndexChanged="ListViewHistoryPengerjaan_SelectedIndexChanged" >
                ...
                <div class="form-group">
                  ...
                  <table style="width:100%;" id="inputHistory" runat="server">
                      <tr>
                      <td style="width:15%;"><asp:Label ID="lblCatatan" runat="server" Text="Catatan :"></asp:Label></td>
                      <td> <asp:TextBox ID="txtCatatan" runat="server" Width="200px" CssClass="form-control input-sm"  style="margin:5px;"></asp:TextBox></td></tr>
                    <tr>
                      <td><asp:Label ID="LblLokasi" runat="server" Text="Lokasi Mobil Lantai :"></asp:Label></td>
                    ...
                    <div class="form-group col-sm-5">
                         <asp:SqlDataSource ID="ass" runat="server" ConnectionString="<%$ ConnectionStrings:service128Connection %>" SelectCommand="select kerjabody_catatan, idkrj_body from TEMP_KERJABODY where kerjabody_nowo = @WOHDR_FNOPOL and kerjabody_status = 17">
                             <SelectParameters>
                                 <asp:QueryStringParameter Name="WOHDR_FNOPOL" QueryStringField="qnowo" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
