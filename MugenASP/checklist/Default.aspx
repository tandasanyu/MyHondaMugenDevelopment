...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Wrapper for slides -->
        <div class="textnya">
            <center><img src="image/hlogo.png" style="width:80px;height:70px;padding:0px;margin:0px;"/></center>
        ...
        <div class="boxlogin">
            <div class="wraptengah" style="border-bottom:2px solid #d60000;top:30px;height:auto;position:relative;box-shadow:0px 3px 3px #c0c0c0;background:#f5f5f5;padding:10px;border-radius:4px;-moz-border-radius:4px;-webkit-border-radius:4px;-o-border-radius:4px;">
                ...
                <div class="input-group" style="width:100%;">
                    ...
                    <asp:TextBox ID="username" class="form-control input-sm" runat="server" Style="color:#333;font-weight:bold;" placeholder="Username" onkeyup="upper(this)"></asp:TextBox>
                </div>
                <div class="input-group" style="width:100%;margin-top:5px;">
                    <div class="input-group-addon" Style="background: linear-gradient(#f5f5f5, #ccc);">
                        <span class="glyphicon glyphicon-lock"></span>
                    </div>
                    <asp:TextBox ID="password" TextMode="Password" Style="color:#333;font-weight:bold;" class="form-control input-sm" runat="server" placeholder="Password"></asp:TextBox>
                </div>
                <asp:Button ID="Login" style="margin:5px;font-weight:bold;font-family:Tahoma;" class="btn btn-success btn-sm" runat="server" Text="MASUK" onclick="Login_Click" />
                <asp:Label ID="peringatan" runat="server" Font-Italic="True" Font-Size="Small" Font-Strikeout="False" ForeColor="Red"></asp:Label>
