<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="formChecklist2.aspx.vb" Inherits="formChecklist2" %>
...
<body>
    ...
    <form runat="server" id="checklist" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-4">
				<asp:TextBox ID="nopol" class="form-control required" style="text-transform: uppercase;" placeholder="c/: B 1234 AB" runat="server"></asp:TextBox>	
			</div>
       ...
       <div id="txt_nmCustomer"  runat="server" style="display:none;" class="form-group">
        ...
        <asp:TextBox ID="petugas" style="display:none;" runat="server"></asp:TextBox>
         <div id="txt_norangka"  runat="server" class="form-group">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
					...
					<div class="panel-body">
                        <center>
                            <div class="relative"><img src="image/depanAccord.png" class="img-responsive" /> 
                                <!-- Bemper Depan Atas -->
								<div class="depanAtas">
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <center>
							<div class="relative">
								<img src="image/belakangAccord.png" class="img-responsive" />  
								<!-- Belakang Atas -->
								<div class="belakangAtas">
									<!-- Belakang Atas 1 -->
                                    <asp:CheckBox runat="server" name="askBelakangAtas1" id="askBelakangAtas1" onclick="belakangAtas1()" /> 
			                        &nbsp;<asp:DropDownList ID="belakangAtas10" style="position:absolute; margin-left:100px; margin-top:-50px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Atas 2 -->
									<asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangAtas2" id="askBelakangAtas2" onclick="belakangAtas2()" value="1"/> 
	                                &nbsp;<asp:DropDownList ID="belakangAtas20" style="position:absolute; display:none; margin-left:155px; margin-top:-50px;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Atas 3 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangAtas3" id="askBelakangAtas3" onclick="belakangAtas3()" value="1"/> 
									&nbsp;<asp:DropDownList ID="belakangAtas30" style="position:absolute; margin-left:205px; margin-top:-50px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Atas 4 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangAtas4" id="askBelakangAtas4" onclick="belakangAtas4()" value="1"/> 
									&nbsp;<asp:DropDownList ID="belakangAtas40" style="position:absolute; margin-left:250px; margin-top:-50px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Atas 5 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangAtas5" id="askBelakangAtas5" onclick="belakangAtas5()" value="1"/> 
									&nbsp;<asp:DropDownList ID="belakangAtas50" style="position:absolute; margin-left:300px; margin-top:-50px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								...
								<div class="belakangTengah">
			                        ...
			                        &nbsp;<asp:DropDownList ID="belakangTengah10" style="position:absolute; margin-left:130px; margin-top:-40px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Tengah 2 -->
									<asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangTengah2" id="askBelakangTengah2" onclick="belakangTengah2()" /> 
	                                &nbsp;<asp:DropDownList ID="belakangTengah20" style="position:absolute; display:none; margin-left:180px; margin-top:-40px;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Tengah 3 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangTengah3" id="askBelakangTengah3" onclick="belakangTengah3()"/> 
									&nbsp;<asp:DropDownList ID="belakangTengah30" style="position:absolute; margin-left:230px; margin-top:-40px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Tengah 4 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangTengah4" id="askBelakangTengah4" onclick="belakangTengah4()" value="1"/> 
									&nbsp;<asp:DropDownList ID="belakangTengah40" style="position:absolute; margin-left:280px; margin-top:-40px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>						
                                ...
                                <!-- Belakang Tengah 5 -->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangTengah5" id="askBelakangTengah5" onclick="belakangTengah5()" value="1"/> 
									&nbsp;<asp:DropDownList ID="belakangTengah50" style="position:absolute; margin-left:330px; margin-top:-40px; display:none;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								...
								<div class="belakangBawah">
									<!-- Belakang Bawah 1 -->
                                    <asp:CheckBox runat="server"  name="askBelakangBawah1" id="askBelakangBawah1" onclick="belakangBawah1()" /> 
									...
									<!-- Belakang Bawah 2-->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangBawah2" id="askBelakangBawah2" onclick="belakangBawah2()" value="1"/> 
                                    &nbsp;<asp:DropDownList ID="belakangBawah20" style="position:absolute; display:none; margin-left:150px;" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
									...
									<!-- Belakang Bawah 3-->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangBawah3" id="askBelakangBawah3" onclick="belakangBawah3()" /> 
                                    &nbsp;<asp:DropDownList style="position:absolute; margin-left:200px; display:none;" ID="belakangBawah30" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <!-- Belakang Bawah 4-->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangBawah4" id="askBelakangBawah4" onclick="belakangBawah4()" /> 
                                    &nbsp;<asp:DropDownList style="position:absolute; margin-left:250px; display:none;" ID="belakangBawah40" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <!-- Belakang Bawah 5-->
                                    <asp:CheckBox runat="server" style="margin-left:25px;" name="askBelakangBawah5" id="askBelakangBawah5" onclick="belakangBawah5()" value="1"/> 
                                    &nbsp;<asp:DropDownList style="position:absolute; margin-left:300px; display:none;" ID="belakangBawah50" runat="server">
                                            <asp:ListItem>X</asp:ListItem>
                                            <asp:ListItem>V</asp:ListItem>
                                            <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
			...
			<div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <center>
						    <div class="relative"><img src="image/kananAccord.png" class="img-responsive" /> 
							    <!-- Kanan Atas -->
							    <div class="kananAtas">
							    ...
							    <div class="kananTengah">
							        ...
							        &nbsp;<asp:DropDownList ID="kananTengah10"  style="position:absolute; margin-left:60px; margin-top:-45px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								    ...
								    <!-- Kanan Tengah 2 -->
                                    <asp:CheckBox runat="server" style="margin-left:20px;" name="askKananTengah2" id="askKananTengah2" onclick="kananTengah2()" value="1"/> 
							        &nbsp;<asp:DropDownList ID="kananTengah20" style="position:absolute; margin-left:130px; margin-top:-45px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								    ...
								    <!-- Kanan Tengah 3 -->
                                    <asp:CheckBox runat="server" style="margin-left:10px;" name="askKananTengah3" id="askKananTengah3" onclick="kananTengah3()" value="1"/>
                                    &nbsp;<asp:DropDownList ID="kananTengah30" style="position:absolute; margin-left:165px; margin-top:-70px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananTengah40" style="position:absolute; margin-left:190px; margin-top:-45px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList  style="position:absolute;  margin-left:220px; margin-top:-70px;  display:none;" ID="kananTengah50" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList style="position:absolute; margin-left:250px; margin-top:-45px; display:none;" ID="kananTengah60" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananTengah70"  style="position:absolute; margin-left:280px; margin-top:-70px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananTengah80" style="position:absolute; margin-left:320px; margin-top:-45px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <!-- Kanan Tengah 9 -->
                                    <asp:CheckBox runat="server" style="margin-left:15px;" name="askKananTengah9" id="askKananTengah9" onclick="kananTengah9()" value="1"/>
                                    &nbsp;<asp:DropDownList ID="kananTengah90" style="position:absolute; margin-left:340px; margin-top:-70px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
							    ...
							    <div class="kananBawah">
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananBawah10"  style="position:absolute; margin-left:45px; margin-top:0px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								    ...
								    <!-- Kanan Bawah 2 -->
                                    <asp:CheckBox runat="server" style="margin-left:15px;" name="askKananBawah2" id="askKananBawah2" onclick="kananBawah2()" value="1"/>
                                    &nbsp;<asp:DropDownList ID="kananBawah20"  style="position:absolute; margin-left:95px; margin-top:0px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								    ...
								    <!-- Kanan Bawah 3 -->
                                    <asp:CheckBox runat="server" style="margin-left:15px;" name="askKananBawah3" id="askKananBawah3" onclick="kananBawah3()" value="1"/>
                                    &nbsp;<asp:DropDownList style="position:absolute; margin-left:135px; margin-top:25px; display:none;" ID="kananBawah30" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananBawah40" runat="server" style="position:absolute; margin-left:175px; margin-top:0px; display:none;">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananBawah50" style="position:absolute; margin-left:200px; margin-top:25px; display:none;" runat="server">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    &nbsp;<asp:DropDownList ID="kananBawah60" runat="server"  style="position:absolute; margin-left:235px; margin-top:0px; display:none;">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
								    ...
								    <!-- Kanan Bawah 7 -->
                                    <asp:CheckBox runat="server" style="margin-left:15px;" name="askKananBawah7" id="askKananBawah7" onclick="kananBawah7()" value="1"/> 
								    &nbsp;<asp:DropDownList ID="kananBawah70" runat="server" style="position:absolute; margin-left:265px; margin-top:25px; display:none;">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <!-- Kanan Bawah 8 -->
                                    <asp:CheckBox runat="server" style="margin-left:15px;" name="askKananBawah8" id="askKananBawah8" onclick="kananBawah8()" value="1"/> 
								    &nbsp;<asp:DropDownList ID="kananBawah80" runat="server" style="position:absolute; margin-left:300px; margin-top:0px; display:none;">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <!-- Kanan Bawah 9 -->
                                    <asp:CheckBox runat="server" style="margin-left:20px;" name="askKananBawah9" id="askKananBawah9" onclick="kananBawah9()" value="1"/> 
								    &nbsp;<asp:DropDownList ID="kananBawah90" runat="server" style="position:absolute; margin-left:350px; margin-top:25px; display:none;">
                                        <asp:ListItem>X</asp:ListItem>
                                        <asp:ListItem>V</asp:ListItem>
                                        <asp:ListItem>O</asp:ListItem>
                                    </asp:DropDownList>
			...
			<div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                     ...
                     <div class="panel-body">
                        <center>
						    <div class="relative"><img src="image/kiriAccord.png" class="img-responsive" />  
							<!-- Kiri Atas -->
							<div class="kiriAtas">
                                <asp:CheckBox runat="server" ID="askKiriAtas" onclick="kiriAtas()" value="1"/> 
							    &nbsp;<asp:DropDownList ID="kiriAtas1" runat="server" style="position:absolute; margin-left:220px; margin-top:-45px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
							...
							<div class="kiriTengah">
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah20" runat="server"  style="position:absolute; margin-left:130px; margin-top:-80px; display:none">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah30" runat="server" style="position:absolute; margin-left:165px; margin-top:-55px; display:none">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
						        ...
						        &nbsp;<asp:DropDownList ID="kiriTengah40" runat="server"  style="position:absolute; margin-left:190px; margin-top:-80px; display:none">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah50" runat="server"  style="position:absolute; margin-left:220px; margin-top:-55px; display:none">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah60" runat="server"  style="position:absolute; margin-left:250px;  margin-top:-80px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah70"  style="position:absolute; margin-left:280px;  margin-top:-55px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah80" style="position:absolute; margin-left:340px; margin-top:-40px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriTengah90" style="position:absolute; margin-left:380px; margin-top:-30px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
							...
							<div class="kiriBawah">
							    ...
							    &nbsp;<asp:DropDownList ID="kiriBawah10" style="position:absolute; margin-left:45px; margin-top:0px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriBawah20" runat="server" style="position:absolute; margin-left:95px; margin-top:0px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriBawah30" style="position:absolute; margin-left:135px; margin-top:25px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Kiri Bawah 4 -->
                                <asp:CheckBox runat="server" style="margin-left:15px;" name="askKiriBawah4" id="askKiriBawah4" onclick="kiriBawah4()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="kiriBawah40" style="position:absolute;  margin-left:175px; margin-top:0px;  display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Kiri Bawah 5 -->
                                <asp:CheckBox runat="server" style="margin-left:10px;" name="askKiriBawah5" id="askKiriBawah5" onclick="kiriBawah5()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="kiriBawah50" style="position:absolute; margin-left:210px; margin-top:25px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriBawah60"  style="position:absolute; margin-left:245px; margin-top:0px;display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                &nbsp;<asp:DropDownList ID="kiriBawah70"  style="position:absolute; margin-left:275px; margin-top:25px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                <!-- Kiri Bawah 8 -->
                                <asp:CheckBox runat="server" style="margin-left:15px;" name="askKiriBawah8" id="askKiriBawah8" onclick="kiriBawah8()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="kiriBawah80"  style="position:absolute; margin-left:310px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                <!-- Kiri Bawah 9 -->
                                <asp:CheckBox runat="server" style="margin-left:20px;" name="askKiriBawah9" id="askKiriBawah9" onclick="kiriBawah9()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="kiriBawah90"  style="position:absolute; margin-left:360px; margin-top:25px; display:none;" runat="server">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
        ...
        <div class="col-md-6">
                ...
                <div class="panel-body">
                    <center>
					    <div class="relative"><img src="image/atasAccord.png" class="img-responsive" />  
				            <!-- Atas Kiri -->
							<div class="atasKiri">
								<!-- Atas Kiri 1 -->
								...
								<!-- Atas Kiri 2 -->
                                <asp:CheckBox runat="server" style="margin-left:50px;" name="askAtasKiri2" id="askAtasKiri2" onclick="atasKiri2()" value="1"/>
                                &nbsp;<asp:DropDownList ID="atasKiri20" runat="server" style="position:absolute; margin-left:135px; margin-top:-45px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kiri 3 -->
                                <asp:CheckBox runat="server" style="margin-left:35px;" name="askAtasKiri3" id="askAtasKiri3" onclick="atasKiri3()" value="1"/>
                                &nbsp;<asp:DropDownList ID="atasKiri30" runat="server" style="position:absolute; margin-left:185px; margin-top:-45px;  display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kiri 4 -->
                                <asp:CheckBox runat="server" style="margin-left:35px;" name="askAtasKiri4" id="askAtasKiri4" onclick="atasKiri4()" value="1"/>
                                &nbsp;<asp:DropDownList ID="atasKiri40" runat="server" style="position:absolute; margin-left:240px; margin-top:-45px;  display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kiri 5 -->
                                <asp:CheckBox runat="server" style="margin-left:80px;" name="askAtasKiri5" id="askAtasKiri5" onclick="atasKiri5()" value="1"/>
                                &nbsp;<asp:DropDownList ID="atasKiri50" runat="server" style="position:absolute; margin-left:355px; margin-top:-45px;  display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
							...
							<div class="atasKanan">
						        ...
						        &nbsp;<asp:DropDownList ID="atasKanan10" runat="server" style="position:absolute; margin-left:55px; margin-top:5px;  display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kanan 2 -->
                                <asp:CheckBox runat="server" style="margin-left:60px;" name="askAtasKanan2" id="askAtasKanan2" onclick="atasKanan2()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="atasKanan20" runat="server" style="position:absolute; margin-left:135px; margin-top:5px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kanan 3 -->
                                <asp:CheckBox runat="server" style="margin-left:35px;" name="askAtasKanan3" id="askAtasKanan3" onclick="atasKanan3()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="atasKanan30" runat="server" style="position:absolute; margin-left:190px; margin-top:5px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kanan 4 -->
                                <asp:CheckBox runat="server" style="margin-left:35px;" name="askAtasKanan4" id="askAtasKanan4" onclick="atasKanan4()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="atasKanan40" runat="server"  style="position:absolute; margin-left:240px; margin-top:5px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>
								...
								<!-- Atas Kanan 5 -->
                                <asp:CheckBox runat="server" style="margin-left:90px;" name="askAtasKanan5" id="askAtasKanan5" onclick="atasKanan5()" value="1"/> 
                                &nbsp;<asp:DropDownList ID="atasKanan50" runat="server" style="position:absolute; margin-left:360px; margin-top:5px; display:none;">
                                    <asp:ListItem>X</asp:ListItem>
                                    <asp:ListItem>V</asp:ListItem>
                                    <asp:ListItem>O</asp:ListItem>
                                </asp:DropDownList>	
