...
Partial Class Default2
    ...
    Protected Sub TampilDetailPermohonan()
        ...
        Else
            Call GetDataA_Tabel_SPKAH_Header_Asesoris("SELECT * FROM TRXN_OPTPO WHERE OPT_NOMORMOHON='" & LblResultIdMohon.Text & "'")
        End If

        If InStr(LblResultIdMohon.Text, "EM/APR/WB") = 0 Then
            'Bukan Permohonan Bodyrepair Gudang
            If LblNoSPK.Text <> "" Then
                ...
                'Khusus yang Asesoris dan DO update Aksesorisnya
                ...
                'Cari Jenis Pindah dana jika Switching
                Dim mSw As Byte = 0
                ...
                If Not (InStr(LblResultIdMohon.Text, "WB/APR/SD") <> 0 Or _
                        ...
                        InStr(LblResultIdMohon.Text, "WB/APR/DD") <> 0 Or _
                        InStr(LblResultIdMohon.Text, "WB/APR/DO") <> 0) Then
                    'Tabel Permohonan Gabungan 
                ...
                Else
                    'Permohonan Detail Single
                    'DD=Permohonan DO Dealer                    DO=permohonan DO
                    'SD=Permohonan Khusus Polcy Max Diskon      AS=permohonan Aksesoris 
                    'FT=Permohonan Faktur                       

                    If InStr(LblResultIdMohon.Text, "WB/APR/AS") = 0 Then
                        Call GetDataA_Tabel_SPKAH_Detail_Permohonan("SELECT * FROM TRXN_SPKAH WHERE CABANG='" & lblDealer.Text & "' AND TRXN_SPKAH.NOMOR_SPK='" & LblNoSPK.Text & "' AND APPROVALCODE='" & LblResultPosSetuju.Text & "' AND TRXN_SPKAH.NOMOR_MOHON='" & LblResultIdMohon.Text & "' AND JUDUL LIKE 'ENTRY%' " & mCari & mNomor)
                    ...
                    ElseIf InStr(LblResultIdMohon.Text, "WB/APR/DO") <> 0 Or InStr(LblResultIdMohon.Text, "WB/APR/DD") <> 0 Then
                        MultiViewSetujuRangka.ActiveViewIndex = 0
                        LvAksesorisNonDO.DataBind()
                        MultiViewAsesorisHdiary.ActiveViewIndex = 0
                        MultiViewSetujuAsesorisSPK.ActiveViewIndex = 0
                        CheckAksesoris.Visible = True
                    ElseIf InStr(LblResultIdMohon.Text, "WB/APR/AS") <> 0 Then
                        MultiViewAsesorisHdiary.ActiveViewIndex = 0
    ...
    Function UpdateDataMohon(ByVal mIdNo As String, ByVal mNoUrut As String, ByVal mEntry As String, ByVal mAlasan As String, ByVal mSetujuTolak As String, ByVal mCatatan As String, ByVal mPosisi As String, ByVal mBaRIS As Byte) As Byte
        ...
        If mNoUrut <> "" Then
            ...
            If mPosTerakhir = mPosisi Or mSetujuTolak = "TOLAK" Then
                If mSetujuTolak = "SETUJU" And InStr(mIdNo, "WB/APR/SW") <> 0 Then 'Pindah Dana
                ...
                If mSetujuTolak = "SETUJU" And InStr(mIdNo, "WB/APR/SW") <> 0 And mSukses = 1 Then
                    Call Proses_Ubah_Data_Yang_Sudah_disetujui(mIdNo, lblDealer.Text)
                End If
            Else
...
ErrHand:
    ...
    Function GetDataA_Tabel_SPKAH_Header_Asesoris(ByVal mSqlCommadstring As String) As Byte
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
        Call Msg_err("", "")
        GetDataA_Tabel_SPKAH_Header_Asesoris = 0
        ...
        Try
            ...
            cmd = New OleDbCommand(mSqlCommadstring, cnn)
            MyRecReadA = cmd.ExecuteReader()
            GetDataA_Tabel_SPKAH_Header_Asesoris = IIf(MyRecReadA.HasRows = True, 1, 0)
            While MyRecReadA.Read()
    ...
    Function GetDataA_Tabel_SPKAH_Detail_Permohonan(ByVal mSqlCommadstring As String) As Byte
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
        Call Msg_err("", "")
        GetDataA_Tabel_SPKAH_Detail_Permohonan = 0
        ...
        Try
            ...
            cmd = New OleDbCommand(mSqlCommadstring, cnn)
            MyRecReadA = cmd.ExecuteReader()
            GetDataA_Tabel_SPKAH_Detail_Permohonan = IIf(MyRecReadA.HasRows = True, 1, 0)
            While MyRecReadA.Read()
    ...
    Function Proses_Ubah_Data_Yang_Sudah_disetujui(ByVal Cari As String, ByVal mLokasi As String) As Byte  'Baru belum diupdate VB.net
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
        ...
        Try
                ...
                While MyRecReadF.Read
                    ...
                    Else
                        ...
                        If UpdateDatabase_Tabel(MySTRsql1, mLokasi) = 1 Then
                            ...
                            ElseIf InStr(nSr(MyRecReadF("JUDUL")), "SETUJU") <> 0 Then

                                If InStr(nSr(MyRecReadF("JUDUL")), "MELEBIHI MAKSIMAL") <> 0 And _
                                ...
                                ElseIf InStr(nSr(MyRecReadF("JUDUL")), "ALASAN DO/ISI NOMOR RANGKA") <> 0 Or _
                                       InStr(nSr(MyRecReadF("JUDUL")), "ALASAN DO/DEALER NOMOR RANGKA TEST") <> 0 Then
                                ...
                                ElseIf InStr(nSr(MyRecReadF("JUDUL")), "PERMOHONAN KIRIM UNIT DEALER TEST") <> 0 Then
                                    Dim Norangkaku As String = GetDataD_IsiField("SELECT SPK_NORANGKA as IsiField FROM TRXN_SPK WHERE SPK_NO='" & nSr(MyRecReadF("NOMOR_SPK")) & "'", mLokasi)
                                    Call Update_Stock_Warehouse_Centralize(mLokasi, "MD", Norangkaku, nSr(MyRecReadF("NOMOR_SPK")), nSr(MyRecReadF("CHANGE")))

                                ElseIf InStr(nSr(MyRecReadF("JUDUL")), "WAKTU UANG MUKA") <> 0 Then
                                ...
                                ElseIf (InStr(nSr(MyRecReadF("JUDUL")), "HARGA UNIT") <> 0 Or _
                                        ...
                                        And InStr(nSr(MyRecReadF("JUDUL")), "TIDAK DIRUBAH SETUJU") <> 0 Then
                                    Call GetData_Setuju_Perubahan_Harga(mLokasi, nSr(MyRecReadF("NOMOR_SPK")), nSr(MyRecReadF("JUDUL")), nSr(MyRecReadF("CHNAGE")), mNoMohon)

                                ElseIf InStr(nSr(MyRecReadF("JUDUL")), "ENTRY ALASAN PEMBUATAN FAKTUR") <> 0 Then

                                ElseIf InStr(nSr(MyRecReadF("JUDUL")), "CANCEL SPK") <> 0 Then
            ...
            End If
            Proses_Ubah_Data_Yang_Sudah_disetujui = 1
        Catch ex As Exception
            Call Msg_err(ex.Message, "")
        End Try
    End Function
    ...
    Function GetData_Setuju_DO(ByVal mServer As String, _
        ...
        MySTRsql1 = "SELECT * , " & _
                    ...
                    "FROM TRXN_STOCK WHERE STOCK_NORANGKA='" & mpNoRangka & "'"
        Call Msg_err("", "")
        cnn = New OleDbConnection(strconn)
        ...
        Try
            ...
            If MyRecReadB.HasRows = True Then
                ...
                End If
                    ...
                    If merrordo = "" Then
                        MySTRsql1 = "UPDATE TRXN_SPK SET SPK_NORANGKA='" & mpNoRangka & "' WHERE SPK_NO='" & nSr(mpNoSPK) & "'"
        ...
        Try
            ...
            If MyRecReadB.HasRows = True Then
                If MyRecReadB.Read Then
                    ...
                    MySTRsql1 = "UPDATE TRXN_SPKCANCEL SET SPKCANCEL_UMUR=ISNULL(SPKCANCEL_UMUR,0)+" & (mMasterUmur + nLg(mfChange)) & " WHERE SPKCANCEL_NO='" & mfNospk & "'"
                    Call UpdateDatabase_Tabel(MySTRsql1, mfServer)
                End If
            End If
    ...
    'S P J unit
    Function Update_Stock_Warehouse_Centralize(ByVal mLokasi As String, ByVal mKode As String, ByVal mRangka As String, ByVal mNoSPK As String, ByVal mTglMohonKirim As String) As Byte
        Dim mIloop As Byte
        ...
        mTglMohonKirim = InputDT(Mid(mTglMohonKirim, 7, 4), Mid(mTglMohonKirim, 4, 2), Mid(mTglMohonKirim, 1, 2), Mid(mTglMohonKirim, 12, 2), "00", "00", "")
        ...
        End If
        If mTxtErr <> "" Then
            Call Msg_err(mTxtErr, 1)
        Else
            Update_Stock_Warehouse_Centralize = Proses_input_Kirim_Warehouse(mKode, mRangka, mTglMohonKirim, lblDealer.Text)
        End If
    End Function
    Function Proses_input_Kirim_Warehouse(ByVal mpKode As String, ByVal mpNoRangka As String, ByVal mpTglMohon As String, ByVal mfServer As String) As Byte
        ...
        If mpKode = "MD" Then
            MySTRsql1 = "SELECT * FROM TRXN_SPK,DATA_SALESMAN,DATA_LEASE WHERE " & _
                        "SPK_CDSALES=SALES_KODE AND SPK_CDLEASE=LEASE_KODE AND SPK_NORANGKA='" & mpNoRangka & "'"
        Else
        ...
        Try
            ...
            If MyRecReadA.HasRows = True Then
                If MyRecReadA.Read Then
                    ...
                    For mIloop = 1 To 12
                        Select Case mIloop
                            ...
                            Case 9 : mErrorStatus = UPDATE_SPKAH_SUKSES(mpNoRangka)
                ...
                End If
            End If
            Proses_input_Kirim_Warehouse = 1
            MyRecReadA.Close()
            cmd.Dispose()
            cnn.Close()
        Catch ex As Exception
    ...
    Function UpdateDataSPK(ByVal mNOSPK As String, ByVal mTglMohon As String) As Byte
        ...
        MySTRsql1 = "UPDATE TRXN_SPK SET " & _
                    ...
                    "WHERE SPK_No ='" & mNOSPK & "'"
        UpdateDataSPK = UpdateDatabase_Tabel(MySTRsql1, lblDealer.Text)
    End Function
    Function UPDATE_STOCK(ByVal mpRangka As String, ByVal mDateTR As String, ByVal mDateMA As String, ByVal mDateMI As String, ByVal mDateMW As String) As Byte
        ...
        UPDATE_STOCK = UpdateDatabase_Tabel(MySTRsql1, lblDealer.Text)
    End Function

    Function UPDATE_SPKAH_SUKSES(ByVal mlblNospk As String) As Byte
        MySTRsql1 = "UPDATE TRXN_SPKAH SET STATUS=GETDATE(),APPROVALCODEP=APPROVALCODEP+'4',judul=REPLACE(judul,'ENTRY','SETUJU') WHERE NOMOR_SPK='" & mlblNospk & "' AND CABANG='" & lblArea1.Text & "' AND judul like 'ENTRY%KIRIM UNIT DEALER%' AND (APPROVALCODEP='0' or APPROVALCODEP='1'  or APPROVALCODEP='01' )"
        UPDATE_SPKAH_SUKSES = UpdateDatabase_Tabel(MySTRsql1, lblDealer.Text)
    End Function
    Function AddSaveDataSPKC_SPJ(ByVal mNOSPK As String, ByVal mNAMA As String, ByVal mNILAI1 As String, ByVal mNILAITgl2 As String, ByVal mInput As String, ByVal mSts As String) As String
        ...
        If GetDataD_00NoFound01Found("SELECT * FROM TRXN_SPKC WHERE SPKC_NO='" & mNOSPK & "' AND SPKC_NAMA='" & mNAMA & "'", lblArea1.Text) = 1 Then
            AddSaveDataSPKC_SPJ = UpdateDatabase_Tabel("UPDATE TRXN_SPKC SET SPKC_ST=GETDATE(),SPKC_NAMA='" & mInput & "',SPKC_TEMP='SYSTEM' WHERE SPKC_NO='" & mNOSPK & "' AND SPKC_NAMA='" & mNAMA & "'", lblDealer.Text)
        End If
    End Function
