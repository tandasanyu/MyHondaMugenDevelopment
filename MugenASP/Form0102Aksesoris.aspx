    ...
    <asp:MultiView ID="MultiViewTabelVA" runat="server" Visible="TRUE">
        ...
        <asp:View ID="V2FormUpdateSPKdanAksesoris" runat="server">
            ...
            <tr> 
                ...
                <td style="width: 75%; Background-color:#CCCCFF;">
                    ...
                    <asp:Button ID="ButtonSPKrefresh" runat="server" BackColor="#003399" 
                        ...
                        Text="Perbarui Tabel Permohoan" />
                    <asp:Label ID="Label82" runat="server" Font-Names="Arial" Font-Size="Small" 
                    height= "21px" Text=" "></asp:Label>
                    <asp:Button ID="ButtonLoadSPK" runat="server" BackColor="#FF0080" 
                        Font-Overline="False" Font-Size="Small" Height="20px" 
                        Text="Detail Data SPK terakhir" ForeColor="White" />
            ...
            <tr>
                ...
                <td style="width: 75%; ">
                    <asp:DropDownList ID="DropDownList3" runat="server" Width="60%" AutoPostBack="true"  >
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr> 
                ...
                <td style="width: 75%; background-color:#CCCCFF ;">
                   ...
                   <asp:Label ID="lblMohonDetailSPK" runat="server" Font-Names="Calibri" Font-Size="Medium" height= "21px" Text="Nomor SPK"></asp:Label>
                    <asp:Label ID="lblMohonDetailInfoSPK" runat="server" Font-Names="Calibri" 
                        Font-Size="Medium" height="21px" Text="Nomor SPK"></asp:Label>
                </td>
            </tr>
            </table>  
            <div>
            ...
            <asp:MultiView ID="MultiViewMhnDetailSub" runat="server" Visible="TRUE">
            ...
            <asp:MultiView ID="MultiViewMhnInpDONoDealer" runat="server" Visible="TRUE">
            <asp:View ID="ViewMohonDONoDealer" runat="server">
            <table id="table3"  border="2" width="100%"  style="border-collapse:collapse;">
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    ...
                    &nbsp;</td>
                <td style="width: 50%; ">
                    <asp:RadioButton ID="RadioBtnAsrNo" Text="Tidak" runat="server" AutoPostBack="true" OnCheckedChanged="AsuransiTDK"  />
                    <asp:RadioButton ID="RadioBtnAsrYs" Text="Ya, Jika ya isi berapa nilai Asuransi Rp. " runat="server" AutoPostBack="true" OnCheckedChanged="AsuransiYA" />
            ...
            <asp:MultiView ID="MultiViewMhnInpDODealer" runat="server" Visible="TRUE">
            <asp:View ID="View12" runat="server">
            <table id="table2"  border="2" width="100%"  style="border-collapse:collapse;">
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="Label84" runat="server" Font-Names="Arial" Font-Size="Small" 
                    height= "21px" Text="Apakah Jual Putus Atau Barter"></asp:Label>
                    &nbsp;</td>
                <td style="width: 50%; ">
                    <asp:RadioButton ID="RadioBtnDoDealer1" Text="Putus" runat="server" AutoPostBack="true" OnCheckedChanged="BarterCHangeYa"   />
                    <asp:RadioButton ID="RadioBtnDoDealer2" Text="Barter" runat="server"  AutoPostBack="true" OnCheckedChanged="BarterCHangeTdk"/>
                </td>
                <td style="width: 25%; color: #FF0000;" >
                </td>
            </tr>
            ...
            <asp:MultiView ID="MultiViewMhnTglKirimSub" runat="server" Visible="TRUE">
            <asp:View ID="ViewMhnTglKirim1Sub" runat="server">
