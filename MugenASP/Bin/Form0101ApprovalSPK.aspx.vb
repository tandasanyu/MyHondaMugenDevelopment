...
Partial Class Default2
    ...
    Sub insert_tabel(ByVal pmLblMhn As String, ByVal pmLblJudul As String, ByVal pmLblAlasan As String, ByVal pmLblTanggal As String, ByVal pmLblNomor As String, ByVal pmLbluser As String, ByVal pmLblChange0 As String, ByVal pmLblChange1 As String, ByVal pmLblChange2 As String, ByVal pmLblChange3 As String)
        ...
        If Lbl01Mhn.Text = "" Then
            Lbl01Mhn.Text = pmLblMhn : Lbl01Judul.Text = pmLblJudul : Lbl01Alasan.Text = pmLblAlasan : Lbl01Nilai.Text = mChange : Lbl01Tanggal.Text = pmLblTanggal : Lbl01Nomor.Text = pmLblNomor : Lbl01User.Text = pmLbluser : ChkBox1.Checked = True : ChkBox1.Visible = True
        ElseIf Lbl02Mhn.Text = "" Then
            Lbl02Mhn.Text = pmLblMhn : Lbl02Judul.Text = pmLblJudul : Lbl02Alasan.Text = pmLblAlasan : Lbl02Nilai.Text = mChange : Lbl02Tanggal.Text = pmLblTanggal : Lbl02Nomor.Text = pmLblNomor : Lbl02User.Text = pmLbluser : ChkBox2.Checked = True : ChkBox2.Visible = True
        ElseIf Lbl03Mhn.Text = "" Then
            Lbl03Mhn.Text = pmLblMhn : Lbl03Judul.Text = pmLblJudul : Lbl03Alasan.Text = pmLblAlasan : Lbl03Nilai.Text = mChange : Lbl03Tanggal.Text = pmLblTanggal : Lbl03Nomor.Text = pmLblNomor : Lbl03User.Text = pmLbluser : ChkBox3.Checked = True : ChkBox3.Visible = True
        ElseIf Lbl04Mhn.Text = "" Then
            Lbl04Mhn.Text = pmLblMhn : Lbl04Judul.Text = pmLblJudul : Lbl04Alasan.Text = pmLblAlasan : Lbl04Nilai.Text = mChange : Lbl04Tanggal.Text = pmLblTanggal : Lbl04Nomor.Text = pmLblNomor : Lbl04User.Text = pmLbluser : ChkBox4.Checked = True : ChkBox4.Visible = True
        ElseIf Lbl05Mhn.Text = "" Then
            Lbl05Mhn.Text = pmLblMhn : Lbl05Judul.Text = pmLblJudul : Lbl05Alasan.Text = pmLblAlasan : Lbl05Nilai.Text = mChange : Lbl05Tanggal.Text = pmLblTanggal : Lbl05Nomor.Text = pmLblNomor : Lbl05User.Text = pmLbluser : ChkBox5.Checked = True : ChkBox5.Visible = True
        ElseIf Lbl06Mhn.Text = "" Then
            Lbl06Mhn.Text = pmLblMhn : Lbl06Judul.Text = pmLblJudul : Lbl06Alasan.Text = pmLblAlasan : Lbl06Nilai.Text = mChange : Lbl06Tanggal.Text = pmLblTanggal : Lbl06Nomor.Text = pmLblNomor : Lbl06User.Text = pmLbluser : ChkBox6.Checked = True : ChkBox6.Visible = True
        ElseIf Lbl07Mhn.Text = "" Then
            Lbl07Mhn.Text = pmLblMhn : Lbl07Judul.Text = pmLblJudul : Lbl07Alasan.Text = pmLblAlasan : Lbl07Nilai.Text = mChange : Lbl07Tanggal.Text = pmLblTanggal : Lbl07Nomor.Text = pmLblNomor : Lbl07User.Text = pmLbluser : ChkBox7.Checked = True : ChkBox7.Visible = True
        ElseIf Lbl08Mhn.Text = "" Then
            Lbl08Mhn.Text = pmLblMhn : Lbl08Judul.Text = pmLblJudul : Lbl08Alasan.Text = pmLblAlasan : Lbl08Nilai.Text = mChange : Lbl08Tanggal.Text = pmLblTanggal : Lbl08Nomor.Text = pmLblNomor : Lbl08User.Text = pmLbluser : ChkBox8.Checked = True : ChkBox8.Visible = True
        ElseIf Lbl09Mhn.Text = "" Then
            Lbl09Mhn.Text = pmLblMhn : Lbl09Judul.Text = pmLblJudul : Lbl09Alasan.Text = pmLblAlasan : Lbl09Nilai.Text = mChange : Lbl09Tanggal.Text = pmLblTanggal : Lbl09Nomor.Text = pmLblNomor : Lbl09User.Text = pmLbluser : ChkBox9.Checked = True : ChkBox9.Visible = True
        ElseIf Lbl10Mhn.Text = "" Then
            Lbl10Mhn.Text = pmLblMhn : Lbl10Judul.Text = pmLblJudul : Lbl10Alasan.Text = pmLblAlasan : Lbl10Nilai.Text = mChange : Lbl10Tanggal.Text = pmLblTanggal : Lbl10Nomor.Text = pmLblNomor : Lbl10User.Text = pmLbluser : ChkBox10.Checked = True : ChkBox10.Visible = True
        End If
    End Sub
...
ErrHand:
    ...
    Sub Rubah_Status(ByVal mStatus As String, ByVal mGol As Byte)
        ...
        If MultiViewENTRY.ActiveViewIndex = 1 And mStatus = "SETUJU" Then
            ...
            ElseIf InStr(lblPolcyNomorMohon.Text, "WB/APR/DO") <> 0 Then 'Pengajuan DO 
                ...
                End If
                If mGol = 1 Then
                    If GetFindRecord_Tabel("SELECT * FROM TRXN_OPTPO WHERE OPT_NOSPK='" & LblNoSPK.Text & "' AND OPT_NODEALER='" & lblDealer.Text & "' AND OPT_STATUSPROSES LIKE 'ENTRY%' AND (OPT_USERAPPV1 IS NULL OR OPT_USERAPPV1='') AND NOT(OPT_SPV='SC' OR OPT_SPV='UG' OPT_SPV='FZ')") = 1 Then
    ...
    Function UpdateDataMohon(ByVal mIdNo As String, ByVal mNoUrut As String, ByVal mEntry As String, ByVal mAlasan As String, ByVal mSetujuTolak As String, ByVal mCatatan As String, ByVal mPosisi As String, ByVal mBaRIS As Byte) As Byte
        ...
        If mPosisi = "0" And (lblTglsetuju0.Text = "" Or (lblTglsetuju0.Text <> "" And mNoUrut = "")) Then
            lblTglsetuju0.Text = UpdateSetujuDataUser(mIdNo, mSetujuTolak, mCatatan, mPosisi, mBaRIS, mNoUrut)
        ElseIf mPosisi = "1" And (lblTglSetuju1.Text = "" Or (lblTglSetuju1.Text <> "" And mNoUrut = "")) Then
            lblTglSetuju1.Text = UpdateSetujuDataUser(mIdNo, mSetujuTolak, mCatatan, mPosisi, mBaRIS, mNoUrut)
        ElseIf mPosisi = "2" And (lblTglSetuju2.Text = "" Or (lblTglSetuju2.Text <> "" And mNoUrut = "")) Then
            lblTglSetuju2.Text = UpdateSetujuDataUser(mIdNo, mSetujuTolak, mCatatan, mPosisi, mBaRIS, mNoUrut)
        ElseIf mPosisi = "3" And (LblTglSetuju3.Text = "" Or (LblTglSetuju3.Text <> "" And mNoUrut = "")) Then
            LblTglSetuju3.Text = UpdateSetujuDataUser(mIdNo, mSetujuTolak, mCatatan, mPosisi, mBaRIS, mNoUrut)
        ...
        If mNoUrut <> "" Then
            ...
            If MultiViewENTRY.ActiveViewIndex = 1 Then
                ...
                ElseIf InStr(mIdNo, "WB/APR/FT") <> 0 Then 'Setuju hanya Faktur
                    If UpdateData_Tabel("UPDATE TRXN_SPKAF SET SPKAF_NOMOR='" & mNoUrut & "' WHERE SPKAF_NOMORMOHON = '" & mIdNo & "' AND SPKAF_NOMOR=''") = 1 Then
            ...
            If mNomorSPKAH_SqlUpdate = "" Then
                mTextSql = "UPDATE TRXN_SPKAH SET APPROVALCODEP='" & lblPosSetuju.Text & mPosisi & "'" & mChangeHarga & ",NOMOR='" & mNoUrut & "' " & _
            ...
            If UpdateData_Tabel(mTextSql) = 1 Then
                Call TandaResult(mBaRIS, mSetujuTolak)
                mNomorSPKAH_SqlUpdate = mNoUrut
            End If
            ...
            If mPosTerakhir = mPosisi Or mSetujuTolak = "TOLAK" Then
                Call Update_Tabel_SPKAH_Keputusan_Terakhir(mIdNo, mEntry, mSetujuTolak, mCatatan, mPosisi, mNomorSPKAH_SqlUpdate)
            End If
            If mPosTerakhir = "3" And mPosisi = "1" And mSetujuTolak = "SETUJU" And InStr(mIdNo, "WB/APR/SD") <> 0 Then
                Call SendEmailProces("Susanto.soetrisno@gmail.com", "Permohonan persetujuan melebihi Diskon tgl " & Now() & " NOMOR " & mNoUrut, "", "", "Permohonan persetujuan melebihi Diskon tgl " & Now())
                Call SendEmailProces("Susantosoetrisno@yahoo.com", "Permohonan persetujuan melebihi Diskon tgl " & Now() & " NOMOR " & mNoUrut, "", "", "Permohonan persetujuan melebihi Diskon tgl " & Now())
    ...
    Function UpdateSetujuDataUser(ByVal mpIdMohon As String, ByVal mREASON As String, ByVal mCatat As String, ByVal mPos As String, ByVal mBar As Byte, ByVal mUrut As String) As String
        Call Msg_err("", "")
        ...
        If mPos = "0" Then
            mDisetujuiOleh = GetFindRecord_Tabel("SELECT * FROM TRXN_SPKAH WHERE NOMOR='" & mNomor_urut & "' AND SPV='" & TxtCariNoSPK.Text & "'")
    ...
    Function Update_Tabel_SPKAH_Keputusan_Terakhir(ByVal mIdnom As String, ByVal mKetENtry As String, ByVal Reason As String, ByVal mCatat As String, ByVal mPos As String, ByVal mNo As String) As Byte
        ...
        If Reason = "SETUJU" Then
            ...
            Call UpdateData_Tabel("UPDATE TRXN_SPKAH SET JUDUL='" & mSetujuGantiRevisiBaru & "' " & _
            ...
            While MyRecReadA.Read()
                If Not (InStr(nSr(MyRecReadA("NOMOR_MOHON")), "WB/APR/SD") <> 0 Or _
                    ...
                    Call insert_tabel(nSr(MyRecReadA("NOMOR_MOHON")), _
                                      ...
                                      nSr(MyRecReadA("TANGGAL_ENTRY")), nSr(MyRecReadA("NOMOR")), nSr(MyRecReadA("MYUSER")), nSr(MyRecReadA("CHANGE")), nSr(MyRecReadA("CHANGE1")), nSr(MyRecReadA("CHANGE2")), nSr(MyRecReadA("CHANGE3")))
...
ErrHand:
    ...
    Protected Sub Button9_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Else
            ...
            End If
            If txtChatNo1.Text <> "" Then
                If UpdateData_Tabel("INSERT INTO TRXN_SPKAHCHT (CHAT_DEALER,CHAT_NO,CHAT_TGL,CHAT_USER,CHAT_TEXT,CHAT_NOMOHON) VALUES ('" & _
                    ...
                    If UCase(LblUserName.Text) <> "SANTO" Then
                        Call SendEmailProces("Susanto.soetrisno@gmail.com", "Percakapan NOMOR CHAT " & txtChatNo1.Text, "", "", mBodyMsg)
                    Else
                        If lblArea1.Text = "112" Then
                            Call SendEmailProces("Faiz@hondamugen.co.id", "Percakapan NOMOR CHAT " & txtChatNo1.Text, "", "", mBodyMsg)
                        Else
                            Call SendEmailProces("Ugam@hondamugen.co.id", "Percakapan NOMOR CHAT " & txtChatNo1.Text, "", "", mBodyMsg)
                        End If
                    End If
                End If
            End If
    ...
    Protected Sub lvChat_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LVChat.SelectedIndexChanged
        ...
        Call GetData_Chat("SELECT * FROM TRXN_SPKAHCHT WHERE CHAT_NO='" & txtChatNo1.Text & "'", 0)
    End Sub

    Function GetData_NomorChat() As String
        Call Msg_err("", "")
        GetData_NomorChat = GetData_SearchNomorChat()
        If GetData_NomorChat <> "" Then
            If GetData_NomorChat = "NO FOUND" Then
                GetData_NomorChat = GetData_StartNomorChat()
            End If
        End If
        If GetData_NomorChat = "" Then
            Call Msg_err("DATA TIDAK BERHASIL DISIMPAN", "")
    ...
    Function GetData_SearchNomorChat() As String
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        ...
        Try
            ...
            mFind = IIf(MyRecReadA.HasRows = True, 1, 0)
            If mFind = 0 Then
                GetData_SearchNomorChat = "NO FOUND"
            Else
                MyRecReadA.Read()
                If nSr(MyRecReadA("mMaxNomor")) = "" Then
                    GetData_SearchNomorChat = "NO FOUND"
                Else
                    GetData_SearchNomorChat = Val(nSr(MyRecReadA("mMaxNomor"))) + 1
                End If
            End If
            MyRecReadA.Close()
            cmd.Dispose()
    ...
    Function GetData_StartNomorChat() As String
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        ...
        Try
            ...
            MyRecReadA = cmd.ExecuteReader()
            mFind = IIf(MyRecReadA.HasRows = True, 1, 0)
            If mFind = 0 Then GetData_StartNomorChat = "NO FOUND"
            While MyRecReadA.Read()
                GetData_StartNomorChat = lblDealer.Text & _
    ...
    Function GetData_Chat(ByVal mSqlCommadstring As String, ByVal mType As Byte) As Double
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
        Call Msg_err("", "")
