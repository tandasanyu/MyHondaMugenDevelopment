            ...
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                   <asp:Label ID="Label90" runat="server" Font-Names="Arial" Font-Size="Small" 
                    ...
                    &nbsp;</td>
                <td style="width: 75%; ">
                    <asp:TextBox ID="txtChatTanggal" runat="server" text="" Width="100%" MaxLength="100" CssClass="uppercase"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
            ...
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                   <asp:Label ID="Label101" runat="server" Font-Names="Arial" Font-Size="Small" 
                    ...
                    &nbsp;</td>
                <td style="width: 75%; ">
                    <asp:TextBox ID="txtChatUser" runat="server" text="" Width="100%" MaxLength="100" CssClass="uppercase"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
