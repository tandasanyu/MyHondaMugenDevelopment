...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table style="width: 100%; height:auto ; font-family: Arial; font-size: small;">
        <tr>
            ...
            <td style="width: 20%;height:auto ">
               <asp:Button ID="Button14" runat="server" Text="Pasang Aksesoris Ke suplier"  
                    BackColor="#808040" Font-Bold="True" ForeColor="White" Width="95%" Height="35px" />
                </td>
...
<br />
    ...
    <asp:MultiView ID="MultiView1a" runat="server" Visible="TRUE">
        ...
        <asp:Label ID="Label110" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Data SPK"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label111" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Data Unit"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label112" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Data Harga"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label113" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Cara Bayar"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label114" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Data Permohonan"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label115" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Data Perubahan"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <asp:Label ID="Label116" runat="server" Font-Names="Arial" Font-Size="Small" height= "21px" Text="Alur Persetujuan"></asp:Label>
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;
                   border-top-color :red; border-top-style:solid  ; border-top-width:thin;
                   border-bottom-color :red; border-bottom-style:solid  ; border-bottom-width:thin;
                   border-left-color :red; border-left-style:solid  ; border-left-width:thin;
        ...
        <table style="width: 100%; height:inherit; font-family: Arial; font-size: small">
            ...
            <asp:MultiView ID="MultiViewMhnInpPaketCermat" runat="server" Visible="TRUE">
            <asp:View ID="View14" runat="server">
            <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;">
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="Label117" runat="server" Font-Names="Arial" Font-Size="Small" 
                    height= "21px" Text="Harga Modal Paket Cermat"></asp:Label>
                    &nbsp;</td>
                <td style="width: 25%; ">
                    <asp:TextBox ID="TxtChangePaketCermatM" runat="server" text="" Width="149px"></asp:TextBox>
                    <asp:CompareValidator ID="CompareValidatorPaketCermatM" runat ="server"  
                      ErrorMessage ="Tipe data harus numerik " ControlToValidate="TxtChangePaketCermatM" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 50%; color: #FF0000;" >&lt;---Isi harga Modal Paket Cermat </td>
            </tr>
            </table> 
            </asp:View> 
            </asp:MultiView>   

            <asp:MultiView ID="MultiViewMhnInpBedaThn" runat="server" Visible="TRUE">
            <asp:View ID="View16" runat="server">
            <table style="width: 100%; height:inherit; font-family: Arial; font-size: small;">
            <tr>
                <td style="width: 25%; background-color: #000000;  color: #FFFFFF;">
                    <asp:Label ID="Label120" runat="server" Font-Names="Arial" Font-Size="Small" 
                    height= "21px" Text="Harga Selisih beda tahun"></asp:Label>
                    &nbsp;</td>
                <td style="width: 25%; ">
                    <asp:TextBox ID="TxtChangeBedaThn" runat="server" text="" Width="149px"></asp:TextBox>
                    <asp:CompareValidator ID="CompareValidatorBedaThn" runat ="server"  
                      ErrorMessage ="Tipe data harus numerik " ControlToValidate="TxtChangeBedaThn" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 50%; color: #FF0000;" >&lt;---Isi harga unit selisih tahun</td>
            </tr>
            </table> 
            </asp:View> 
            </asp:MultiView>   
           ...
           <tr> 
            ...
            <td style="width: 25%;  color: #FFFFFF;">
                <asp:Button ID="Button2" runat="server" Text="Simpan" Width="321px" 
                    Height="43px" Font-Overline="False" Font-Size="X-Large" 
                    BackColor="#004080"  onclick="Button2_Click" Font-Bold="True" 
                    ForeColor="Yellow"/>    
                ...
                <div id="btnCloseParent" style="float: right; visibility :hidden">
                ...
                <div>
                <p>
                    Tunggu Sedang Sistem sedang melakukan proses simpan ...... sampai ada "Data Permohonan sudah tersimpan "...... ......
                </p>
                <br />
                </div>
                </div>        
                ...
                <ajaxToolkit:AnimationExtender id="OpenAnimation" runat="server" TargetControlID="Button2">
                <Animations>
                <OnClick>
                    <Sequence>
                        ...
                        <ScriptAction Script="Cover($get('ctl00_SampleContent_Button2'), $get('flyout'));" />
            ...
            <asp:ListView ID="LvPermohonan" runat="server" DataSourceID="sdsTabelPermohonan" DataKeyNames ="JUDUL">
            <LayoutTemplate>
            <table id="table-a"  border="2" width="100%"  style="border-collapse:collapse;">
                <thead  style="background-color:Silver; height:30px">
                <th>Tipe Permohonan</th><th>Buat</th><th>Proses</th><th>Nomor</th><th>Dibuat</th><th>SPV</th><th>Pos #1</th><th>Pos #2</th>
            ...
            <ItemTemplate>
                <tr>
                    <td style="width:9%; font-size: x-small">
                       <asp:LinkButton ID="lnkSelect" Text='<%# Eval("JUDUL") %>' CommandName="Select" runat="server" />
                    </td>
                    <td style="width:7%; font-size:x-small"><%#Eval("mJudul")%></td>
