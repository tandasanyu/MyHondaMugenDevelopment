...
Partial Class Form02Aksesoris
    ...
    Protected Sub LvPO_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LvPO.SelectedIndexChanged
        ...
        If UCase(LblUserName.Text) = "ITPSMOK" Or UCase(LblUserName.Text) = "ITPURIOK" Then
            CheckBoxUpdateAss.Checked = False : CheckBoxUpdateAss1.Checked = False
    ...
    Sub DropDownList3_DO()
        ...
        End If
        If DropDownList3.Text = "ENTRY SUBSIDI SALES" Then
            MultiViewMhnInpSubsidiSales.ActiveViewIndex = 0
        End If
...
ErrHand:
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ElseIf DropDownList3.Text = "ENTRY SUBSIDI SALES" And _
           (Not IsNumeric(TxtChangePaketCermatM.Text) Or Val(TxtChangePaketCermatM.Text) < 0 Or TxtChangePaketCermatM.Text = "") Then
            Call Msg_err("ISIAN HARGA SUBSIDI SALES BELUM DIISI") : Exit Sub
        ...
        If mAroval <> "" And mNomorMohon <> "" Then
            ...
            ElseIf DropDownList3.Text = "ENTRY SUBSIDI SALES" Then
                mTxtInsert = "'" & UCase(TxtPetik(Left(Trim(TxtChangeSubsidiSales.Text), 20))) & "','','','',''"
            End If
