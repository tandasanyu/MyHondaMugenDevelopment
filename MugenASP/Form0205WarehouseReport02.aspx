<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Form0205WarehouseReport02.aspx.vb" Inherits="Form0205WarehouseReport02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
            <center>
                <h2 style="font-family:Cooper Black;">Laporan Gesek Rangka</h2>
            </center>
	</div>  
    <center>
   ...
   <asp:MultiView ID="MultiViewError" runat="server" Visible="TRUE">
    ...
    <asp:View ID="View8" runat="server">
        ...
        <tr>
            <td style="width: 30%; ">
                <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Size="Small" 
                    height="99%" Text="Pencarian Dari Tanggal Input Gesek Rangka"></asp:Label>
            </td>
            <td style="width: 30%; ">
        ...
        <asp:ListView ID="LvTabelBBM" 
            ...
            <th>Tgl TTK</th><th>No TTK</th><th>Warna</th><th>Tipe</th><th>Rangka</th><th>Mesin</th><th>Lokasi SPK</th>
            <th>Tgl Gesek</th><th>Tgl Terima</th>
            </thead>
