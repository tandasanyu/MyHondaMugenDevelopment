...
Partial Class HRDPENILAIANATASANSALES
   Inherits System.Web.UI.Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		TxtStaffNIK.Text = lblusername.text
    End Sub
...
ErrHand:
    ...
    Sub SaveTombol()
        Call UpdateData_Server("DELETE FROM TRXN_KPIN WHERE KPIN_USER='" & TxtStaffNIK.Text & "' AND KPIN_TGL like '%" & TahunPenilaian.Text & "%' AND KPIN_GROUP = '2'")
    ...
    Function UpdateData_Server(ByVal mSqlCommadstring As String) As Byte
        Dim strconn As String = WebConfigurationManager.ConnectionStrings("MyConnCloudDnet4").ConnectionString
        Dim cnn As OleDbConnection
        Dim cmd As OleDbCommand
