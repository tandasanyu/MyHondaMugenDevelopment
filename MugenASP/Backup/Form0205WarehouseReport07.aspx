   ...
   <asp:MultiView ID="MultiViewError" runat="server" Visible="TRUE">
    ...
    <asp:View ID="View8" runat="server">
        ...
        <asp:MultiView ID="MultiVStock" runat="server" Visible="TRUE">
            ...
            SelectCommand="SELECT TRXN_STOCK.STOCK_NoTTK, TRXN_STOCK.STOCK_NoRangka, TRXN_STOCK.STOCK_NoMesin, TRXN_STOCK.STOCK_NoKunci, TRXN_STOCK.STOCK_CdWarna, DATA_WARNA.WARNA_Int, TRXN_STOCK.STOCK_CdType, DATA_TYPE.TYPE_Nama, TRXN_STOCK.STOCK_CdSuplier, DATA_SUPLIER.SUPLIER_Nama, TRXN_STOCK.STOCK_CdLokasi, DATA_LOKASI.LOKASI_Nama, TRXN_STOCK.STOCK_KirimTGLTerima, DATA_TYPE.TYPE_Group FROM DATA_WARNA RIGHT OUTER JOIN DATA_TYPE RIGHT OUTER JOIN TRXN_STOCK LEFT OUTER JOIN DATA_SUPLIER ON TRXN_STOCK.STOCK_CdSuplier = DATA_SUPLIER.SUPLIER_Kode LEFT OUTER JOIN DATA_LOKASI ON TRXN_STOCK.STOCK_CdLokasi = DATA_LOKASI.LOKASI_Kode ON DATA_TYPE.TYPE_Type = TRXN_STOCK.STOCK_CdType ON DATA_WARNA.WARNA_Kode = TRXN_STOCK.STOCK_CdWarna RIGHT OUTER JOIN TEMP_STOCKWAREHOSE ON TRXN_STOCK.STOCK_NoRangka = TEMP_STOCKWAREHOSE.STOCKWAREHOSE_NORANGKA ORDER BY TYPE_Group,STOCK_CdType,STOCK_CdWarna,STOCK_NOTTK"                     
            ...
            <table id="table-a"  border="2" width="100%"  style="border-collapse:collapse;">
                    <thead style="background-color:Silver; height:30px">
                      <th>No TTK</th><th>Rangka</th><th>Mesin</th><th>Kunci</th><th>Warna</th><th>Tipe</th><th>Suplier</th><th>Lokasi</th><th>Terima</th>
                    </thead>
            ...
            <ItemTemplate>
                <tr>
                    <td style="width:10%; font-size: x-small"><%#Eval("STOCK_NoTTK")%></td>
                    <td style="width:10%; font-size: x-small"><%#Eval("STOCK_NoRangka")%></td>
                    <td style="width:10%; font-size: x-small"><%#Eval("STOCK_NoMesin")%></td>
                    <td style="width:10%; font-size: x-small"><%#Eval("STOCK_NoKunci")%></td>
                    ...
                    <td style="width:10%; font-size: x-small"><%#Eval("LOKASI_Nama")%></td>
                    <td style="width:10%; font-size: x-small"><%#Eval("STOCK_KirimTGLTerima")%></td>
                </tr>
            </ItemTemplate>
            </asp:ListView>
            </asp:View>
