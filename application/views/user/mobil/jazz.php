		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/jazz1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/jazz2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/jazz3.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/jazz4.jpg'?>" alt="" />
					  </li>
					   <li>
						<img src="<?php echo base_url().'image/jazz5.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<ul class="nav nav-tabs">
					...
					<li><a href="<?php echo base_url().'brosur/Jazz.pdf'?>">Unduh Brosur</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane <?php if ($tab=='video'){echo 'active';} else{echo '';}?>" id="video">
						<div class="video-container">			
							<iframe width="800" height="400" src="https://www.youtube.com/embed/CYKki4mLpVs" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					<!--Tab Preview 
					<div class="tab-pane" id="preview">
						<div class="video-container">			
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/jazz.html" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>-->
					<!--Tab Spesifikasi -->
							...
							<table class="table table-bordered table-hover">
								<tbody>
									...
									<tr>
										...
										<th class="col-md-2">New Jazz A</th>			
										<th class="col-md-2">New Jazz S</th>
										<th class="col-md-2">New Jazz S CVT</th>
										<th class="col-md-2">New Jazz RS</th>
										<th class="col-md-2">New Jazz RS CVT</th>
									</tr>
									...
									<tr>
										...
										<td>3.995mm x 1.694mm x 1.524mm</td>
										<td>3.995mm x 1.694mm x 1.524mm</td>
										<td>3.995mm x 1.694mm x 1.524mm</td>
										<td>3.995mm x 1.694mm x 1.524mm</td>
										<td>3.995mm x 1.694mm x 1.524mm</td>
									...
									<tr>
										...
										<td>1.492mm/1.481mm</td>
										<td>1.492mm/1.481mm</td>
										<td>1.492mm/1.481mm</td>
										<td>1.476mm/1.466mm</td>
										<td>1.476mm/1.466mm</td>					
									</tr>
									<tr>
									...
									<tr>
										...
										<td>Alloy Wheel 15" x 5 1/2 J</td>
										<td>Alloy Wheel 15" x 5 1/2 J</td>
										<td>Alloy Wheel 16" x 6 J</td>
										<td>Alloy Wheel 16" x 6 J</td>
									</tr>	
									...
									<tr>
										...
										<td>Halogen Headlight</td>
										<td>Halogen Headlight</td>
										<td>LED Headlight w/ auto leveling</td>
										<td>LED Headlight w/ auto leveling</td>
									</tr>
									<tr>
										<th>Fog Lamp</th>	
									...
									<tr>
										<th>Front Grille</th>	
										<td>Black</td>
										<td>Glossy Black with Chrome Plating</td>
										<td>Glossy Black with Chrome Plating</td>
										<td>Glossy Black w/ Dark Chrome Plating & RS E</td>
										<td>Glossy Black w/ Dark Chrome Plating & RS E</td>
									</tr>										
									<tr>
										<th>Door Mirror</th>	
									...
									<tr>
										<th>Audio</th>	
										<td>Single DIN AM/FM Radio, Single Disc MP3/WMA + USB Port + AUX Input + Made for iPhone</td>
									...
									<tr>
										<th>Front & Rear Seat Reclining</th>	
										<td>YES</td>
										<td>YES</td>
										<td>YES</td>
										<td>YES</td>
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'jazz'?>" method="post">
