		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/freed1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/freed2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/freed3.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/freed4.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<ul class="nav nav-tabs">
					...
					<li><a href="<?php echo base_url().'brosur/freed.pdf'?>">Unduh Brosur</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="video">
						<center>		
							<iframe width="800" height="400" src="https://www.youtube.com/embed/mG-u42ScYhY" frameborder="0" allowfullscreen></iframe>
						</center>	
					</div>
					...
					<div class="tab-pane" id="preview">
						<center>		
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/freed.html" frameborder="0" allowfullscreen></iframe>
						</center>	
					</div>
							...
							<table class="table table-bordered table-hover">
								<tbody>
									...
									<tr>
										...
										<th class="col-md-4">Honda Freed S</th>	
										<th class="col-md-4">Honda Freed E</th>
									</tr>
									<tr>
										<th>Tipe</th>	
										<td>1.5 L SOHC silinder segaris, 16 katup i-VTEC + DBW + TBR</td>
										<td>1.5 L SOHC silinder segaris, 16 katup i-VTEC + DBW + TBR</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>14,9 kg.m (146Nm)/4.800 rpm</td>
										<td>14,9 kg.m (146Nm)/4.800 rpm</td>
									</tr>
									...
									<tr>
										...
										<td>4.215mm x 1.700mm x 1.740mm</td>
										<td>4.215mm x 1.700mm x 1.740mm</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Door Mirror</th>	
										<td>Body Color (with Turning Signal)</td>
										<td>Body Color (with Turning Signal)</td>
									</tr>	
									<tr>
										<th>Door Handle</th>	
									...
									<tr>
										<th>Power Sliding Door Button</th>	
										<td>Left Side</td>
										<td>Both Side</td>
									<tr>
										<th>Audio</th>				
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'freed'?>" method="post">
