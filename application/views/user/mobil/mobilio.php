		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/mobilio1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/mobilio2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/mobilio3.jpg'?>" alt="" />
					  </li>
					   <li>
						<img src="<?php echo base_url().'image/mobilio4.jpg'?>" alt="" />
					  </li>
					   <li>
						<img src="<?php echo base_url().'image/mobilio5.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane <?php if ($tab=='video'){echo 'active';} else{echo '';}?>" id="video">
						<div class="video-container">		
							<iframe width="800" height="400" src="https://www.youtube.com/embed/Tm6LeqxGo8k" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					<!--Tab Preview-->
					<div class="tab-pane" id="preview">
						<div class="video-container">			
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/mobilio.html" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					<!--Tab Spesifikasi-->
							...
							<table class="table table-bordered table-hover">
								<tbody>
									...
									<tr>
										...
										<th class="col-md-2">Honda Mobilio S</th>	
										<th class="col-md-2">Honda Mobilio E</th>
										<th class="col-md-2">Honda Mobilio E CVT</th>
										<th class="col-md-2">Honda Mobilio E Prestige</th>
									</tr>
									<tr>
										<th>Tipe</th>	
									...
									<tr>
										...
										<td>4,386m x 1,683m x 1,603m</td>
										<td>4,386m x 1,683m x 1,603m</td>
										<td>4,386m x 1,683m x 1,603m</td>
										<td>4,386m x 1,683m x 1,603m</td>
									</tr>
									...
									<tr>
										<th>Audio</th>				
										<td>Single DIN AM/FM Radio, Single Disc MP3/WMA + AUX Input</td>
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'mobilio'?>" method="post">
