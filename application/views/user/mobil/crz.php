		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/crz1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/crz2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/crz3.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<ul class="nav nav-tabs">
					...
					<li><a href="<?php echo base_url().'brosur/CRZ.pdf'?>">Unduh Brosur</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="video">
						<div class="video-container">		
							<iframe width="800" height="400" src="https://www.youtube.com/embed/fELJqaY4sc0" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					...
					<div class="tab-pane" id="preview">
						<div class="video-container">			
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/crz.html" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					-->
					<!--Tab Spesifikasi -->
							...
							<table class="table table-bordered table-hover">
								<tbody>
									...
									<tr>
										...
										<th class="col-md-4">Honda CR-Z CVT</th>	
										<th class="col-md-4">Honda CR-Z 6M/T</th>
									</tr>
									<tr>
										<th>Tipe</th>	
									...
									<tr>
										...
										<td>14,7 kg.m (144Nm)/4.800 rpm</td>
									...
									<tr>
										...
										<td>4.075mm x 1.740mm x 1.395mm</td>
										<td>4.075mm x 1.740mm x 1.395mm</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Tipe</th>	
										<td>Wet Multiplate Clutch, CVT</td>
										<td>Synchronized 6-speed forward, 1 speed reverse</td>
									</tr>
									<tr>
										<th>1</th>	
										<td>2,526 ~ 0,421</td>
									...
									<tr>
										<th>Audio</th>	
										<td>Double DIN, AM/FM Single Disc, MP3 + AUX Input + USB Port, 6 Speakers, 1 Subwoofer</td>
										<td>Double DIN, AM/FM Single Disc, MP3 + AUX Input + USB Port, 6 Speakers, 1 Subwoofer</td>
									</tr>
									<tr>
										<th>ECO Assist</th>	
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'crz'?>" method="post">
