		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/brio1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/brio2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/brio3.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/brio4.jpg'?>" alt="" />
					  </li>
						 <li>
						<img src="<?php echo base_url().'image/brio5.jpg'?>" alt="" />
					  </li>
					   <li>
						<img src="<?php echo base_url().'image/brio6.jpg'?>" alt="" />
					  </li>
		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<ul class="nav nav-tabs">
					...
					<li><a href="<?php echo base_url().'brosur/Brio.pdf'?>">Unduh Brosur</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane <?php if ($tab=='video'){echo 'active';} else{echo '';}?>" id="video">
						<div class="video-container">			
							<iframe width="800" height="400" src="https://www.youtube.com/embed/6N7-Vx7JcWI" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					...
					<div class="tab-pane" id="preview">
						<div class="video-container">			
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/brio.html" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>-->
							...
							<table class="table table-bordered table-hover">
								<tbody>
									...
									<tr>
										...
										<th class="col-md-2">Brio Satya S</th>	
										<th class="col-md-2">Brio Satya E</th>
										<th class="col-md-2">Brio Satya E CVT</th>
										<th class="col-md-2">Brio RS</th>
										<th class="col-md-2">Brio RS A/T</th>
									</tr>
									<tr>
										<th>Tipe</th>	
										<td>1.2 L SOHC silinder segaris, 16 katup i-VTEC + DBW</td>
										<td>1.2 L SOHC silinder segaris, 16 katup i-VTEC + DBW</td>
										<td>1.2 L SOHC silinder segaris, 16 katup i-VTEC + DBW</td>
										<td>1.2 L SOHC silinder segaris, 16 katup i-VTEC + DBW</td>
										<td>1.2 L SOHC silinder segaris, 16 katup i-VTEC + DBW</td>
									...
									<tr>
										<th>Roda</th>	
										<td>Steel Wheel 14"</td>
										<td>Alloy Wheel 14"</td>
										<td>Alloy Wheel 14"</td>
									...
									<tr>
										...
										<td>Halogen Headlight</td>
										<td>Halogen Headlight</td>
										<td>Projector Headlamp with LED Light Guide</td>
										<td>Projector Headlamp with LED Light Guide</td>
									</tr>			
									<tr>
										<th>Fog Lamp</th>	
									...
									<tr>
										<th>Audio</th>				
										<td>2DIN Audio, AM/FM Radio, CD Player, Aux-in, USB Port, Made for iPod/iPhone</td>
										<td>2DIN Audio, AM/FM Radio, CD Player, Aux-in, USB Port, Made for iPod/iPhone</td>
										<td>2DIN Audio, AM/FM Radio, CD Player, Aux-in, USB Port, Made for iPod/iPhone</td>
										<td>6.2" touchscreen audio video system</td>
										<td>6.2" touchscreen audio video system</td>
									</tr>		
									<!--Keselamatan-->
									<tr class="active">
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'brio'?>" method="post">
