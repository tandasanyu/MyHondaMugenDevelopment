		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				...
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/crv1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/crv2.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/crv3.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
		...
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<ul class="nav nav-tabs">
					...
					<li><a href="<?php echo base_url().'brosur/CRV.pdf'?>">Unduh Brosur</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane <?php if ($tab=='video'){echo 'active';} else{echo '';}?>" id="video">
						<div class="video-container">		
							<iframe width="800" height="400" src="https://www.youtube.com/embed/meCXgw75Tew" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>
					...
					<div class="tab-pane" id="preview">
						<div class="video-container">		
							<iframe width="1000" height="400" src="http://www.honda-indonesia.com/H3D/crv.html" frameborder="0" allowfullscreen></iframe>
						</div>	
					</div>-->
						...
						<div class="table table-responsive">
							<table class="table table-bordered table-hover">
								<tbody>
									<!--Mesin-->
									<tr class="active">
										<td colspan="5" align="center"><b>Mesin</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC</th>
										<th class="col-md-2">Honda CR-V 2.4 I-VTEC A/T</th>
										<th class="col-md-2">Honda CR-V 2.4L Prestige</th>
									</tr>
									<tr>
										<th>Tipe</th>	
										<td>2.0 L SOHC, i-VTEC + DBW</td>
										<td>2.0 L SOHC, i-VTEC + DBW</td>
										<td>2.4 L DOHC, i-VTEC + DBW</td>
										<td>2.4 L DOHC, i-VTEC + DBW</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Daya Maksimum</th>	
										<td>114 Kw (155 PS)/6.500 rpm</td>
										<td>114 Kw (155 PS)/6.500 rpm</td>
										<td>140 Kw (190 PS)/7.000 rpm</td>
										<td>140 Kw (190 PS)/7.000 rpm</td>
									</tr>			
									<tr>
										<th>Momen Puntir Maksimum</th>	
										<td>19,4 kg.m (190Nm)/4.300 rpm</td>
										<td>19,4 kg.m (190Nm)/4.300 rpm</td>
										<td>22,6 kg.m (222Nm)/4.400 rpm</td>
										<td>22,6 kg.m (222Nm)/4.400 rpm</td>
									</tr>
									
									<!--Dimensi-->
									<tr class="active">
										<td colspan="5" align="center"><b>Dimensi</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<tr>
										...
										<td>4.595mm x 1.820mm x 1.685mm</td>
										<td>4.545mm x 1.820mm x 1.685mm</td>
										<td>4.595mm x 1.820mm x 1.685mm</td>
										<td>4.595mm x 1.820mm x 1.685mm</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>1.580mm / 1.580mm</td>
										<td>1.565mm / 1.565mm</td>
										<td>1.580mm / 1.580mm</td>
										<td>1.580mm / 1.580mm</td>
									</tr>
									<tr>
									...
									<!--Transmisi-->
									<tr class="active">
										<td colspan="5" align="center"><b>Transmisi</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<tr>
										<th>Tipe</th>
										<td>A/T</td>
										<td>Synchronized 6-speed, Dry Spring Single Plate</td>
										<td>A/T</td>
										<td>A/T</td>
									</tr>
									<tr>
									...
									<!--Kemudi-->
									<tr class="active">
										<td colspan="5" align="center"><b>Sistem Kemudi</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<!--Suspensi-->
									<tr class="active">
										<td colspan="5" align="center"><b>Sistem Suspensi</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<!--Rem-->
									<tr class="active">
										<td colspan="5" align="center"><b>Sistem Rem</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<!--Ban-->
									<tr class="active">
										<td colspan="5" align="center"><b>Ban</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<tr>
										<th>Roda</th>	
										<td>Alloy Wheel 17" x 6.5j</td>
										<td>Alloy Wheel 17" x 6.5j</td>
										<td>Alloy Wheel 18" x 6.5j</td>
										<td>Alloy Wheel 18" x 6.5j</td>
									</tr>	
									
									<!--Eksterior-->
									<tr class="active">
										<td colspan="5" align="center"><b>Eksterior</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<!--Interior-->
									<tr class="active">
										<td colspan="5" align="center"><b>Interior</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<tr>
										...
										<td>i-MID (Inteligent Multi Information Display</td>
										<td>7.0" Touch Screen Display, AM/FM Radio, CD/DVD Player, MP3/WMA + NAVI System + USB Port + AUX input + Made for iPod/iPhone/Android + Bluetooth + HDMI ( Need Additional Cable for Phone Mirroring)</td>
										<td>7.0" Touch Screen Display, AM/FM Radio, CD/DVD Player, MP3/WMA + NAVI System + USB Port + AUX input + Made for iPod/iPhone/Android + Bluetooth + HDMI ( Need Additional Cable for Phone Mirroring)</td>
									</tr>	
									<tr>
									...
									<!--Keselamatan-->
									<tr class="active">
										<td colspan="5" align="center"><b>Fitur Keselamatan</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
									...
									<!--Keamanan-->
									<tr class="active">
										<td colspan="5" align="center"><b>Sistem Keamanan</b></td>
									</tr>
									<tr>
										<th class="col-md-2"></th>
										<th class="col-md-2">Honda CR-V 2.0 i-VTEC A/T	</th>	
				...
				<!--Tab Harga -->
					...
					<div class="tab-pane <?php if ($tab=='simulasi'){echo 'active';} else{echo '';}?>" id="simulasi">				
						<form action="<?php echo base_url().'crv'?>" method="post">
