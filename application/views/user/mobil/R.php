	...
	<section id="content">
		<div class="container">
			<div class="col-sm-12 col-lg-12">
				<h2>Honda Civic Type R 6 Speed M/T</h2>
				<!-- Slider -->
				<div id="main-slider" class="main-slider flexslider">
					<ul class="slides">
					  <li>
						<img src="<?php echo base_url().'image/r1.jpg'?>" alt="" />
					  </li>
					  <li>
						<img src="<?php echo base_url().'image/r2.jpg'?>" alt="" />
					  </li>
					</ul>
				</div>
			</div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane <?php if ($tab=='video'){echo 'active';} else{echo '';}?>" id="video">
						<div class="video-container">		
							<iframe width="800" height="400" src="https://www.youtube.com/embed/_eNFxZ_OMMI" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
						</div>	
					</div>
						...
						<div class="table table-responsive">
							<table class="table table-bordered table-hover">
								<tbody>	
									...
									<tr>
										<th>Tipe</th>	
										<td>2.0L 4 Silinder Segaris, VTEC Turbo DOHC, 16 Katup + DBW</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Daya Maksimum</th>	
										<td>301 PS / 6.500 rpm</td>	
									</tr>			
									<tr>
										<th>Momen Puntir Maksimum</th>	
										<td>400 Nm / 2.500 - 4.500 rpm</td>
									</tr>
									...
									<tr>
										...
										<td>4.557mm x 2.076mm x 1.421mm</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Ban</th>	
										<td>2415/30 ZR20 90Y</td>
									</tr>	
									<tr>
										<th>Roda</th>	
										<td>20" Alloy Wheel</td>
									</tr>	
									...
									<tr>
										<th>Chrome Exhaust Pipe + Finisher</th>	
										<td>Type R Triple Exhaust with Finisher</td>
									</tr>
									<tr>
									...
									<tr>
										<th>Audio</th>				
										<td>7,0" Touchscreen Monitor with Android System, Garmin Navigation, MP3/WMA, AM/FM Radio, HDMI Port, USB Port, Smartphone Connection, Bluetooth Connection<br><br>
