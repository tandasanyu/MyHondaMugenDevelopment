        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Promosi/simpan_event'?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-5"> 
									<input class="form-control" id="datepicker" readonly="readonly" name="tgl_event" data-date-format="mm/dd/yyyy">
								</div>
							</div>
							<div class="form-group">
