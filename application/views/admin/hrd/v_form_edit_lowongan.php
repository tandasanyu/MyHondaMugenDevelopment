	<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Form Ubah Lowongan Pekerjaan</h1>
            </div>
			<!-- /.col-lg-12 -->
                    ...
                    <div class="col-md-12">
						<form class="form-horizontal" method="post" action="">
							...
							<div class="form-group">
								...
								<div class="col-sm-5"> 
									<input type="text" class="form-control" id="posisi" name="posisi" value="<?php echo $no->posisi?>">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="kualifikasi">Kualifikasi:</label>
								<div class="col-sm-8"> 
									<textarea name="kualifikasi"> <?php echo $no->kualifikasi?></textarea>
								</div>
							</div>
							<div class="form-group"> 
