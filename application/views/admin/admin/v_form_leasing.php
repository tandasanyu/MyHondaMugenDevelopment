	<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Form Leasing</h1>
            </div>
			<!-- /.col-lg-12 -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Admin/simpan_leasing'?>">
							<div class="form-group">
								<label class="control-label col-sm-2" for="nm_leasing">nm_leasing:</label>
								<div class="col-sm-5"> 
									<input type="text" class="form-control" id="nm_leasing" name="nm_leasing">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5"> 
									<select class="form-control" id="provisi" name="provisi">
										<option value="">-Pilih Provisi-</option>
										<option value="1">1%</option>
										<option value="2">2%</option>
										<option value="3">3%</option>
										<option value="4">4%</option>
